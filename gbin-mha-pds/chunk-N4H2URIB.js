...
import "./chunk-NACOCQOL.js";
import "./chunk-ZFBVEYKZ.js";
import {
...
var NoAccessComponent = class _NoAccessComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NoAccessComponent, selectors: [["app-no-access"]], decls: 11, vars: 1, consts: [[1, "no-access-container"], [1, "no-access-card"], [1, "no-access-icon"], [1, "position-info"]], template: function NoAccessComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275domElementEnd();
      \u0275\u0275conditionalCreate(10, NoAccessComponent_Conditional_10_Template, 4, 1, "div", 3);
      \u0275\u0275domElementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(10);
      \u0275\u0275conditional(ctx.position() ? 10 : -1);
    }
      ...
      <div class="no-access-card">
        ...
        @if (position()) {
          <div class="position-info">
            Your current position: <strong>{{ position() }}</strong>
          </div>
        }
      </div>
    </div>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NoAccessComponent, { className: "NoAccessComponent", filePath: "src/app/no-access/no-access.ts", lineNumber: 61 });
})();
export {
  NoAccessComponent
};
