...
var AuditPayloadParserService = class _AuditPayloadParserService {
  ...
  DE_FIELD_LABELS = {
    ...
    "DE06.004": "Eligibility Screening Date",
    "DE06.008": "Service Initiation Date",
    "DE06.009": "Service Enrollment Date",
    "DE06.010": "Service Termination Date",
    "DE06.011": "Service Termination Reason",
  ...
  extractFromEpisodeOfCare(deCode, episodes) {
    ...
    switch (deCode) {
      ...
      case "DE06.009": {
        const ext = this.getExtensionDate(eoc.extension, "ServiceEnrollmentDate");
        return ext ? { value_sent: ext.date, extension_url: ext.url } : null;
      }
      case "DE06.010": {
        const ext = this.getExtensionDate(eoc.extension, "ServiceTerminationDate");
        return ext ? { value_sent: ext.date, extension_url: ext.url } : null;
      }
      case "DE06.011": {
        const ext = this.getExtensionCoded(eoc.extension, "ServiceTerminationReason");
        return ext ? {
          mapped_code: ext.display,
          coding_code: ext.code,
          code_system: ext.system,
