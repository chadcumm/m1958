        ...
        script: [
          {
            ...
            parameters: {
              ...
              requestId: Date.now(),
              requestData: JSON.stringify(report.PARAMS ?? {}),
...
function ReportsComponent_Conditional_5_Case_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-mpage-table-renderer", 10);
  }
  if (rf & 2) {
    let tmp_4_0;
    const data_r1 = \u0275\u0275nextContext();
...
function ReportsComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, ReportsComponent_Conditional_5_Case_0_Template, 1, 1, "app-spreadsheet-renderer", 9)(1, ReportsComponent_Conditional_5_Case_1_Template, 1, 2, "app-mpage-table-renderer", 10)(2, ReportsComponent_Conditional_5_Case_2_Template, 2, 0, "div", 11)(3, ReportsComponent_Conditional_5_Case_3_Template, 2, 1, "div", 12);
  }
  if (rf & 2) {
    let tmp_2_0;
    const ctx_r1 = \u0275\u0275nextContext();
...
var ReportsComponent = class _ReportsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReportsComponent, selectors: [["app-reports"]], decls: 7, vars: 3, consts: [[1, "reports-layout"], [3, "reportSelected", "reports", "selected"], [1, "reports-content"], [1, "loading-container"], [1, "alert", "alert-danger", "m-3"], [1, "welcome-message"], ["role", "status", 1, "spinner-border", "text-primary"], [1, "visually-hidden"], [1, "mt-2"], [3, "data"], [3, "data", "tableParams"], [1, "alert", "alert-info", "m-3"], [1, "alert", "alert-warning", "m-3"], [1, "text-muted"]], template: function ReportsComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReportsComponent, { className: "ReportsComponent", filePath: "src/app/reports/reports.ts", lineNumber: 25 });
})();
export {
  ReportsComponent
};
