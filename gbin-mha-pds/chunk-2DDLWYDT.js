...
var ConfigSectionMirth = class _ConfigSectionMirth {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConfigSectionMirth, selectors: [["app-config-section-mirth"]], inputs: { config: "config" }, outputs: { configChange: "configChange" }, decls: 56, vars: 9, consts: [[1, "section-content"], [1, "form-grid"], [1, "form-group", "full-width"], ["for", "mirthUrl"], ["type", "url", "id", "mirthUrl", "placeholder", "https://mirth-server.example.com:8443/api", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "help-text"], [1, "future-note"], ["for", "mirthChannelId"], ["type", "text", "id", "mirthChannelId", "placeholder", "b397b5cb-c91c-47c2-af3a-438acfef6d8a", 1, "form-control", 3, "ngModelChange", "ngModel"], ["for", "mirthTriggerUrl"], [1, "badge"], ["type", "url", "id", "mirthTriggerUrl", "placeholder", "http://mirth-server.example.com:8081/mha-pds-trigger", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "form-group"], ["for", "mirthUsername"], ["type", "text", "id", "mirthUsername", "placeholder", "API username", 1, "form-control", 3, "ngModelChange", "ngModel"], ["for", "mirthPassword"], [1, "password-field"], ["id", "mirthPassword", "placeholder", "API password", 1, "form-control", 3, "ngModelChange", "type", "ngModel"], ["type", "button", 1, "password-toggle", 3, "click"], ["for", "mirthTimeout"], ["type", "number", "id", "mirthTimeout", "min", "5", "max", "300", "step", "5", 1, "form-control", 3, "ngModelChange", "ngModel"], ["for", "mirthRetries"], ["type", "number", "id", "mirthRetries", "min", "0", "max", "10", "step", "1", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "test-connection-section"], ["type", "button", "disabled", "", "title", "Connection testing will be available in a future release", 1, "btn", "btn-outline"]], template: function ConfigSectionMirth_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(9, "Not currently in use \u2014 reserved for future development");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(10, "div", 2)(11, "label", 7);
      \u0275\u0275text(12, "Channel ID");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(13, "input", 8);
      \u0275\u0275listener("ngModelChange", function ConfigSectionMirth_Template_input_ngModelChange_13_listener($event) {
        return ctx.onFieldChange("CHANNEL_ID", $event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(14, "small", 5);
      \u0275\u0275text(15, "UUID of the Mirth channel (legacy fallback only, not needed if Trigger URL is set)");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(16, "small", 6);
      \u0275\u0275text(17, "Not currently in use \u2014 reserved for future development");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(18, "div", 2)(19, "label", 9);
      \u0275\u0275text(20, " Trigger URL ");
      \u0275\u0275elementStart(21, "span", 10);
      \u0275\u0275text(22, "Recommended");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(23, "input", 11);
      \u0275\u0275listener("ngModelChange", function ConfigSectionMirth_Template_input_ngModelChange_23_listener($event) {
        return ctx.onFieldChange("TRIGGER_URL", $event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(24, "small", 5);
      \u0275\u0275text(25, " Direct HTTP endpoint for manual trigger channel (port 8081). If set, this overrides Server URL + Channel ID approach. Format: http://server:port/context-path ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(26, "div", 12)(27, "label", 13);
      \u0275\u0275text(28, "Username");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(29, "input", 14);
      \u0275\u0275listener("ngModelChange", function ConfigSectionMirth_Template_input_ngModelChange_29_listener($event) {
        return ctx.onFieldChange("USERNAME", $event);
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(30, "div", 12)(31, "label", 15);
      \u0275\u0275text(32, "Password");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(33, "div", 16)(34, "input", 17);
      \u0275\u0275listener("ngModelChange", function ConfigSectionMirth_Template_input_ngModelChange_34_listener($event) {
        return ctx.onFieldChange("PASSWORD", $event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(35, "button", 18);
      \u0275\u0275listener("click", function ConfigSectionMirth_Template_button_click_35_listener() {
        return ctx.togglePasswordVisibility();
      });
      \u0275\u0275text(36);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(37, "small", 5);
      \u0275\u0275text(38, "Leave blank to keep existing password");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(39, "div", 12)(40, "label", 19);
      \u0275\u0275text(41, "Timeout (seconds)");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(42, "input", 20);
      \u0275\u0275listener("ngModelChange", function ConfigSectionMirth_Template_input_ngModelChange_42_listener($event) {
        return ctx.onFieldChange("TIMEOUT_SECONDS", $event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(43, "small", 5);
      \u0275\u0275text(44, "Connection timeout (5-300 seconds)");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(45, "div", 12)(46, "label", 21);
      \u0275\u0275text(47, "Retry Attempts");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(48, "input", 22);
      \u0275\u0275listener("ngModelChange", function ConfigSectionMirth_Template_input_ngModelChange_48_listener($event) {
        return ctx.onFieldChange("RETRY_ATTEMPTS", $event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(49, "small", 5);
      \u0275\u0275text(50, "Number of retries on connection failure (0-10)");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(51, "div", 23)(52, "button", 24);
      \u0275\u0275text(53, " Test Connection ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(54, "small", 5);
      \u0275\u0275text(55, "Connection testing not yet implemented");
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(5);
...
(() => {
    ...
    <div class="section-content">
      <div class="form-grid">
        ...
        <div class="form-group full-width">
          ...
          <small class="future-note">Not currently in use \u2014 reserved for future development</small>
        </div>
  ...
  `, changeDetection: ChangeDetectionStrategy.OnPush, styles: ["/* angular:styles/component:scss;471875f93f79a90041db835f1f6d39e0f6d18e51b5dd1bb28b42448d2106df95;/Users/chadcummings/Github/chadcumm/gbin-mha-pds/src/app/config-editor/sections/config-section-mirth.ts */\n.section-content {\n  max-width: 800px;\n}\n.form-grid {\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n  gap: 20px;\n}\n@media (max-width: 600px) {\n  .form-grid {\n    grid-template-columns: 1fr;\n  }\n}\n.full-width {\n  grid-column: 1/-1;\n}\n.form-group {\n  display: flex;\n  flex-direction: column;\n  gap: 6px;\n}\n.form-group label {\n  font-weight: 500;\n  color: #333;\n  font-size: 14px;\n  display: flex;\n  align-items: center;\n  gap: 8px;\n}\n.form-group label .badge {\n  display: inline-block;\n  padding: 2px 8px;\n  background-color: #28a745;\n  color: white;\n  font-size: 11px;\n  font-weight: 600;\n  border-radius: 12px;\n  text-transform: uppercase;\n  letter-spacing: 0.5px;\n}\n.form-group .form-control {\n  padding: 10px 12px;\n  border: 1px solid #ced4da;\n  border-radius: 4px;\n  font-size: 14px;\n  transition: border-color 0.2s, box-shadow 0.2s;\n}\n.form-group .form-control:focus {\n  outline: none;\n  border-color: #0078d4;\n  box-shadow: 0 0 0 3px rgba(0, 120, 212, 0.1);\n}\n.form-group .form-control::placeholder {\n  color: #adb5bd;\n}\n.form-group .help-text {\n  color: #6c757d;\n  font-size: 12px;\n}\n.form-group .future-note {\n  display: block;\n  color: #e65100;\n  font-size: 12px;\n  font-style: italic;\n  margin-top: 2px;\n}\n.password-field {\n  display: flex;\n  gap: 8px;\n}\n.password-field .form-control {\n  flex: 1;\n}\n.password-field .password-toggle {\n  padding: 10px 16px;\n  border: 1px solid #ced4da;\n  background-color: #f8f9fa;\n  border-radius: 4px;\n  font-size: 13px;\n  cursor: pointer;\n  transition: background-color 0.2s;\n}\n.password-field .password-toggle:hover {\n  background-color: #e9ecef;\n}\n.test-connection-section {\n  margin-top: 24px;\n  padding-top: 20px;\n  border-top: 1px solid #e9ecef;\n  display: flex;\n  align-items: center;\n  gap: 12px;\n}\n.test-connection-section .btn-outline {\n  padding: 10px 20px;\n  border: 1px solid #0078d4;\n  background: transparent;\n  color: #0078d4;\n  border-radius: 4px;\n  font-size: 14px;\n  cursor: pointer;\n  transition: all 0.2s;\n}\n.test-connection-section .btn-outline:hover:not(:disabled) {\n  background-color: #0078d4;\n  color: white;\n}\n.test-connection-section .btn-outline:disabled {\n  border-color: #ced4da;\n  color: #6c757d;\n  cursor: not-allowed;\n}\n"] }]
  }], null, { config: [{
    type: Input
  }], configChange: [{
    type: Output
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConfigSectionMirth, { className: "ConfigSectionMirth", filePath: "src/app/config-editor/sections/config-section-mirth.ts", lineNumber: 290 });
})();
...
function ConfigSectionSubmission_Case_43_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, " Automatic submissions are disabled. Records will only be submitted manually. ");
  }
}
function ConfigSectionSubmission_Case_44_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
  }
  if (rf & 2) {
...
function ConfigSectionSubmission_Conditional_45_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
  }
  if (rf & 2) {
...
function ConfigSectionSubmission_Conditional_46_Template(rf, ctx) {
  if (rf & 1) {
...
var ConfigSectionSubmission = class _ConfigSectionSubmission {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConfigSectionSubmission, selectors: [["app-config-section-submission"]], inputs: { config: "config" }, outputs: { configChange: "configChange" }, decls: 47, vars: 6, consts: [[1, "section-content"], [1, "future-banner"], [1, "form-grid"], [1, "form-group"], ["for", "batchSize"], ["type", "number", "id", "batchSize", "min", "1", "max", "1000", "step", "10", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "help-text"], ["for", "scheduleFrequency"], ["id", "scheduleFrequency", 1, "form-control", 3, "ngModelChange", "ngModel"], ["value", "HOURLY"], ["value", "DAILY"], ["value", "WEEKLY"], ["value", "MANUAL"], ["for", "maxRetries"], ["type", "number", "id", "maxRetries", "min", "0", "max", "10", "step", "1", 1, "form-control", 3, "ngModelChange", "ngModel"], ["for", "retryDelay"], ["type", "number", "id", "retryDelay", "min", "1", "max", "120", "step", "5", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "schedule-summary"]], template: function ConfigSectionSubmission_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(21, "Manual Only");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(22, "small", 6);
      \u0275\u0275text(23, "How often to run automatic submissions");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(24, "div", 3)(25, "label", 13);
      \u0275\u0275text(26, "Max Retries");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(27, "input", 14);
      \u0275\u0275listener("ngModelChange", function ConfigSectionSubmission_Template_input_ngModelChange_27_listener($event) {
        return ctx.onFieldChange("MAX_RETRIES", $event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(28, "small", 6);
      \u0275\u0275text(29, "Maximum retry attempts for failed submissions (0-10)");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(30, "div", 3)(31, "label", 15);
      \u0275\u0275text(32, "Retry Delay (minutes)");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(33, "input", 16);
      \u0275\u0275listener("ngModelChange", function ConfigSectionSubmission_Template_input_ngModelChange_33_listener($event) {
        return ctx.onFieldChange("RETRY_DELAY_MINUTES", $event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(34, "small", 6);
      \u0275\u0275text(35, "Wait time between retry attempts (1-120 minutes)");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(36, "div", 17)(37, "h4");
      \u0275\u0275text(38, "Schedule Summary");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(39, "p");
      \u0275\u0275conditionalCreate(40, ConfigSectionSubmission_Case_40_Template, 1, 1)(41, ConfigSectionSubmission_Case_41_Template, 1, 1)(42, ConfigSectionSubmission_Case_42_Template, 1, 1)(43, ConfigSectionSubmission_Case_43_Template, 1, 0)(44, ConfigSectionSubmission_Case_44_Template, 1, 1);
      \u0275\u0275conditionalCreate(45, ConfigSectionSubmission_Conditional_45_Template, 1, 2)(46, ConfigSectionSubmission_Conditional_46_Template, 1, 0);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      let tmp_4_0;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ConfigSectionSubmission, [{
    ...
    <div class="section-content">
      <div class="future-banner">Not currently in use \u2014 these settings are reserved for future development.</div>
      <div class="form-grid">
        <!-- Batch Size -->
        <div class="form-group">
  ...
  `, changeDetection: ChangeDetectionStrategy.OnPush, styles: ["/* angular:styles/component:scss;1f8ae17aa2e230eb52160edb25bedafba9dd757c35155b4bee19f6e8687c18a0;/Users/chadcummings/Github/chadcumm/gbin-mha-pds/src/app/config-editor/sections/config-section-submission.ts */\n.section-content {\n  max-width: 800px;\n}\n.future-banner {\n  background: #fff3e0;\n  border: 1px solid #ffe0b2;\n  border-radius: 4px;\n  padding: 10px 14px;\n  color: #e65100;\n  font-size: 13px;\n  font-style: italic;\n  margin-bottom: 16px;\n}\n.form-grid {\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n  gap: 20px;\n}\n@media (max-width: 600px) {\n  .form-grid {\n    grid-template-columns: 1fr;\n  }\n}\n.form-group {\n  display: flex;\n  flex-direction: column;\n  gap: 6px;\n}\n.form-group label {\n  font-weight: 500;\n  color: #333;\n  font-size: 14px;\n}\n.form-group .form-control {\n  padding: 10px 12px;\n  border: 1px solid #ced4da;\n  border-radius: 4px;\n  font-size: 14px;\n  transition: border-color 0.2s, box-shadow 0.2s;\n}\n.form-group .form-control:focus {\n  outline: none;\n  border-color: #0078d4;\n  box-shadow: 0 0 0 3px rgba(0, 120, 212, 0.1);\n}\n.form-group select.form-control {\n  cursor: pointer;\n  background-color: white;\n}\n.form-group .help-text {\n  color: #6c757d;\n  font-size: 12px;\n}\n.schedule-summary {\n  margin-top: 24px;\n  padding: 16px;\n  background-color: #f8f9fa;\n  border: 1px solid #e9ecef;\n  border-radius: 6px;\n}\n.schedule-summary h4 {\n  margin: 0 0 8px 0;\n  color: #333;\n  font-size: 14px;\n  font-weight: 600;\n}\n.schedule-summary p {\n  margin: 0;\n  color: #555;\n  font-size: 13px;\n  line-height: 1.6;\n}\n"] }]
  }], null, { config: [{
    type: Input
  }], configChange: [{
    type: Output
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConfigSectionSubmission, { className: "ConfigSectionSubmission", filePath: "src/app/config-editor/sections/config-section-submission.ts", lineNumber: 207 });
})();

// src/app/config-editor/sections/config-section-processing.ts
function ConfigSectionProcessing_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
...
function ConfigSectionProcessing_Conditional_54_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275domElementStart(0, "button", 20);
    \u0275\u0275domListener("click", function ConfigSectionProcessing_Conditional_54_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.clearCutoff());
    });
    \u0275\u0275text(1, "Clear");
    \u0275\u0275domElementEnd();
  }
...
var ConfigSectionProcessing = class _ConfigSectionProcessing {
  ...
  get cutoffLocalValue() {
    if (!this.config.HSE_CUTOFF_DT_TM)
      return "";
    return this.config.HSE_CUTOFF_DT_TM.replace(/\.\d{3}Z$/, "").replace(/Z$/, "");
  }
  ...
  onCutoffChange(event) {
    ...
    const isoValue = value ? value + ":00.000Z" : "";
    const updatedConfig = __spreadProps(__spreadValues({}, this.config), { HSE_CUTOFF_DT_TM: isoValue });
    this.configChange.emit(updatedConfig);
  }
  clearCutoff() {
    const updatedConfig = __spreadProps(__spreadValues({}, this.config), { HSE_CUTOFF_DT_TM: "" });
    this.configChange.emit(updatedConfig);
  }
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConfigSectionProcessing, selectors: [["app-config-section-processing"]], inputs: { config: "config" }, outputs: { configChange: "configChange" }, decls: 84, vars: 22, consts: [[1, "section-content"], [1, "toggle-list"], [1, "toggle-item"], [1, "toggle-info"], [1, "future-note"], [1, "warning-badge"], [1, "toggle-switch"], ["type", "checkbox", 3, "change", "checked"], [1, "toggle-slider"], [1, "datetime-section"], [1, "datetime-item"], [1, "datetime-info"], [1, "datetime-controls"], ["type", "datetime-local", 1, "datetime-input", 3, "change", "value"], [1, "clear-btn"], [1, "status-summary"], [1, "status-grid"], [1, "status-item"], [1, "status-label"], [1, "status-value"], [1, "clear-btn", 3, "click"]], template: function ConfigSectionProcessing_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(9, "Not currently in use \u2014 reserved for future development.");
      \u0275\u0275domElementEnd();
      \u0275\u0275conditionalCreate(10, ConfigSectionProcessing_Conditional_10_Template, 3, 0, "div", 5);
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(11, "label", 6)(12, "input", 7);
      \u0275\u0275domListener("change", function ConfigSectionProcessing_Template_input_change_12_listener($event) {
        return ctx.onToggleChange("ENABLE_DUMMY_MODE", $event);
      });
      \u0275\u0275domElementEnd();
      \u0275\u0275domElement(13, "span", 8);
      \u0275\u0275domElementEnd()();
      \u0275\u0275domElementStart(14, "div", 2)(15, "div", 3)(16, "h4");
      \u0275\u0275text(17, "Detailed Logging");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(18, "p");
      \u0275\u0275text(19, "Enables verbose logging of all processing steps, including data transformations and API calls. Helpful for debugging but may impact performance.");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(20, "p", 4);
      \u0275\u0275text(21, "Not currently in use \u2014 reserved for future development.");
      \u0275\u0275domElementEnd()();
      \u0275\u0275domElementStart(22, "label", 6)(23, "input", 7);
      \u0275\u0275domListener("change", function ConfigSectionProcessing_Template_input_change_23_listener($event) {
        return ctx.onToggleChange("ENABLE_DETAILED_LOGGING", $event);
      });
      \u0275\u0275domElementEnd();
      \u0275\u0275domElement(24, "span", 8);
      \u0275\u0275domElementEnd()();
      \u0275\u0275domElementStart(25, "div", 2)(26, "div", 3)(27, "h4");
      \u0275\u0275text(28, "Error Notifications");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(29, "p");
      \u0275\u0275text(30, "Sends notifications when submission errors occur. Configure notification recipients in the system settings.");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(31, "p", 4);
      \u0275\u0275text(32, "Not currently in use \u2014 reserved for future development.");
      \u0275\u0275domElementEnd()();
      \u0275\u0275domElementStart(33, "label", 6)(34, "input", 7);
      \u0275\u0275domListener("change", function ConfigSectionProcessing_Template_input_change_34_listener($event) {
        return ctx.onToggleChange("ENABLE_ERROR_NOTIFICATIONS", $event);
      });
      \u0275\u0275domElementEnd();
      \u0275\u0275domElement(35, "span", 8);
      \u0275\u0275domElementEnd()();
      \u0275\u0275domElementStart(36, "div", 2)(37, "div", 3)(38, "h4");
      \u0275\u0275text(39, "Send Group Minutes");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(40, "p");
      \u0275\u0275text(41, "When enabled, direct minutes (DE10.006) are included in group encounter submissions. OH recommends disabling until PDS 2.0 clarifies group minute requirements.");
      \u0275\u0275domElementEnd()();
      \u0275\u0275domElementStart(42, "label", 6)(43, "input", 7);
      \u0275\u0275domListener("change", function ConfigSectionProcessing_Template_input_change_43_listener($event) {
        return ctx.onToggleChange("SEND_GROUP_MINUTES", $event);
      });
      \u0275\u0275domElementEnd();
      \u0275\u0275domElement(44, "span", 8);
      \u0275\u0275domElementEnd()()();
      \u0275\u0275domElementStart(45, "div", 9)(46, "div", 10)(47, "div", 11)(48, "h4");
      \u0275\u0275text(49, "HSE Cutoff Date/Time");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(50, "p");
      \u0275\u0275text(51, "Only process Health Service Events and Outcome of Referral results entered into Cerner on or after this date. Leave empty to process all records without restriction.");
      \u0275\u0275domElementEnd()();
      \u0275\u0275domElementStart(52, "div", 12)(53, "input", 13);
      \u0275\u0275domListener("change", function ConfigSectionProcessing_Template_input_change_53_listener($event) {
        return ctx.onCutoffChange($event);
      });
      \u0275\u0275domElementEnd();
      \u0275\u0275conditionalCreate(54, ConfigSectionProcessing_Conditional_54_Template, 2, 0, "button", 14);
      \u0275\u0275domElementEnd()()();
      \u0275\u0275domElementStart(55, "div", 15)(56, "h4");
      \u0275\u0275text(57, "Current Status");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(58, "div", 16)(59, "div", 17)(60, "span", 18);
      \u0275\u0275text(61, "Mode:");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(62, "span", 19);
      \u0275\u0275text(63);
      \u0275\u0275domElementEnd()();
      \u0275\u0275domElementStart(64, "div", 17)(65, "span", 18);
      \u0275\u0275text(66, "Logging:");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(67, "span", 19);
      \u0275\u0275text(68);
      \u0275\u0275domElementEnd()();
      \u0275\u0275domElementStart(69, "div", 17)(70, "span", 18);
      \u0275\u0275text(71, "Notifications:");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(72, "span", 19);
      \u0275\u0275text(73);
      \u0275\u0275domElementEnd()();
      \u0275\u0275domElementStart(74, "div", 17)(75, "span", 18);
      \u0275\u0275text(76, "Group Minutes:");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(77, "span", 19);
      \u0275\u0275text(78);
      \u0275\u0275domElementEnd()();
      \u0275\u0275domElementStart(79, "div", 17)(80, "span", 18);
      \u0275\u0275text(81, "HSE Cutoff:");
      \u0275\u0275domElementEnd();
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(8);
      \u0275\u0275conditional(ctx.config.ENABLE_DUMMY_MODE === 1 ? 10 : -1);
      \u0275\u0275advance(2);
      ...
      \u0275\u0275advance(10);
      \u0275\u0275domProperty("value", ctx.cutoffLocalValue);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.config.HSE_CUTOFF_DT_TM ? 54 : -1);
      \u0275\u0275advance(8);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ConfigSectionProcessing, [{
    ...
    <div class="section-content">
      <div class="toggle-list">
        ...
        <div class="toggle-item" [class.enabled]="config.ENABLE_DUMMY_MODE === 1">
          <div class="toggle-info">
            ...
            <p class="future-note">Not currently in use \u2014 reserved for future development.</p>
      ...
      <!-- HSE Cutoff Date/Time -->
      <div class="datetime-section">
        <div class="datetime-item">
          <div class="datetime-info">
            <h4>HSE Cutoff Date/Time</h4>
            <p>Only process Health Service Events and Outcome of Referral results entered into Cerner on or after this date. Leave empty to process all records without restriction.</p>
          </div>
          <div class="datetime-controls">
            <input
              type="datetime-local"
              [value]="cutoffLocalValue"
              (change)="onCutoffChange($event)"
              class="datetime-input" />
            @if (config.HSE_CUTOFF_DT_TM) {
              <button class="clear-btn" (click)="clearCutoff()">Clear</button>
            }
          </div>
        </div>
      </div>
      ...
      <div class="status-summary">
        ...
        <div class="status-grid">
          ...
          <div class="status-item">
            <span class="status-label">HSE Cutoff:</span>
            <span class="status-value">
              {{ config.HSE_CUTOFF_DT_TM ? config.HSE_CUTOFF_DT_TM : 'Disabled (all records)' }}
            </span>
          </div>
        </div>
      </div>
    </div>
  `, changeDetection: ChangeDetectionStrategy.OnPush, styles: ['/* angular:styles/component:scss;8d681d1972fbc772a78d0968c643b49c062c381ba90a7cf4a2637172f348e3be;/Users/chadcummings/Github/chadcumm/gbin-mha-pds/src/app/config-editor/sections/config-section-processing.ts */\n.section-content {\n  max-width: 800px;\n}\n.future-note {\n  color: #e65100;\n  font-size: 12px;\n  font-style: italic;\n  margin-top: 4px;\n}\n.toggle-list {\n  display: flex;\n  flex-direction: column;\n  gap: 16px;\n}\n.toggle-item {\n  display: flex;\n  justify-content: space-between;\n  align-items: flex-start;\n  gap: 20px;\n  padding: 20px;\n  background-color: #f8f9fa;\n  border: 1px solid #e9ecef;\n  border-radius: 8px;\n  transition: all 0.2s ease;\n}\n.toggle-item.enabled {\n  background-color: #e7f3ff;\n  border-color: #b3d9ff;\n}\n.toggle-item .toggle-info {\n  flex: 1;\n}\n.toggle-item .toggle-info h4 {\n  margin: 0 0 6px 0;\n  color: #333;\n  font-size: 15px;\n  font-weight: 600;\n}\n.toggle-item .toggle-info p {\n  margin: 0;\n  color: #555;\n  font-size: 13px;\n  line-height: 1.5;\n}\n.toggle-item .toggle-info .warning-badge {\n  margin-top: 10px;\n  padding: 8px 12px;\n  background-color: #fff3cd;\n  border: 1px solid #ffc107;\n  border-radius: 4px;\n}\n.toggle-item .toggle-info .warning-badge span {\n  color: #856404;\n  font-size: 12px;\n  font-weight: 500;\n}\n.toggle-switch {\n  position: relative;\n  display: inline-block;\n  width: 50px;\n  height: 26px;\n  flex-shrink: 0;\n}\n.toggle-switch input {\n  opacity: 0;\n  width: 0;\n  height: 0;\n}\n.toggle-switch input:checked + .toggle-slider {\n  background-color: #0078d4;\n}\n.toggle-switch input:checked + .toggle-slider:before {\n  transform: translateX(24px);\n}\n.toggle-switch input:focus + .toggle-slider {\n  box-shadow: 0 0 0 3px rgba(0, 120, 212, 0.2);\n}\n.toggle-switch .toggle-slider {\n  position: absolute;\n  cursor: pointer;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  background-color: #ccc;\n  border-radius: 26px;\n  transition: 0.3s;\n}\n.toggle-switch .toggle-slider:before {\n  position: absolute;\n  content: "";\n  height: 20px;\n  width: 20px;\n  left: 3px;\n  bottom: 3px;\n  background-color: white;\n  border-radius: 50%;\n  transition: 0.3s;\n}\n.datetime-section {\n  margin-top: 16px;\n}\n.datetime-item {\n  display: flex;\n  justify-content: space-between;\n  align-items: flex-start;\n  gap: 20px;\n  padding: 20px;\n  background-color: #f8f9fa;\n  border: 1px solid #e9ecef;\n  border-radius: 8px;\n}\n.datetime-item .datetime-info {\n  flex: 1;\n}\n.datetime-item .datetime-info h4 {\n  margin: 0 0 6px 0;\n  color: #333;\n  font-size: 15px;\n  font-weight: 600;\n}\n.datetime-item .datetime-info p {\n  margin: 0;\n  color: #555;\n  font-size: 13px;\n  line-height: 1.5;\n}\n.datetime-item .datetime-controls {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n  flex-shrink: 0;\n}\n.datetime-item .datetime-input {\n  padding: 6px 10px;\n  border: 1px solid #ced4da;\n  border-radius: 4px;\n  font-size: 13px;\n  color: #333;\n  background-color: #fff;\n}\n.datetime-item .datetime-input:focus {\n  outline: none;\n  border-color: #0078d4;\n  box-shadow: 0 0 0 3px rgba(0, 120, 212, 0.2);\n}\n.datetime-item .clear-btn {\n  padding: 6px 12px;\n  border: 1px solid #dc3545;\n  border-radius: 4px;\n  background-color: #fff;\n  color: #dc3545;\n  font-size: 12px;\n  cursor: pointer;\n  white-space: nowrap;\n}\n.datetime-item .clear-btn:hover {\n  background-color: #dc3545;\n  color: #fff;\n}\n.status-summary {\n  margin-top: 24px;\n  padding: 16px;\n  background-color: #fff;\n  border: 1px solid #dee2e6;\n  border-radius: 6px;\n}\n.status-summary h4 {\n  margin: 0 0 12px 0;\n  color: #333;\n  font-size: 14px;\n  font-weight: 600;\n}\n.status-summary .status-grid {\n  display: grid;\n  grid-template-columns: repeat(3, 1fr);\n  gap: 16px;\n}\n@media (max-width: 600px) {\n  .status-summary .status-grid {\n    grid-template-columns: 1fr;\n  }\n}\n.status-summary .status-item {\n  display: flex;\n  flex-direction: column;\n  gap: 4px;\n}\n.status-summary .status-item .status-label {\n  color: #6c757d;\n  font-size: 12px;\n  font-weight: 500;\n}\n.status-summary .status-item .status-value {\n  color: #333;\n  font-size: 14px;\n  font-weight: 600;\n}\n.status-summary .status-item .status-value.warning {\n  color: #856404;\n}\n'] }]
  }], null, { config: [{
    type: Input
  }], configChange: [{
    type: Output
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConfigSectionProcessing, { className: "ConfigSectionProcessing", filePath: "src/app/config-editor/sections/config-section-processing.ts", lineNumber: 391 });
})();
...
function MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_4_For_2_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r16 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "input", 86);
    \u0275\u0275listener("ngModelChange", function MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_4_For_2_Conditional_3_Template_input_ngModelChange_0_listener($event) {
      \u0275\u0275restoreView(_r16);
      const \u0275$index_328_r15 = \u0275\u0275nextContext().$index;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.updateTableField(\u0275$index_328_r15, "EVENT_CD_VALUE", $event));
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const table_r17 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275property("ngModel", table_r17.EVENT_CD_VALUE);
  }
}
function MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_4_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(3, MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_4_For_2_Conditional_3_Template, 1, 1, "input", 83);
    \u0275\u0275elementStart(4, "input", 84);
    \u0275\u0275listener("ngModelChange", function MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_4_For_2_Template_input_ngModelChange_4_listener($event) {
      const \u0275$index_328_r15 = \u0275\u0275restoreView(_r14).$index;
      const ctx_r1 = \u0275\u0275nextContext(4);
    ...
    \u0275\u0275listener("click", function MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_4_For_2_Template_button_click_5_listener() {
      const \u0275$index_328_r15 = \u0275\u0275restoreView(_r14).$index;
      const ctx_r1 = \u0275\u0275nextContext(4);
  ...
  if (rf & 2) {
    const table_r17 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", table_r17.TABLE);
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", table_r17.FIELD_NAME);
    \u0275\u0275advance();
    \u0275\u0275conditional(table_r17.TABLE === "CLINICAL_EVENT" && table_r17.FIELD_NAME === "EVENT_CD" ? 3 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", table_r17.PRIORITY);
  }
}
function MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 77);
    \u0275\u0275repeaterCreate(1, MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_4_For_2_Template, 7, 4, "div", 80, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_11_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 80)(1, "input", 87);
    \u0275\u0275listener("ngModelChange", function MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_11_For_2_Template_input_ngModelChange_1_listener($event) {
      const \u0275$index_358_r19 = \u0275\u0275restoreView(_r18).$index;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.updateDtaField(\u0275$index_358_r19, "DTA", $event));
    });
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("ngModelChange", function MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_11_For_2_Template_input_ngModelChange_2_listener($event) {
      const \u0275$index_358_r19 = \u0275\u0275restoreView(_r18).$index;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.updateDtaField(\u0275$index_358_r19, "PRIORITY", $event));
    });
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_11_For_2_Template_button_click_3_listener() {
      const \u0275$index_358_r19 = \u0275\u0275restoreView(_r18).$index;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.removeDta(\u0275$index_358_r19));
    });
    \u0275\u0275text(4, "\xD7");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const dta_r20 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", dta_r20.DTA);
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", dta_r20.PRIORITY);
  }
}
...
function MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_18_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 80)(1, "input", 88);
    \u0275\u0275listener("ngModelChange", function MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_18_For_2_Template_input_ngModelChange_1_listener($event) {
      const \u0275$index_383_r22 = \u0275\u0275restoreView(_r21).$index;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.updateCodeSetField(\u0275$index_383_r22, "CODE_SET", $event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "input", 84);
    \u0275\u0275listener("ngModelChange", function MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_18_For_2_Template_input_ngModelChange_2_listener($event) {
      const \u0275$index_383_r22 = \u0275\u0275restoreView(_r21).$index;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.updateCodeSetField(\u0275$index_383_r22, "PRIORITY", $event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 85);
    \u0275\u0275listener("click", function MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_18_For_2_Template_button_click_3_listener() {
      const \u0275$index_383_r22 = \u0275\u0275restoreView(_r21).$index;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.removeCodeSet(\u0275$index_383_r22));
    });
    \u0275\u0275text(4, "\xD7");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", cs_r23.CODE_SET);
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", cs_r23.PRIORITY);
  }
}
...
function MappingEditorDrawer_Conditional_2_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 10)(1, "div", 89)(2, "h4");
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(18, "div", 89)(19, "h4");
    \u0275\u0275text(20, "Identifier System");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "p", 90);
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(35, "div", 89)(36, "h4");
    \u0275\u0275text(37, "Value Metadata");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "p", 90);
...
function MappingEditorDrawer_Conditional_2_Conditional_23_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(error_r25.message);
  }
}
function MappingEditorDrawer_Conditional_2_Conditional_23_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 12);
    \u0275\u0275repeaterCreate(1, MappingEditorDrawer_Conditional_2_Conditional_23_For_2_Template, 2, 1, "div", 100, _forTrack13);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
                  ...
                  <div class="source-list">
                    @for (table of editedMapping()!.TABLES; track $index; let i = $index) {
                      <div class="source-item">
                        ...
                        @if (table.TABLE === 'CLINICAL_EVENT' && table.FIELD_NAME === 'EVENT_CD') {
                          <input
                            type="number"
                            class="form-control"
                            placeholder="Event CD Value"
                            [ngModel]="table.EVENT_CD_VALUE"
                            (ngModelChange)="updateTableField(i, 'EVENT_CD_VALUE', $event)" />
                        }
                        <input
                          type="number"
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MappingEditorDrawer, { className: "MappingEditorDrawer", filePath: "src/app/config-editor/sections/mapping-editor-drawer.ts", lineNumber: 1155 });
})();
...
var _forTrack010 = ($index, $item) => $item.DCP_FORMS_REF_ID;
var _forTrack18 = ($index, $item) => $item.EVENT_TYPE_NAME;
function ConfigSectionServiceEventTypesComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 3)(1, "button", 9);
    \u0275\u0275listener("click", function ConfigSectionServiceEventTypesComponent_Conditional_9_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.openAddForm());
    });
    \u0275\u0275text(2, " + Add Service Event Type ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 10);
    \u0275\u0275listener("click", function ConfigSectionServiceEventTypesComponent_Conditional_9_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onDiscoverForms());
    });
    \u0275\u0275text(4, " Discover Forms ");
    \u0275\u0275elementEnd()();
  }
}
...
function ConfigSectionServiceEventTypesComponent_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 4)(1, "input", 11);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(2, ConfigSectionServiceEventTypesComponent_Conditional_10_Conditional_2_Template, 2, 0, "button", 12);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function ConfigSectionServiceEventTypesComponent_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(12, "div", 14)(13, "div", 20)(14, "label", 21);
...
function ConfigSectionServiceEventTypesComponent_Conditional_12_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 28);
    \u0275\u0275text(1, "Searching for PowerForms with MHA Time/Workload section...");
    \u0275\u0275elementEnd();
  }
}
function ConfigSectionServiceEventTypesComponent_Conditional_12_Conditional_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r1.discoveryError());
  }
}
function ConfigSectionServiceEventTypesComponent_Conditional_12_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 30);
    \u0275\u0275text(1, "No PowerForms found with MHA Time/Workload section.");
    \u0275\u0275elementEnd();
  }
}
function ConfigSectionServiceEventTypesComponent_Conditional_12_Conditional_9_For_2_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 38);
...
function ConfigSectionServiceEventTypesComponent_Conditional_12_Conditional_9_For_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "label", 35)(1, "input", 36);
    \u0275\u0275listener("change", function ConfigSectionServiceEventTypesComponent_Conditional_12_Conditional_9_For_2_Template_input_change_1_listener() {
      const form_r9 = \u0275\u0275restoreView(_r8).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.toggleFormSelection(form_r9.DCP_FORMS_REF_ID));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "span", 37);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(4, ConfigSectionServiceEventTypesComponent_Conditional_12_Conditional_9_For_2_Conditional_4_Template, 2, 0, "span", 38);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const form_r9 = ctx.$implicit;
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275classProp("already-configured", form_r9.alreadyConfigured);
    \u0275\u0275advance();
    \u0275\u0275property("checked", ctx_r1.selectedFormIds().has(form_r9.DCP_FORMS_REF_ID))("disabled", form_r9.alreadyConfigured);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(form_r9.FORM_DESCRIPTION);
    \u0275\u0275advance();
    \u0275\u0275conditional(form_r9.alreadyConfigured ? 4 : -1);
  }
}
function ConfigSectionServiceEventTypesComponent_Conditional_12_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 31);
    \u0275\u0275repeaterCreate(1, ConfigSectionServiceEventTypesComponent_Conditional_12_Conditional_9_For_2_Template, 5, 6, "label", 32, _forTrack010);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 33)(4, "button", 34);
    \u0275\u0275listener("click", function ConfigSectionServiceEventTypesComponent_Conditional_12_Conditional_9_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.addSelectedForms());
    });
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "button", 24);
    \u0275\u0275listener("click", function ConfigSectionServiceEventTypesComponent_Conditional_12_Conditional_9_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.closeDiscoveryPanel());
    });
    \u0275\u0275text(7, "Cancel");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r1.discoveryList());
    \u0275\u0275advance(3);
    \u0275\u0275property("disabled", ctx_r1.selectedFormIds().size === 0);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" Add Selected (", ctx_r1.selectedFormIds().size, ") ");
  }
}
function ConfigSectionServiceEventTypesComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 6)(1, "div", 26)(2, "h4");
    \u0275\u0275text(3, "Discover PowerForms");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "button", 27);
    \u0275\u0275listener("click", function ConfigSectionServiceEventTypesComponent_Conditional_12_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeDiscoveryPanel());
    });
    \u0275\u0275text(5, "\xD7");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(6, ConfigSectionServiceEventTypesComponent_Conditional_12_Conditional_6_Template, 2, 0, "div", 28)(7, ConfigSectionServiceEventTypesComponent_Conditional_12_Conditional_7_Template, 2, 1, "div", 29)(8, ConfigSectionServiceEventTypesComponent_Conditional_12_Conditional_8_Template, 2, 0, "div", 30)(9, ConfigSectionServiceEventTypesComponent_Conditional_12_Conditional_9_Template, 8, 2);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(6);
    \u0275\u0275conditional(ctx_r1.discoveryLoading() ? 6 : ctx_r1.discoveryError() ? 7 : ctx_r1.discoveryList().length === 0 ? 8 : 9);
  }
}
function ConfigSectionServiceEventTypesComponent_Conditional_13_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
...
function ConfigSectionServiceEventTypesComponent_Conditional_13_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 41);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ConfigSectionServiceEventTypesComponent_Conditional_13_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 41);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ConfigSectionServiceEventTypesComponent_Conditional_13_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
...
function ConfigSectionServiceEventTypesComponent_Conditional_13_For_21_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "td", 45)(1, "button", 50);
    \u0275\u0275listener("click", function ConfigSectionServiceEventTypesComponent_Conditional_13_For_21_Conditional_11_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r13);
      const eventType_r12 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.onRemoveEventType(eventType_r12));
    });
    \u0275\u0275text(2, " Remove ");
    \u0275\u0275elementEnd()();
  }
}
function ConfigSectionServiceEventTypesComponent_Conditional_13_For_21_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr")(1, "td", 39)(2, "label", 47)(3, "input", 36);
    \u0275\u0275listener("change", function ConfigSectionServiceEventTypesComponent_Conditional_13_For_21_Template_input_change_3_listener($event) {
      const eventType_r12 = \u0275\u0275restoreView(_r11).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.onToggleActive(eventType_r12, $event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275element(4, "span", 48);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(11, ConfigSectionServiceEventTypesComponent_Conditional_13_For_21_Conditional_11_Template, 3, 0, "td", 45);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const eventType_r12 = ctx.$implicit;
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275classProp("inactive", eventType_r12.ACTIVE_IND === 0);
    \u0275\u0275advance(3);
    \u0275\u0275property("checked", eventType_r12.ACTIVE_IND === 1)("disabled", ctx_r1.readonly);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(eventType_r12.EVENT_TITLE_TEXT);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(eventType_r12.EVENT_TYPE_NAME);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(eventType_r12.DESCRIPTION);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r1.readonly ? 11 : -1);
  }
}
function ConfigSectionServiceEventTypesComponent_Conditional_13_ForEmpty_22_Template(rf, ctx) {
  if (rf & 1) {
...
function ConfigSectionServiceEventTypesComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 7)(1, "table")(2, "thead")(3, "tr")(4, "th", 39)(5, "button", 40);
    \u0275\u0275listener("click", function ConfigSectionServiceEventTypesComponent_Conditional_13_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.sortBy("ACTIVE_IND"));
    });
    \u0275\u0275text(6, " Active ");
    \u0275\u0275conditionalCreate(7, ConfigSectionServiceEventTypesComponent_Conditional_13_Conditional_7_Template, 2, 1, "span", 41);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "th", 42)(9, "button", 40);
    \u0275\u0275listener("click", function ConfigSectionServiceEventTypesComponent_Conditional_13_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.sortBy("EVENT_TITLE_TEXT"));
    });
    \u0275\u0275text(10, " Event Title Text ");
    \u0275\u0275conditionalCreate(11, ConfigSectionServiceEventTypesComponent_Conditional_13_Conditional_11_Template, 2, 1, "span", 41);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "th", 43)(13, "button", 40);
    \u0275\u0275listener("click", function ConfigSectionServiceEventTypesComponent_Conditional_13_Template_button_click_13_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.sortBy("EVENT_TYPE_NAME"));
    });
    \u0275\u0275text(14, " Event Type Name ");
    \u0275\u0275conditionalCreate(15, ConfigSectionServiceEventTypesComponent_Conditional_13_Conditional_15_Template, 2, 1, "span", 41);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "th", 44);
    \u0275\u0275text(17, "Description");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(18, ConfigSectionServiceEventTypesComponent_Conditional_13_Conditional_18_Template, 2, 0, "th", 45);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(19, "tbody");
    \u0275\u0275repeaterCreate(20, ConfigSectionServiceEventTypesComponent_Conditional_13_For_21_Template, 12, 8, "tr", 46, _forTrack18, false, ConfigSectionServiceEventTypesComponent_Conditional_13_ForEmpty_22_Template, 3, 2, "tr");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function ConfigSectionServiceEventTypesComponent_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
...
var ConfigSectionServiceEventTypesComponent = class _ConfigSectionServiceEventTypesComponent {
  ...
  // Discovery inputs (signal inputs for reactivity with computed())
  discoveredForms = input([], ...ngDevMode ? [{ debugName: "discoveredForms" }] : []);
  discoveryLoading = input(false, ...ngDevMode ? [{ debugName: "discoveryLoading" }] : []);
  discoveryError = input(null, ...ngDevMode ? [{ debugName: "discoveryError" }] : []);
  discoverForms = new EventEmitter();
  ...
  // Discovery UI state
  showDiscoveryPanel = signal(false, ...ngDevMode ? [{ debugName: "showDiscoveryPanel" }] : []);
  selectedFormIds = signal(/* @__PURE__ */ new Set(), ...ngDevMode ? [{ debugName: "selectedFormIds" }] : []);
  ...
  discoveryList = computed(() => {
    const configured = new Set(this.serviceEventTypes().map((e) => e.EVENT_TITLE_TEXT.toUpperCase()));
    return this.discoveredForms().map((form) => __spreadProps(__spreadValues({}, form), {
      alreadyConfigured: configured.has(form.FORM_DESCRIPTION.toUpperCase())
    }));
  }, ...ngDevMode ? [{ debugName: "discoveryList" }] : []);
  ...
  onDiscoverForms() {
    this.showDiscoveryPanel.set(true);
    this.selectedFormIds.set(/* @__PURE__ */ new Set());
    this.discoverForms.emit();
  }
  toggleFormSelection(formId) {
    const current = new Set(this.selectedFormIds());
    if (current.has(formId)) {
      current.delete(formId);
    } else {
      current.add(formId);
    }
    this.selectedFormIds.set(current);
  }
  addSelectedForms() {
    if (!this.configuration())
      return;
    const selected = this.discoveryList().filter((f) => this.selectedFormIds().has(f.DCP_FORMS_REF_ID) && !f.alreadyConfigured);
    const newTypes = selected.map((form) => ({
      EVENT_TITLE_TEXT: form.FORM_DESCRIPTION,
      EVENT_TYPE_NAME: form.FORM_DESCRIPTION.toUpperCase().replace(/[^A-Z0-9\s]/g, "").replace(/\s+/g, "_").replace(/^_+|_+$/g, ""),
      DESCRIPTION: form.FORM_DESCRIPTION,
      DCP_EVENT_CD: 258355,
      ACTIVE_IND: 1
    }));
    const updatedEventTypes = [...this.serviceEventTypes(), ...newTypes];
    this.emitUpdate(updatedEventTypes);
    this.showDiscoveryPanel.set(false);
    this.selectedFormIds.set(/* @__PURE__ */ new Set());
  }
  closeDiscoveryPanel() {
    this.showDiscoveryPanel.set(false);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConfigSectionServiceEventTypesComponent, selectors: [["app-config-section-service-event-types"]], inputs: { configuration: [1, "configuration"], readonly: "readonly", discoveredForms: [1, "discoveredForms"], discoveryLoading: [1, "discoveryLoading"], discoveryError: [1, "discoveryError"] }, outputs: { configurationChange: "configurationChange", discoverForms: "discoverForms" }, decls: 15, vars: 7, consts: [[1, "section-content"], [1, "summary-bar"], [1, "stat"], [1, "btn-group"], [1, "search-bar"], [1, "add-form"], [1, "discovery-panel"], [1, "event-types-table"], [1, "empty-state"], [1, "btn-add", 3, "click"], [1, "btn-discover", 3, "click"], ["type", "text", "placeholder", "Search by event title or type name...", 1, "search-input", 3, "input", "value"], [1, "btn-clear-search"], [1, "btn-clear-search", 3, "click"], [1, "form-row"], [1, "form-group"], ["for", "eventTitleText"], ["type", "text", "id", "eventTitleText", "placeholder", "e.g., Initial Assessment - Outpatient MHA", 3, "ngModelChange", "ngModel"], ["for", "eventTypeName"], ["type", "text", "id", "eventTypeName", "placeholder", "e.g., INITIAL_ASSESSMENT", 3, "ngModelChange", "ngModel"], [1, "form-group", "full-width"], ["for", "description"], ["type", "text", "id", "description", "placeholder", "Human-readable description of this event type", 3, "ngModelChange", "ngModel"], [1, "form-actions"], [1, "btn-cancel", 3, "click"], [1, "btn-save", 3, "click", "disabled"], [1, "discovery-header"], [1, "btn-close", 3, "click"], [1, "discovery-loading"], [1, "discovery-error"], [1, "discovery-empty"], [1, "discovery-list"], [1, "discovery-item", 3, "already-configured"], [1, "discovery-actions"], [1, "btn-add-selected", 3, "click", "disabled"], [1, "discovery-item"], ["type", "checkbox", 3, "change", "checked", "disabled"], [1, "form-name"], [1, "badge-configured"], [1, "col-active"], [1, "sort-btn", 3, "click"], [1, "sort-indicator"], [1, "col-title"], [1, "col-type"], [1, "col-description"], [1, "col-actions"], [3, "inactive"], [1, "toggle-switch"], [1, "toggle-slider"], [1, "col-type", "code"], [1, "btn-remove", 3, "click"], [1, "no-results"], [1, "hint"]], template: function ConfigSectionServiceEventTypesComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(9, ConfigSectionServiceEventTypesComponent_Conditional_9_Template, 5, 0, "div", 3);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275conditionalCreate(12, ConfigSectionServiceEventTypesComponent_Conditional_12_Template, 10, 1, "div", 6);
      \u0275\u0275conditionalCreate(13, ConfigSectionServiceEventTypesComponent_Conditional_13_Template, 23, 5, "div", 7)(14, ConfigSectionServiceEventTypesComponent_Conditional_14_Template, 5, 0, "div", 8);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(4);
      ...
      <div class="summary-bar">
        ...
        @if (!readonly) {
          <div class="btn-group">
            ...
            <button class="btn-discover" (click)="onDiscoverForms()">
              Discover Forms
            </button>
          </div>
        }
      ...
      @if (showDiscoveryPanel()) {
        <div class="discovery-panel">
          <div class="discovery-header">
            <h4>Discover PowerForms</h4>
            <button class="btn-close" (click)="closeDiscoveryPanel()">&times;</button>
          </div>

          @if (discoveryLoading()) {
            <div class="discovery-loading">Searching for PowerForms with MHA Time/Workload section...</div>
          } @else if (discoveryError()) {
            <div class="discovery-error">{{ discoveryError() }}</div>
          } @else if (discoveryList().length === 0) {
            <div class="discovery-empty">No PowerForms found with MHA Time/Workload section.</div>
          } @else {
            <div class="discovery-list">
              @for (form of discoveryList(); track form.DCP_FORMS_REF_ID) {
                <label class="discovery-item" [class.already-configured]="form.alreadyConfigured">
                  <input
                    type="checkbox"
                    [checked]="selectedFormIds().has(form.DCP_FORMS_REF_ID)"
                    [disabled]="form.alreadyConfigured"
                    (change)="toggleFormSelection(form.DCP_FORMS_REF_ID)" />
                  <span class="form-name">{{ form.FORM_DESCRIPTION }}</span>
                  @if (form.alreadyConfigured) {
                    <span class="badge-configured">Already configured</span>
                  }
                </label>
              }
            </div>
            <div class="discovery-actions">
              <button
                ...
                Add Selected ({{ selectedFormIds().size }})
              </button>
              <button class="btn-cancel" (click)="closeDiscoveryPanel()">Cancel</button>
            </div>
          }
        </div>
      }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConfigSectionServiceEventTypesComponent, { className: "ConfigSectionServiceEventTypesComponent", filePath: "src/app/config-editor/sections/config-section-service-event-types.ts", lineNumber: 709 });
})();
...
var KNOWN_SECTION_LABELS = {
  ...
  SERVICE_EVENT_TYPES: "Service Event Types",
  TIME_INTERVAL_MAPPINGS: "Time Intervals",
  SUBMIT_FIELDS: "Submit Fields",
  CODE_TABLES: "Code Tables",
  CODE_TABLE_MAPPINGS: "Code Table Mappings",
  MAPPINGS: "Mappings",
  FHIR_RESOURCE_CODES: "FHIR Codes",
  MHA_LOCATIONS: "MHA Locations",
  REPORTS: "Reports",
  ACCESS_CONTROL: "Access Control"
};
var SKIP_KEYS = /* @__PURE__ */ new Set(["UPDT_DT_TM"]);
function toTitleCase(key) {
  return key.replace(/_CNT$/, "").split("_").map((w) => w.charAt(0) + w.slice(1).toLowerCase()).join(" ");
}
var ConfigSectionJsonEditorComponent = class _ConfigSectionJsonEditorComponent {
  ...
  /** Dynamically built from config keys — always includes Full Configuration first */
  get sectionOptions() {
    const options = [
    ...
    if (this.config) {
      for (const key of Object.keys(this.config)) {
        ...
        if (key.endsWith("_CNT"))
          continue;
        const label = KNOWN_SECTION_LABELS[key] ?? toTitleCase(key);
  ...
  applySectionToConfig(config, section, data) {
    ...
    if (Array.isArray(data)) {
      const cntKey = section === "CODE_TABLE_MAPPINGS" ? "CODE_TABLE_MAPPING_CNT" : `${section}_CNT`;
      if (cntKey in this.config) {
        config[cntKey] = data.length;
      }
    }
  }
  validateJson(value) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConfigSectionJsonEditorComponent, { className: "ConfigSectionJsonEditorComponent", filePath: "src/app/config-editor/sections/config-section-json-editor.ts", lineNumber: 370 });
})();

// src/app/config-editor/sections/config-section-reports.ts
var _forTrack013 = ($index, $item) => $item.REPORT_ID;
var _forTrack19 = ($index, $item) => $item.key;
function ConfigSectionReportsComponent_Conditional_11_For_27_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2("", cat_r3.key, " \u2014 ", cat_r3.label);
  }
}
function ConfigSectionReportsComponent_Conditional_11_Conditional_37_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 28);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ConfigSectionReportsComponent_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 4)(1, "div", 8)(2, "div", 9)(3, "label", 10);
    \u0275\u0275text(4, "Report ID");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "input", 11);
    \u0275\u0275listener("ngModelChange", function ConfigSectionReportsComponent_Conditional_11_Template_input_ngModelChange_5_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.newReportId.set($event));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 9)(7, "label", 12);
    \u0275\u0275text(8, "Title");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "input", 13);
    \u0275\u0275listener("ngModelChange", function ConfigSectionReportsComponent_Conditional_11_Template_input_ngModelChange_9_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.newTitle.set($event));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "div", 9)(11, "label", 14);
    \u0275\u0275text(12, "Render Type");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "select", 15);
    \u0275\u0275listener("ngModelChange", function ConfigSectionReportsComponent_Conditional_11_Template_select_ngModelChange_13_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.newRenderType.set($event));
    });
    \u0275\u0275elementStart(14, "option", 16);
    \u0275\u0275text(15, "Spreadsheet");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "option", 17);
    \u0275\u0275text(17, "MPage Table");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "option", 18);
    \u0275\u0275text(19, "PDF");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(20, "div", 9)(21, "label", 19);
    \u0275\u0275text(22, "Category");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "select", 20);
    \u0275\u0275listener("ngModelChange", function ConfigSectionReportsComponent_Conditional_11_Template_select_ngModelChange_23_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.newCategory.set($event));
    });
    \u0275\u0275elementStart(24, "option", 21);
    \u0275\u0275text(25, "(No category \u2014 visible to all)");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(26, ConfigSectionReportsComponent_Conditional_11_For_27_Template, 2, 3, "option", 22, _forTrack19);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(28, "div", 9)(29, "label", 23);
    \u0275\u0275text(30, "CCL Script");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "input", 24);
    \u0275\u0275listener("ngModelChange", function ConfigSectionReportsComponent_Conditional_11_Template_input_ngModelChange_31_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.newCclScript.set($event));
    });
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(32, "div", 25)(33, "button", 26);
    \u0275\u0275listener("click", function ConfigSectionReportsComponent_Conditional_11_Template_button_click_33_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onAddReport());
    });
    \u0275\u0275text(34, " Add ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "button", 27);
    \u0275\u0275listener("click", function ConfigSectionReportsComponent_Conditional_11_Template_button_click_35_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onCancelAdd());
    });
    \u0275\u0275text(36, " Cancel ");
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(37, ConfigSectionReportsComponent_Conditional_11_Conditional_37_Template, 2, 1, "div", 28);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275property("ngModel", ctx_r1.newReportId());
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r1.newTitle());
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx_r1.newRenderType());
    \u0275\u0275advance(10);
    \u0275\u0275property("ngModel", ctx_r1.newCategory());
    \u0275\u0275advance(3);
    \u0275\u0275repeater(ctx_r1.categoryOptions());
    \u0275\u0275advance(5);
    \u0275\u0275property("ngModel", ctx_r1.newCclScript());
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", !ctx_r1.canAdd());
    \u0275\u0275advance(4);
    \u0275\u0275conditional(ctx_r1.addError() ? 37 : -1);
  }
}
function ConfigSectionReportsComponent_For_14_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 34);
    \u0275\u0275text(1, "Inactive");
    \u0275\u0275elementEnd();
...
function ConfigSectionReportsComponent_For_14_Conditional_17_For_27_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 22);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2("", cat_r8.key, " \u2014 ", cat_r8.label);
  }
}
function ConfigSectionReportsComponent_For_14_Conditional_17_Conditional_44_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 45)(1, "h6");
    \u0275\u0275text(2, "Table Parameters");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 8)(4, "label", 53)(5, "input", 54);
    \u0275\u0275listener("ngModelChange", function ConfigSectionReportsComponent_For_14_Conditional_17_Conditional_44_Template_input_ngModelChange_5_listener($event) {
      \u0275\u0275restoreView(_r9);
      const \u0275$index_88_r7 = \u0275\u0275nextContext(2).$index;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onTableParamChange(\u0275$index_88_r7, "SHOW_TOOLBAR", $event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275text(6, " Show Toolbar ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "label", 53)(8, "input", 54);
    \u0275\u0275listener("ngModelChange", function ConfigSectionReportsComponent_For_14_Conditional_17_Conditional_44_Template_input_ngModelChange_8_listener($event) {
      \u0275\u0275restoreView(_r9);
      const \u0275$index_88_r7 = \u0275\u0275nextContext(2).$index;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onTableParamChange(\u0275$index_88_r7, "COLUMN_FILTER", $event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275text(9, " Column Filter ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "label", 53)(11, "input", 54);
    \u0275\u0275listener("ngModelChange", function ConfigSectionReportsComponent_For_14_Conditional_17_Conditional_44_Template_input_ngModelChange_11_listener($event) {
      \u0275\u0275restoreView(_r9);
      const \u0275$index_88_r7 = \u0275\u0275nextContext(2).$index;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onTableParamChange(\u0275$index_88_r7, "HIDE_ID_VALUES", $event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275text(12, " Hide ID Values ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "div", 42)(14, "label");
    \u0275\u0275text(15, "Max Column Width");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "input", 55);
    \u0275\u0275listener("ngModelChange", function ConfigSectionReportsComponent_For_14_Conditional_17_Conditional_44_Template_input_ngModelChange_16_listener($event) {
      \u0275\u0275restoreView(_r9);
      const \u0275$index_88_r7 = \u0275\u0275nextContext(2).$index;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onTableParamChange(\u0275$index_88_r7, "MAX_INITIAL_COLUMN_WIDTH", +$event));
    });
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const report_r5 = \u0275\u0275nextContext(2).$implicit;
    \u0275\u0275advance(5);
    \u0275\u0275property("ngModel", (report_r5.TABLE_PARAMS == null ? null : report_r5.TABLE_PARAMS.SHOW_TOOLBAR) ?? true);
    \u0275\u0275advance(3);
    \u0275\u0275property("ngModel", (report_r5.TABLE_PARAMS == null ? null : report_r5.TABLE_PARAMS.COLUMN_FILTER) ?? true);
    \u0275\u0275advance(3);
    \u0275\u0275property("ngModel", (report_r5.TABLE_PARAMS == null ? null : report_r5.TABLE_PARAMS.HIDE_ID_VALUES) ?? false);
    \u0275\u0275advance(5);
    \u0275\u0275property("ngModel", (report_r5.TABLE_PARAMS == null ? null : report_r5.TABLE_PARAMS.MAX_INITIAL_COLUMN_WIDTH) ?? 300);
  }
}
function ConfigSectionReportsComponent_For_14_Conditional_17_For_49_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 47)(1, "span", 56);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "input", 57);
    \u0275\u0275listener("ngModelChange", function ConfigSectionReportsComponent_For_14_Conditional_17_For_49_Template_input_ngModelChange_3_listener($event) {
      const key_r11 = \u0275\u0275restoreView(_r10).$implicit;
      const \u0275$index_88_r7 = \u0275\u0275nextContext(2).$index;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onParamChange(\u0275$index_88_r7, key_r11, $event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "button", 58);
    \u0275\u0275listener("click", function ConfigSectionReportsComponent_For_14_Conditional_17_For_49_Template_button_click_4_listener() {
      const key_r11 = \u0275\u0275restoreView(_r10).$implicit;
      const \u0275$index_88_r7 = \u0275\u0275nextContext(2).$index;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onRemoveParam(\u0275$index_88_r7, key_r11));
    });
    \u0275\u0275text(5, "\xD7");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", report_r5.PARAMS[key_r11]);
  }
}
function ConfigSectionReportsComponent_For_14_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 39)(1, "div", 8)(2, "div", 9)(3, "label");
    \u0275\u0275text(4, "Title");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "input", 40);
    \u0275\u0275listener("ngModelChange", function ConfigSectionReportsComponent_For_14_Conditional_17_Template_input_ngModelChange_5_listener($event) {
      \u0275\u0275restoreView(_r6);
      const \u0275$index_88_r7 = \u0275\u0275nextContext().$index;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onFieldChange(\u0275$index_88_r7, "TITLE", $event));
    });
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275listener("ngModelChange", function ConfigSectionReportsComponent_For_14_Conditional_17_Template_input_ngModelChange_9_listener($event) {
      \u0275\u0275restoreView(_r6);
      const \u0275$index_88_r7 = \u0275\u0275nextContext().$index;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onFieldChange(\u0275$index_88_r7, "DESCRIPTION", $event));
    });
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275listener("ngModelChange", function ConfigSectionReportsComponent_For_14_Conditional_17_Template_select_ngModelChange_13_listener($event) {
      \u0275\u0275restoreView(_r6);
      const \u0275$index_88_r7 = \u0275\u0275nextContext().$index;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onFieldChange(\u0275$index_88_r7, "RENDER_TYPE", $event));
    });
    \u0275\u0275elementStart(14, "option", 16);
    \u0275\u0275text(15, "Spreadsheet");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("ngModelChange", function ConfigSectionReportsComponent_For_14_Conditional_17_Template_select_ngModelChange_23_listener($event) {
      \u0275\u0275restoreView(_r6);
      const report_r5 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.updateReportCategory(report_r5, $event));
    });
    \u0275\u0275elementStart(24, "option", 21);
    \u0275\u0275text(25, "(No category \u2014 visible to all)");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(26, ConfigSectionReportsComponent_For_14_Conditional_17_For_27_Template, 2, 3, "option", 22, _forTrack19);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(28, "div", 9)(29, "label");
    \u0275\u0275text(30, "CCL Script");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "input", 40);
    \u0275\u0275listener("ngModelChange", function ConfigSectionReportsComponent_For_14_Conditional_17_Template_input_ngModelChange_31_listener($event) {
      \u0275\u0275restoreView(_r6);
      const \u0275$index_88_r7 = \u0275\u0275nextContext().$index;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onFieldChange(\u0275$index_88_r7, "CCL_SCRIPT", $event));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(32, "div", 42)(33, "label");
    \u0275\u0275text(34, "Sort Sequence");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "input", 43);
    \u0275\u0275listener("ngModelChange", function ConfigSectionReportsComponent_For_14_Conditional_17_Template_input_ngModelChange_35_listener($event) {
      \u0275\u0275restoreView(_r6);
      const \u0275$index_88_r7 = \u0275\u0275nextContext().$index;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onFieldChange(\u0275$index_88_r7, "SORT_SEQ", +$event));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(36, "div", 42)(37, "label");
    \u0275\u0275text(38, "Active");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "select", 41);
    \u0275\u0275listener("ngModelChange", function ConfigSectionReportsComponent_For_14_Conditional_17_Template_select_ngModelChange_39_listener($event) {
      \u0275\u0275restoreView(_r6);
      const \u0275$index_88_r7 = \u0275\u0275nextContext().$index;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onFieldChange(\u0275$index_88_r7, "ACTIVE_IND", +$event));
    });
    \u0275\u0275elementStart(40, "option", 44);
    \u0275\u0275text(41, "Active");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(42, "option", 44);
    \u0275\u0275text(43, "Inactive");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275conditionalCreate(44, ConfigSectionReportsComponent_For_14_Conditional_17_Conditional_44_Template, 17, 4, "div", 45);
    \u0275\u0275elementStart(45, "div", 46)(46, "h6");
    \u0275\u0275text(47, "Parameters");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(48, ConfigSectionReportsComponent_For_14_Conditional_17_For_49_Template, 6, 2, "div", 47, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementStart(50, "div", 47)(51, "input", 48);
    \u0275\u0275listener("ngModelChange", function ConfigSectionReportsComponent_For_14_Conditional_17_Template_input_ngModelChange_51_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.newParamKey.set($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(52, "input", 49);
    \u0275\u0275listener("ngModelChange", function ConfigSectionReportsComponent_For_14_Conditional_17_Template_input_ngModelChange_52_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.newParamValue.set($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(53, "button", 50);
    \u0275\u0275listener("click", function ConfigSectionReportsComponent_For_14_Conditional_17_Template_button_click_53_listener() {
      \u0275\u0275restoreView(_r6);
      const \u0275$index_88_r7 = \u0275\u0275nextContext().$index;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onAddParam(\u0275$index_88_r7));
    });
    \u0275\u0275text(54, "+");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(55, "div", 51)(56, "button", 52);
    \u0275\u0275listener("click", function ConfigSectionReportsComponent_For_14_Conditional_17_Template_button_click_56_listener() {
      \u0275\u0275restoreView(_r6);
      const \u0275$index_88_r7 = \u0275\u0275nextContext().$index;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onDeleteReport(\u0275$index_88_r7));
    });
    \u0275\u0275text(57, " Delete Report ");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const report_r5 = \u0275\u0275nextContext().$implicit;
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(5);
    \u0275\u0275property("ngModel", report_r5.TITLE);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", report_r5.DESCRIPTION);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", report_r5.RENDER_TYPE);
    \u0275\u0275advance(10);
    \u0275\u0275property("ngModel", report_r5.CATEGORY ?? "");
    \u0275\u0275advance(3);
    \u0275\u0275repeater(ctx_r1.categoryOptions());
    \u0275\u0275advance(5);
    \u0275\u0275property("ngModel", report_r5.CCL_SCRIPT);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", report_r5.SORT_SEQ);
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", report_r5.ACTIVE_IND);
    \u0275\u0275advance();
    \u0275\u0275property("ngValue", 1);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngValue", 0);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(report_r5.RENDER_TYPE === "mpage_table" ? 44 : -1);
    \u0275\u0275advance(4);
    \u0275\u0275repeater(ctx_r1.getParamKeys(report_r5));
    \u0275\u0275advance(3);
    \u0275\u0275property("ngModel", ctx_r1.newParamKey());
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", ctx_r1.newParamValue());
    \u0275\u0275advance();
    \u0275\u0275property("disabled", !ctx_r1.newParamKey());
  }
}
function ConfigSectionReportsComponent_For_14_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(7, ConfigSectionReportsComponent_For_14_Conditional_7_Template, 2, 0, "span", 34);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "div", 35)(9, "button", 36);
    \u0275\u0275listener("click", function ConfigSectionReportsComponent_For_14_Template_button_click_9_listener() {
      const report_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleExpand(report_r5.REPORT_ID));
    });
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()()();
    ...
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(17, ConfigSectionReportsComponent_For_14_Conditional_17_Template, 58, 13, "div", 39);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const report_r5 = ctx.$implicit;
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275classProp("inactive", report_r5.ACTIVE_IND === 0);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(report_r5.TITLE);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(report_r5.RENDER_TYPE);
    \u0275\u0275advance();
    \u0275\u0275conditional(report_r5.ACTIVE_IND === 0 ? 7 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275property("title", ctx_r1.expandedId() === report_r5.REPORT_ID ? "Collapse" : "Edit");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.expandedId() === report_r5.REPORT_ID ? "\u25B2" : "\u25BC", " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(report_r5.REPORT_ID);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(report_r5.DESCRIPTION);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.expandedId() === report_r5.REPORT_ID ? 17 : -1);
  }
}
function ConfigSectionReportsComponent_ForEmpty_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 7);
    \u0275\u0275text(1, 'No reports configured. Click "Add Report" to create one.');
    \u0275\u0275elementEnd();
  }
}
var ConfigSectionReportsComponent = class _ConfigSectionReportsComponent {
  accessControl = inject(AccessControlService);
  reports = input([], ...ngDevMode ? [{ debugName: "reports" }] : []);
  reportsChange = output();
  categoryOptions = this.accessControl.availableCategories;
  // Add form state
  showAddForm = signal(false, ...ngDevMode ? [{ debugName: "showAddForm" }] : []);
  newReportId = signal("", ...ngDevMode ? [{ debugName: "newReportId" }] : []);
  newTitle = signal("", ...ngDevMode ? [{ debugName: "newTitle" }] : []);
  newRenderType = signal("mpage_table", ...ngDevMode ? [{ debugName: "newRenderType" }] : []);
  newCclScript = signal("", ...ngDevMode ? [{ debugName: "newCclScript" }] : []);
  newCategory = signal("", ...ngDevMode ? [{ debugName: "newCategory" }] : []);
  addError = signal("", ...ngDevMode ? [{ debugName: "addError" }] : []);
  // Edit state
  expandedId = signal(null, ...ngDevMode ? [{ debugName: "expandedId" }] : []);
  newParamKey = signal("", ...ngDevMode ? [{ debugName: "newParamKey" }] : []);
  newParamValue = signal("", ...ngDevMode ? [{ debugName: "newParamValue" }] : []);
  activeCount = computed(() => this.reports().filter((r) => r.ACTIVE_IND === 1).length, ...ngDevMode ? [{ debugName: "activeCount" }] : []);
  sortedReports = computed(() => [...this.reports()].sort((a, b) => (a.SORT_SEQ ?? 0) - (b.SORT_SEQ ?? 0)), ...ngDevMode ? [{ debugName: "sortedReports" }] : []);
  canAdd = computed(() => {
    const id = this.newReportId().trim();
    const title = this.newTitle().trim();
    const script = this.newCclScript().trim();
    if (!id || !title || !script)
      return false;
    if (!/^[a-zA-Z0-9_]+$/.test(id))
      return false;
    if (this.reports().some((r) => r.REPORT_ID === id))
      return false;
    return true;
  }, ...ngDevMode ? [{ debugName: "canAdd" }] : []);
  ...
  onAddReport() {
    const id = this.newReportId().trim();
    if (this.reports().some((r) => r.REPORT_ID === id)) {
      this.addError.set("Report ID already exists");
      return;
    }
    if (!/^[a-zA-Z0-9_]+$/.test(id)) {
      this.addError.set("Report ID must be alphanumeric with underscores only");
      return;
    }
    const newReport = {
      REPORT_ID: id,
      ...
      DESCRIPTION: "",
      RENDER_TYPE: this.newRenderType(),
      ACTIVE_IND: 1,
      SORT_SEQ: this.reports().length + 1,
      CCL_SCRIPT: this.newCclScript().trim(),
      CATEGORY: this.newCategory(),
      PARAMS: {},
      TABLE_PARAMS: {
        SHOW_TOOLBAR: true,
        COLUMN_FILTER: true,
        HIDE_ID_VALUES: false,
        MAX_INITIAL_COLUMN_WIDTH: 300
      }
    };
    this.reportsChange.emit([...this.reports(), newReport]);
    this.onCancelAdd();
  }
  onCancelAdd() {
    this.showAddForm.set(false);
    this.newReportId.set("");
    this.newTitle.set("");
    this.newRenderType.set("mpage_table");
    this.newCclScript.set("");
    this.newCategory.set("");
    this.addError.set("");
  }
  onFieldChange(index, field, value) {
    const sorted = this.sortedReports();
    const reportId = sorted[index].REPORT_ID;
    const realIndex = this.reports().findIndex((r) => r.REPORT_ID === reportId);
    if (realIndex < 0)
      return;
    const updated = [...this.reports()];
    updated[realIndex] = __spreadProps(__spreadValues({}, updated[realIndex]), { [field]: value });
    this.reportsChange.emit(updated);
  }
  onTableParamChange(index, param, value) {
    const sorted = this.sortedReports();
    const reportId = sorted[index].REPORT_ID;
    const realIndex = this.reports().findIndex((r) => r.REPORT_ID === reportId);
    if (realIndex < 0)
      return;
    const updated = [...this.reports()];
    updated[realIndex] = __spreadProps(__spreadValues({}, updated[realIndex]), {
      TABLE_PARAMS: __spreadProps(__spreadValues({}, updated[realIndex].TABLE_PARAMS), {
        [param]: value
      })
    });
    this.reportsChange.emit(updated);
  ...
  onParamChange(index, key, value) {
    ...
    if (realIndex < 0)
      return;
    const updated = [...this.reports()];
    const params = __spreadValues({}, updated[realIndex].PARAMS);
    const numVal = Number(value);
    params[key] = !isNaN(numVal) && value !== "" ? numVal : value;
    updated[realIndex] = __spreadProps(__spreadValues({}, updated[realIndex]), { PARAMS: params });
    this.reportsChange.emit(updated);
  }
  onAddParam(index) {
    const key = this.newParamKey().trim();
    if (!key)
      return;
    const sorted = this.sortedReports();
    const reportId = sorted[index].REPORT_ID;
    ...
    const updated = [...this.reports()];
    const params = __spreadValues({}, updated[realIndex].PARAMS);
    const value = this.newParamValue().trim();
    const numVal = Number(value);
    params[key] = !isNaN(numVal) && value !== "" ? numVal : value;
    updated[realIndex] = __spreadProps(__spreadValues({}, updated[realIndex]), { PARAMS: params });
    this.reportsChange.emit(updated);
    this.newParamKey.set("");
    this.newParamValue.set("");
  }
  onRemoveParam(index, key) {
    const sorted = this.sortedReports();
    const reportId = sorted[index].REPORT_ID;
    const realIndex = this.reports().findIndex((r) => r.REPORT_ID === reportId);
    if (realIndex < 0)
  ...
  onDeleteReport(index) {
    const sorted = this.sortedReports();
    const reportId = sorted[index].REPORT_ID;
    if (!confirm(`Delete report "${sorted[index].TITLE}"?`))
      return;
    const updated = this.reports().filter((r) => r.REPORT_ID !== reportId);
    this.reportsChange.emit(updated);
    if (this.expandedId() === reportId) {
      this.expandedId.set(null);
    }
  }
  updateReportCategory(report, category) {
    const updated = this.reports().map((r) => r === report ? __spreadProps(__spreadValues({}, r), { CATEGORY: category }) : r);
    this.reportsChange.emit(updated);
  }
  getParamKeys(report) {
    return Object.keys(report.PARAMS ?? {});
  }
  static \u0275fac = function ConfigSectionReportsComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ConfigSectionReportsComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConfigSectionReportsComponent, selectors: [["app-config-section-reports"]], inputs: { reports: [1, "reports"] }, outputs: { reportsChange: "reportsChange" }, decls: 16, vars: 5, consts: [[1, "section-content"], [1, "summary-bar"], [1, "stat"], [1, "btn-add", 3, "click", "disabled"], [1, "add-form"], [1, "report-list"], [1, "report-card", 3, "inactive"], [1, "text-muted"], [1, "form-grid"], [1, "form-group"], ["for", "newReportId"], ["id", "newReportId", "type", "text", "placeholder", "e.g., activity_log", 1, "form-input", 3, "ngModelChange", "ngModel"], ["for", "newTitle"], ["id", "newTitle", "type", "text", "placeholder", "Report display title", 1, "form-input", 3, "ngModelChange", "ngModel"], ["for", "newRenderType"], ["id", "newRenderType", 1, "form-input", 3, "ngModelChange", "ngModel"], ["value", "spreadsheet"], ["value", "mpage_table"], ["value", "pdf"], ["for", "newCategory"], ["id", "newCategory", 1, "form-input", 3, "ngModelChange", "ngModel"], ["value", ""], [3, "value"], ["for", "newCclScript"], ["id", "newCclScript", "type", "text", "placeholder", "gbin_mha_pds_rpt_...", 1, "form-input", 3, "ngModelChange", "ngModel"], [1, "form-actions"], [1, "btn-confirm", 3, "click", "disabled"], [1, "btn-cancel", 3, "click"], [1, "form-error"], [1, "report-card"], [1, "report-header"], [1, "report-header-left"], [1, "report-title"], [1, "badge", "badge-render-type"], [1, "badge", "badge-inactive"], [1, "report-header-right"], [1, "btn-icon", 3, "click", "title"], [1, "report-subtitle"], [1, "report-id"], [1, "report-detail"], ["type", "text", 1, "form-input", 3, "ngModelChange", "ngModel"], [1, "form-input", 3, "ngModelChange", "ngModel"], [1, "form-group", "form-group-narrow"], ["type", "number", "min", "1", 1, "form-input", 3, "ngModelChange", "ngModel"], [3, "ngValue"], [1, "table-params-section"], [1, "params-section"], [1, "param-row"], ["type", "text", "placeholder", "New key", 1, "form-input", "param-key-input", 3, "ngModelChange", "ngModel"], ["type", "text", "placeholder", "Value", 1, "form-input", "param-value", 3, "ngModelChange", "ngModel"], [1, "btn-add-small", 3, "click", "disabled"], [1, "report-actions"], [1, "btn-delete", 3, "click"], [1, "checkbox-label"], ["type", "checkbox", 3, "ngModelChange", "ngModel"], ["type", "number", "min", "100", 1, "form-input", 3, "ngModelChange", "ngModel"], [1, "param-key"], ["type", "text", 1, "form-input", "param-value", 3, "ngModelChange", "ngModel"], [1, "btn-remove", 3, "click"]], template: function ConfigSectionReportsComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "span", 2)(3, "strong");
      \u0275\u0275text(4);
      \u0275\u0275elementEnd();
      \u0275\u0275text(5, " reports configured (");
      \u0275\u0275elementStart(6, "strong");
      \u0275\u0275text(7);
      \u0275\u0275elementEnd();
      \u0275\u0275text(8, " active) ");
      ...
      \u0275\u0275listener("click", function ConfigSectionReportsComponent_Template_button_click_9_listener() {
        return ctx.showAddForm.set(true);
      });
      \u0275\u0275text(10, " + Add Report ");
      \u0275\u0275elementEnd()();
      \u0275\u0275conditionalCreate(11, ConfigSectionReportsComponent_Conditional_11_Template, 38, 7, "div", 4);
      \u0275\u0275elementStart(12, "div", 5);
      \u0275\u0275repeaterCreate(13, ConfigSectionReportsComponent_For_14_Template, 18, 10, "div", 6, _forTrack013, false, ConfigSectionReportsComponent_ForEmpty_15_Template, 2, 0, "p", 7);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(ctx.reports().length);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(ctx.activeCount());
      \u0275\u0275advance(2);
      \u0275\u0275property("disabled", ctx.showAddForm());
    ...
    <div class="section-content">
      ...
      @if (showAddForm()) {
        <div class="add-form">
          <div class="form-grid">
            <div class="form-group">
              <label for="newReportId">Report ID</label>
              <input
                id="newReportId"
                type="text"
                class="form-input"
                ...
                [ngModel]="newReportId()"
                (ngModelChange)="newReportId.set($event)" />
            </div>
            <div class="form-group">
              ...
              <input
                ...
                type="text"
                class="form-input"
                placeholder="Report display title"
                [ngModel]="newTitle()"
                (ngModelChange)="newTitle.set($event)" />
            </div>
            <div class="form-group">
              <label for="newRenderType">Render Type</label>
              <select
                id="newRenderType"
                class="form-input"
                [ngModel]="newRenderType()"
                (ngModelChange)="newRenderType.set($event)">
                <option value="spreadsheet">Spreadsheet</option>
                <option value="mpage_table">MPage Table</option>
            ...
            <div class="form-group">
              ...
              <select
                ...
                <option value="">(No category \u2014 visible to all)</option>
                @for (cat of categoryOptions(); track cat.key) {
                  <option [value]="cat.key">{{ cat.key }} \u2014 {{ cat.label }}</option>
                }
              </select>
            </div>
            <div class="form-group">
              <label for="newCclScript">CCL Script</label>
              <input
                id="newCclScript"
                type="text"
                class="form-input"
                placeholder="gbin_mha_pds_rpt_..."
                [ngModel]="newCclScript()"
                (ngModelChange)="newCclScript.set($event)" />
            </div>
          </div>
          <div class="form-actions">
            <button
      ...
      <div class="report-list">
        @for (report of sortedReports(); track report.REPORT_ID; let i = $index) {
          <div class="report-card" [class.inactive]="report.ACTIVE_IND === 0">
            <div class="report-header">
              <div class="report-header-left">
                <span class="report-title">{{ report.TITLE }}</span>
                <span class="badge badge-render-type">{{ report.RENDER_TYPE }}</span>
                @if (report.ACTIVE_IND === 0) {
                  <span class="badge badge-inactive">Inactive</span>
                }
              </div>
              <div class="report-header-right">
                <button
                  ...
                  [title]="expandedId() === report.REPORT_ID ? 'Collapse' : 'Edit'">
            ...
            @if (expandedId() === report.REPORT_ID) {
              <div class="report-detail">
                <div class="form-grid">
                  <div class="form-group">
                    ...
                    <input
                      ...
                      (ngModelChange)="onFieldChange(i, 'TITLE', $event)" />
                  </div>
                  <div class="form-group">
                    <label>Description</label>
                    <input
                      ...
                      (ngModelChange)="onFieldChange(i, 'DESCRIPTION', $event)" />
                  </div>
                  <div class="form-group">
                    <label>Render Type</label>
                    <select
                      class="form-input"
                      [ngModel]="report.RENDER_TYPE"
                      (ngModelChange)="onFieldChange(i, 'RENDER_TYPE', $event)">
                      <option value="spreadsheet">Spreadsheet</option>
                      <option value="mpage_table">MPage Table</option>
                      <option value="pdf">PDF</option>
                    </select>
                  ...
                  <div class="form-group">
                    ...
                    <select
                      class="form-input"
                      [ngModel]="report.CATEGORY ?? ''"
                      (ngModelChange)="updateReportCategory(report, $event)">
                      <option value="">(No category \u2014 visible to all)</option>
                      @for (cat of categoryOptions(); track cat.key) {
                        <option [value]="cat.key">{{ cat.key }} \u2014 {{ cat.label }}</option>
                      }
                  ...
                  <div class="form-group">
                    <label>CCL Script</label>
                    <input
                      type="text"
                      class="form-input"
                      [ngModel]="report.CCL_SCRIPT"
                      (ngModelChange)="onFieldChange(i, 'CCL_SCRIPT', $event)" />
                  </div>
                  <div class="form-group form-group-narrow">
                    ...
                    <input
                      ...
                      class="form-input"
                      min="1"
                      [ngModel]="report.SORT_SEQ"
                      (ngModelChange)="onFieldChange(i, 'SORT_SEQ', +$event)" />
                  </div>
                  <div class="form-group form-group-narrow">
                    <label>Active</label>
                    <select
                      class="form-input"
                      [ngModel]="report.ACTIVE_IND"
                      (ngModelChange)="onFieldChange(i, 'ACTIVE_IND', +$event)">
                ...
                <!-- Table Params (conditional) -->
                @if (report.RENDER_TYPE === 'mpage_table') {
                  <div class="table-params-section">
                    <h6>Table Parameters</h6>
                    <div class="form-grid">
                      <label class="checkbox-label">
                        <input
                          type="checkbox"
                          [ngModel]="report.TABLE_PARAMS?.SHOW_TOOLBAR ?? true"
                          (ngModelChange)="onTableParamChange(i, 'SHOW_TOOLBAR', $event)" />
                        Show Toolbar
                      </label>
                      <label class="checkbox-label">
                        <input
                          type="checkbox"
                          [ngModel]="report.TABLE_PARAMS?.COLUMN_FILTER ?? true"
                          (ngModelChange)="onTableParamChange(i, 'COLUMN_FILTER', $event)" />
                        Column Filter
                      </label>
                      <label class="checkbox-label">
                        <input
                          type="checkbox"
                          [ngModel]="report.TABLE_PARAMS?.HIDE_ID_VALUES ?? false"
                          (ngModelChange)="onTableParamChange(i, 'HIDE_ID_VALUES', $event)" />
                        Hide ID Values
                      </label>
                      <div class="form-group form-group-narrow">
                        ...
                        <input
                          ...
                          class="form-input"
                          min="100"
                          [ngModel]="report.TABLE_PARAMS?.MAX_INITIAL_COLUMN_WIDTH ?? 300"
                          (ngModelChange)="onTableParamChange(i, 'MAX_INITIAL_COLUMN_WIDTH', +$event)" />
                      </div>
                    </div>
                  </div>
                }
                ...
                <div class="params-section">
                  <h6>Parameters</h6>
                  @for (key of getParamKeys(report); track key) {
                    <div class="param-row">
                      <span class="param-key">{{ key }}</span>
                      <input
                        type="text"
                        class="form-input param-value"
                        [ngModel]="report.PARAMS[key]"
                        (ngModelChange)="onParamChange(i, key, $event)" />
                      <button class="btn-remove" (click)="onRemoveParam(i, key)">\xD7</button>
                    </div>
                  }
                  <div class="param-row">
                    <input
                      type="text"
                      class="form-input param-key-input"
                      placeholder="New key"
                      [ngModel]="newParamKey()"
                      (ngModelChange)="newParamKey.set($event)" />
                    <input
                      type="text"
                      class="form-input param-value"
                      placeholder="Value"
                      [ngModel]="newParamValue()"
                      (ngModelChange)="newParamValue.set($event)" />
                    <button
                      class="btn-add-small"
                      [disabled]="!newParamKey()"
                      (click)="onAddParam(i)">+</button>
                  </div>
                </div>

                <div class="report-actions">
                  <button class="btn-delete" (click)="onDeleteReport(i)">
                    Delete Report
                  </button>
                </div>
              </div>
          ...
          <p class="text-muted">No reports configured. Click "Add Report" to create one.</p>
        }
      </div>
    </div>
  `, changeDetection: ChangeDetectionStrategy.OnPush, styles: ["/* angular:styles/component:scss;19750109c37563aa14a4dbc70e6e696a4e58e4037b00c62485cb50259270f044;/Users/chadcummings/Github/chadcumm/gbin-mha-pds/src/app/config-editor/sections/config-section-reports.ts */\n.summary-bar {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 0.75rem;\n  background: #f8f9fa;\n  border-radius: 4px;\n  margin-bottom: 1rem;\n}\n.btn-add {\n  padding: 0.375rem 0.75rem;\n  background: #0d6efd;\n  color: white;\n  border: none;\n  border-radius: 4px;\n  cursor: pointer;\n  font-size: 0.875rem;\n}\n.btn-add:disabled {\n  opacity: 0.5;\n  cursor: not-allowed;\n}\n.add-form {\n  padding: 1rem;\n  background: #f0f7ff;\n  border: 1px solid #86b7fe;\n  border-radius: 4px;\n  margin-bottom: 1rem;\n}\n.form-grid {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  gap: 0.75rem;\n  margin-bottom: 0.75rem;\n}\n.form-group label {\n  display: block;\n  font-weight: 600;\n  font-size: 0.8rem;\n  margin-bottom: 0.25rem;\n}\n.form-group-narrow {\n  max-width: 150px;\n}\n.form-input {\n  width: 100%;\n  padding: 0.375rem 0.5rem;\n  border: 1px solid #ced4da;\n  border-radius: 4px;\n  font-size: 0.875rem;\n}\n.form-actions {\n  display: flex;\n  gap: 0.5rem;\n}\n.btn-confirm {\n  padding: 0.375rem 0.75rem;\n  background: #198754;\n  color: white;\n  border: none;\n  border-radius: 4px;\n  cursor: pointer;\n}\n.btn-confirm:disabled {\n  opacity: 0.5;\n  cursor: not-allowed;\n}\n.btn-cancel {\n  padding: 0.375rem 0.75rem;\n  background: #6c757d;\n  color: white;\n  border: none;\n  border-radius: 4px;\n  cursor: pointer;\n}\n.form-error {\n  color: #dc3545;\n  font-size: 0.85rem;\n  margin-top: 0.5rem;\n}\n.report-list {\n  display: flex;\n  flex-direction: column;\n  gap: 0.5rem;\n}\n.report-card {\n  border: 1px solid #dee2e6;\n  border-radius: 4px;\n  padding: 0.75rem;\n  background: white;\n}\n.report-card.inactive {\n  opacity: 0.6;\n}\n.report-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.report-header-left {\n  display: flex;\n  align-items: center;\n  gap: 0.5rem;\n}\n.report-title {\n  font-weight: 600;\n}\n.badge {\n  font-size: 0.7rem;\n  padding: 0.15rem 0.4rem;\n  border-radius: 3px;\n  text-transform: uppercase;\n  font-weight: 600;\n}\n.badge-render-type {\n  background: #e7f1ff;\n  color: #0d6efd;\n}\n.badge-inactive {\n  background: #f8d7da;\n  color: #842029;\n}\n.btn-icon {\n  background: none;\n  border: 1px solid #dee2e6;\n  border-radius: 4px;\n  padding: 0.25rem 0.5rem;\n  cursor: pointer;\n  font-size: 0.75rem;\n}\n.report-subtitle {\n  font-size: 0.8rem;\n  color: #6c757d;\n  margin-top: 0.25rem;\n}\n.report-id {\n  font-family: monospace;\n}\n.report-detail {\n  margin-top: 0.75rem;\n  padding-top: 0.75rem;\n  border-top: 1px solid #dee2e6;\n}\n.table-params-section,\n.params-section {\n  margin-top: 0.75rem;\n  padding: 0.75rem;\n  background: #f8f9fa;\n  border-radius: 4px;\n}\n.table-params-section h6,\n.params-section h6 {\n  margin: 0 0 0.5rem 0;\n  font-size: 0.85rem;\n}\n.checkbox-label {\n  display: flex;\n  align-items: center;\n  gap: 0.5rem;\n  font-size: 0.875rem;\n  cursor: pointer;\n}\n.param-row {\n  display: flex;\n  gap: 0.5rem;\n  align-items: center;\n  margin-bottom: 0.375rem;\n}\n.param-key {\n  font-family: monospace;\n  font-size: 0.85rem;\n  min-width: 150px;\n}\n.param-key-input {\n  max-width: 150px;\n}\n.param-value {\n  flex: 1;\n}\n.btn-remove {\n  background: none;\n  border: 1px solid #dc3545;\n  color: #dc3545;\n  border-radius: 4px;\n  padding: 0.15rem 0.5rem;\n  cursor: pointer;\n}\n.btn-add-small {\n  background: #0d6efd;\n  color: white;\n  border: none;\n  border-radius: 4px;\n  padding: 0.25rem 0.5rem;\n  cursor: pointer;\n}\n.btn-add-small:disabled {\n  opacity: 0.5;\n  cursor: not-allowed;\n}\n.report-actions {\n  margin-top: 0.75rem;\n  padding-top: 0.75rem;\n  border-top: 1px solid #dee2e6;\n}\n.btn-delete {\n  padding: 0.375rem 0.75rem;\n  background: #dc3545;\n  color: white;\n  border: none;\n  border-radius: 4px;\n  cursor: pointer;\n  font-size: 0.85rem;\n}\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConfigSectionReportsComponent, { className: "ConfigSectionReportsComponent", filePath: "src/app/config-editor/sections/config-section-reports.ts", lineNumber: 388 });
})();
...
function ConfigEditorComponent_Conditional_15_For_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(3, ConfigEditorComponent_Conditional_15_For_3_Conditional_3_Template, 2, 0, "span", 42);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ConfigEditorComponent_Conditional_15_Case_11_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-config-section-mirth", 43);
...
function ConfigEditorComponent_Conditional_15_Case_12_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-config-section-submission", 43);
...
function ConfigEditorComponent_Conditional_15_Case_13_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-config-section-processing", 43);
...
function ConfigEditorComponent_Conditional_15_Case_14_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-config-section-service-event-types", 44);
    ...
    })("discoverForms", function ConfigEditorComponent_Conditional_15_Case_14_Template_app_config_section_service_event_types_discoverForms_0_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.onDiscoverPowerForms());
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275property("configuration", ctx_r1.config())("readonly", false)("discoveredForms", ctx_r1.discoveredForms())("discoveryLoading", ctx_r1.discoveryLoading())("discoveryError", ctx_r1.discoveryError());
  }
}
function ConfigEditorComponent_Conditional_15_Case_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r12 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-config-section-time-interval-mappings", 45);
...
function ConfigEditorComponent_Conditional_15_Case_16_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-config-section-submit-fields", 46);
...
function ConfigEditorComponent_Conditional_15_Case_17_Template(rf, ctx) {
  if (rf & 1) {
    const _r14 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-config-section-code-tables", 47);
...
function ConfigEditorComponent_Conditional_15_Case_18_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-config-section-mappings", 48);
...
function ConfigEditorComponent_Conditional_15_Case_22_Template(rf, ctx) {
  if (rf & 1) {
    const _r16 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-config-section-mha-locations", 49);
...
function ConfigEditorComponent_Conditional_15_Case_23_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-config-section-reports", 50);
    \u0275\u0275listener("reportsChange", function ConfigEditorComponent_Conditional_15_Case_23_Template_app_config_section_reports_reportsChange_0_listener($event) {
      \u0275\u0275restoreView(_r17);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.onReportsChange($event));
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275property("reports", ctx_r1.reports());
  }
}
function ConfigEditorComponent_Conditional_15_Case_24_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r18 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-config-section-json-editor", 43);
    \u0275\u0275listener("configChange", function ConfigEditorComponent_Conditional_15_Case_24_Conditional_0_Template_app_config_section_json_editor_configChange_0_listener($event) {
      \u0275\u0275restoreView(_r18);
      const ctx_r1 = \u0275\u0275nextContext(3);
...
function ConfigEditorComponent_Conditional_15_Case_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, ConfigEditorComponent_Conditional_15_Case_24_Conditional_0_Template, 1, 1, "app-config-section-json-editor", 36);
  }
  if (rf & 2) {
    let tmp_2_0;
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function ConfigEditorComponent_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(2, ConfigEditorComponent_Conditional_15_For_3_Template, 4, 4, "button", 25, _forTrack014);
    \u0275\u0275elementEnd();
...
var ConfigEditorComponent = class _ConfigEditorComponent {
  ...
  // PowerForm discovery state
  discoveredForms = signal([], ...ngDevMode ? [{ debugName: "discoveredForms" }] : []);
  discoveryLoading = signal(false, ...ngDevMode ? [{ debugName: "discoveryLoading" }] : []);
  discoveryError = signal(null, ...ngDevMode ? [{ debugName: "discoveryError" }] : []);
  // Tab configuration
  tabs = [
    ...
    { id: "reports", label: "Reports", icon: "assessment", description: "Report definitions and settings", editable: true },
  ...
  reports = computed(() => this.config()?.REPORTS ?? [], ...ngDevMode ? [{ debugName: "reports" }] : []);
  ...
  /**
   * Discover PowerForms available in Cerner for service event type configuration
   */
  onDiscoverPowerForms() {
    this.discoveryLoading.set(true);
    this.discoveryError.set(null);
    this.discoveredForms.set([]);
    this.configService.discoverPowerForms().subscribe({
      next: (forms) => {
        this.discoveredForms.set(forms);
        this.discoveryLoading.set(false);
      },
      error: (err) => {
        this.discoveryError.set(err.message || "Failed to discover PowerForms");
        this.discoveryLoading.set(false);
      }
    });
  }
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConfigEditorComponent, selectors: [["app-config-editor"]], decls: 17, vars: 7, consts: [[1, "config-editor-container"], [1, "page-header"], [1, "header-content"], [1, "header-title"], [1, "page-description"], [1, "header-actions"], [1, "btn", "btn-secondary", 3, "click", "disabled"], [1, "status-bar"], [1, "notification", 3, "class"], [1, "loading-overlay"], [1, "main-content"], [1, "empty-state"], [1, "btn", "btn-primary", 3, "click", "disabled"], [1, "spinner-small"], [1, "status-item"], [1, "status-label"], [1, "status-value"], [1, "status-item", "status-unsaved"], [1, "status-badge"], [1, "notification"], [1, "notification-message"], [1, "notification-dismiss", 3, "click"], [1, "loading-content"], [1, "spinner"], [1, "tab-navigation"], [1, "tab-button", 3, "active"], [1, "tab-content"], [1, "tab-header"], [1, "tab-description"], [1, "tab-panel"], [3, "configuration", "readonly", "discoveredForms", "discoveryLoading", "discoveryError"], [3, "mappings"], [3, "fields", "fieldsByCategory"], [3, "codeTables", "codeTableMappings"], [3, "mappings", "submitFields", "codeTableMappings"], [3, "mappings", "codeTableMappings"], [3, "config"], [3, "fhirCodes"], [3, "locations"], [3, "reports"], [1, "tab-button", 3, "click"], [1, "tab-label"], [1, "tab-readonly-badge"], [3, "configChange", "config"], [3, "configurationChange", "discoverForms", "configuration", "readonly", "discoveredForms", "discoveryLoading", "discoveryError"], [3, "mappingsChange", "mappings"], [3, "fieldsChange", "fields", "fieldsByCategory"], [3, "codeTableMappingsChange", "codeTables", "codeTableMappings"], [3, "mappingsChange", "mappings", "submitFields", "codeTableMappings"], [3, "locationsChange", "locations"], [3, "reportsChange", "reports"], [1, "btn", "btn-primary", 3, "click"]], template: function ConfigEditorComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(15, ConfigEditorComponent_Conditional_15_Template, 25, 3, "div", 10);
          ...
          @switch (activeTab()) {
            ...
            @case ('service_event_types') {
              <app-config-section-service-event-types
                ...
                (discoverForms)="onDiscoverPowerForms()" />
            }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConfigEditorComponent, { className: "ConfigEditorComponent", filePath: "src/app/config-editor/config-editor.ts", lineNumber: 100 });
})();
export {
