...
function isMhaPdsConfiguration(value) {
  ...
  const config = value;
  return typeof config.UPDT_DT_TM === "string" && typeof config.MIRTH_CONNECT === "object" && typeof config.SUBMISSION === "object" && typeof config.PROCESSING === "object" && typeof config.CODE_TABLES_CNT === "number" && Array.isArray(config.CODE_TABLES) && typeof config.CODE_TABLE_MAPPING_CNT === "number" && Array.isArray(config.CODE_TABLE_MAPPINGS) && typeof config.MAPPING_CNT === "number" && Array.isArray(config.MAPPINGS) && typeof config.SUBMIT_FIELDS_CNT === "number" && Array.isArray(config.SUBMIT_FIELDS) && typeof config.FHIR_RESOURCE_CODES_CNT === "number" && Array.isArray(config.FHIR_RESOURCE_CODES);
}
...
(() => {
  ...
  `, changeDetection: ChangeDetectionStrategy.OnPush, styles: ["/* angular:styles/component:scss;2fa9fc9abc393a0187511eb3cf6ae82defb613556f451c9cba9495a34275c265;/Users/chadcummings/Github/gbin-mha-pds/src/app/config-editor/sections/config-section-mirth.ts */\n.section-content {\n  max-width: 800px;\n}\n.form-grid {\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n  gap: 20px;\n}\n@media (max-width: 600px) {\n  .form-grid {\n    grid-template-columns: 1fr;\n  }\n}\n.full-width {\n  grid-column: 1/-1;\n}\n.form-group {\n  display: flex;\n  flex-direction: column;\n  gap: 6px;\n}\n.form-group label {\n  font-weight: 500;\n  color: #333;\n  font-size: 14px;\n}\n.form-group .form-control {\n  padding: 10px 12px;\n  border: 1px solid #ced4da;\n  border-radius: 4px;\n  font-size: 14px;\n  transition: border-color 0.2s, box-shadow 0.2s;\n}\n.form-group .form-control:focus {\n  outline: none;\n  border-color: #0078d4;\n  box-shadow: 0 0 0 3px rgba(0, 120, 212, 0.1);\n}\n.form-group .form-control::placeholder {\n  color: #adb5bd;\n}\n.form-group .help-text {\n  color: #6c757d;\n  font-size: 12px;\n}\n.password-field {\n  display: flex;\n  gap: 8px;\n}\n.password-field .form-control {\n  flex: 1;\n}\n.password-field .password-toggle {\n  padding: 10px 16px;\n  border: 1px solid #ced4da;\n  background-color: #f8f9fa;\n  border-radius: 4px;\n  font-size: 13px;\n  cursor: pointer;\n  transition: background-color 0.2s;\n}\n.password-field .password-toggle:hover {\n  background-color: #e9ecef;\n}\n.test-connection-section {\n  margin-top: 24px;\n  padding-top: 20px;\n  border-top: 1px solid #e9ecef;\n  display: flex;\n  align-items: center;\n  gap: 12px;\n}\n.test-connection-section .btn-outline {\n  padding: 10px 20px;\n  border: 1px solid #0078d4;\n  background: transparent;\n  color: #0078d4;\n  border-radius: 4px;\n  font-size: 14px;\n  cursor: pointer;\n  transition: all 0.2s;\n}\n.test-connection-section .btn-outline:hover:not(:disabled) {\n  background-color: #0078d4;\n  color: white;\n}\n.test-connection-section .btn-outline:disabled {\n  border-color: #ced4da;\n  color: #6c757d;\n  cursor: not-allowed;\n}\n/*# sourceMappingURL=config-section-mirth.css.map */\n"] }]
  }], null, { config: [{
    type: Input
  }], configChange: [{
    type: Output
...
(() => {
  ...
  `, changeDetection: ChangeDetectionStrategy.OnPush, styles: ["/* angular:styles/component:scss;5da649d377454b2dfa4472bff69ec8b1bc889f1c6605be68f08fa868de30eeb1;/Users/chadcummings/Github/gbin-mha-pds/src/app/config-editor/sections/config-section-submission.ts */\n.section-content {\n  max-width: 800px;\n}\n.form-grid {\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n  gap: 20px;\n}\n@media (max-width: 600px) {\n  .form-grid {\n    grid-template-columns: 1fr;\n  }\n}\n.form-group {\n  display: flex;\n  flex-direction: column;\n  gap: 6px;\n}\n.form-group label {\n  font-weight: 500;\n  color: #333;\n  font-size: 14px;\n}\n.form-group .form-control {\n  padding: 10px 12px;\n  border: 1px solid #ced4da;\n  border-radius: 4px;\n  font-size: 14px;\n  transition: border-color 0.2s, box-shadow 0.2s;\n}\n.form-group .form-control:focus {\n  outline: none;\n  border-color: #0078d4;\n  box-shadow: 0 0 0 3px rgba(0, 120, 212, 0.1);\n}\n.form-group select.form-control {\n  cursor: pointer;\n  background-color: white;\n}\n.form-group .help-text {\n  color: #6c757d;\n  font-size: 12px;\n}\n.schedule-summary {\n  margin-top: 24px;\n  padding: 16px;\n  background-color: #f8f9fa;\n  border: 1px solid #e9ecef;\n  border-radius: 6px;\n}\n.schedule-summary h4 {\n  margin: 0 0 8px 0;\n  color: #333;\n  font-size: 14px;\n  font-weight: 600;\n}\n.schedule-summary p {\n  margin: 0;\n  color: #555;\n  font-size: 13px;\n  line-height: 1.6;\n}\n/*# sourceMappingURL=config-section-submission.css.map */\n"] }]
  }], null, { config: [{
    type: Input
  }], configChange: [{
    type: Output
...
function ConfigEditorComponent_Conditional_15_For_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(3, ConfigEditorComponent_Conditional_15_For_3_Conditional_3_Template, 2, 0, "span", 36);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ConfigEditorComponent_Conditional_15_Case_11_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-config-section-mirth", 38);
...
function ConfigEditorComponent_Conditional_15_Case_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, ConfigEditorComponent_Conditional_15_Case_11_Conditional_0_Template, 1, 1, "app-config-section-mirth", 37);
  }
  if (rf & 2) {
    let tmp_2_0;
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function ConfigEditorComponent_Conditional_15_Case_12_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-config-section-submission", 38);
...
function ConfigEditorComponent_Conditional_15_Case_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, ConfigEditorComponent_Conditional_15_Case_12_Conditional_0_Template, 1, 1, "app-config-section-submission", 37);
  }
  if (rf & 2) {
    let tmp_2_0;
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function ConfigEditorComponent_Conditional_15_Case_13_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-config-section-processing", 38);
...
function ConfigEditorComponent_Conditional_15_Case_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, ConfigEditorComponent_Conditional_15_Case_13_Conditional_0_Template, 1, 1, "app-config-section-processing", 37);
  }
  if (rf & 2) {
    let tmp_2_0;
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function ConfigEditorComponent_Conditional_15_Case_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-config-section-submit-fields", 39);
...
function ConfigEditorComponent_Conditional_15_Case_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-config-section-mappings", 40);
...
function ConfigEditorComponent_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(2, ConfigEditorComponent_Conditional_15_For_3_Template, 4, 4, "button", 25, _forTrack05);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional((tmp_4_0 = ctx_r1.activeTab()) === "mirth" ? 11 : tmp_4_0 === "submission" ? 12 : tmp_4_0 === "processing" ? 13 : tmp_4_0 === "submit_fields" ? 14 : tmp_4_0 === "code_tables" ? 15 : tmp_4_0 === "mappings" ? 16 : tmp_4_0 === "fhir_codes" ? 17 : -1);
  }
}
...
var ConfigEditorComponent = class _ConfigEditorComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConfigEditorComponent, selectors: [["app-config-editor"]], decls: 17, vars: 7, consts: [[1, "config-editor-container"], [1, "page-header"], [1, "header-content"], [1, "header-title"], [1, "page-description"], [1, "header-actions"], [1, "btn", "btn-secondary", 3, "click", "disabled"], [1, "status-bar"], [1, "notification", 3, "class"], [1, "loading-overlay"], [1, "main-content"], [1, "empty-state"], [1, "btn", "btn-primary", 3, "click", "disabled"], [1, "spinner-small"], [1, "status-item"], [1, "status-label"], [1, "status-value"], [1, "status-item", "status-unsaved"], [1, "status-badge"], [1, "notification"], [1, "notification-message"], [1, "notification-dismiss", 3, "click"], [1, "loading-content"], [1, "spinner"], [1, "tab-navigation"], [1, "tab-button", 3, "active"], [1, "tab-content"], [1, "tab-header"], [1, "tab-description"], [1, "tab-panel"], [3, "fields", "fieldsByCategory"], [3, "codeTables", "codeTableMappings"], [3, "mappings"], [3, "fhirCodes"], [1, "tab-button", 3, "click"], [1, "tab-label"], [1, "tab-readonly-badge"], [3, "config"], [3, "configChange", "config"], [3, "fieldsChange", "fields", "fieldsByCategory"], [3, "mappingsChange", "mappings"], [1, "btn", "btn-primary", 3, "click"]], template: function ConfigEditorComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(15, ConfigEditorComponent_Conditional_15_Template, 18, 3, "div", 10);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConfigEditorComponent, { className: "ConfigEditorComponent", filePath: "src/app/config-editor/config-editor.ts", lineNumber: 81 });
})();
export {
  ConfigEditorComponent
};
//# sourceMappingURL=chunk-ZUKFCIOC.js.map
