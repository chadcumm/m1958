...
function EpisodeListComponent_Conditional_2_For_1_Conditional_18_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(episode_r2.health_program_number_mapped || episode_r2.health_program_number || "-");
    \u0275\u0275advance(3);
            ...
            <div class="episode-section">
              ...
              <div class="field-row">
                <div class="field">
                  ...
                  <span>{{ episode.health_program_number_mapped || episode.health_program_number || '-' }}</span>
                </div>
                <div class="field">
                  <label>
