...
var LogsService = class _LogsService {
  ...
  loadLogs(filters) {
    ...
    const requestData = JSON.stringify(__spreadProps(__spreadValues({}, currentFilters), {
    ...
    this.cclService.load({
      ...
      try {
        ...
        if (response) {
          ...
          this._totalCount.set(response.total_count || 0);
          this._currentPage.set(response.page || 1);
          this._pageSize.set(response.page_size || 50);
        }
      } catch (err) {
  ...
  loadLogDetail(logId) {
    this._loading.set(true);
    this._error.set(null);
    const requestData = JSON.stringify({ log_id: logId });
    this.cclService.load({
      customScript: {
        script: [{
          name: "gbin_mha_pds_service",
      ...
      try {
        ...
        if (response && response.found_ind) {
          this._selectedLog.set(response);
        } else {
  ...
  loadLogText(logId) {
    ...
    this.cclService.load({
      ...
      try {
        ...
        if (response && response.found_ind) {
          this._selectedLogText.set(response);
        } else {
...
function LogDetailComponent_Conditional_8_Conditional_61_For_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275domElementStart(0, "div", 29);
    \u0275\u0275domListener("click", function LogDetailComponent_Conditional_8_Conditional_61_For_5_Template_div_click_0_listener() {
      const child_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.onViewChildLog(child_r5.log_id));
    });
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(child_r5.log_type);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(child_r5.title);
    \u0275\u0275advance();
    \u0275\u0275classMap(ctx_r2.getStatusClass(child_r5.status));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", child_r5.status, " ");
  }
}
function LogDetailComponent_Conditional_8_Conditional_61_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(4, LogDetailComponent_Conditional_8_Conditional_61_For_5_Template, 7, 5, "div", 28, \u0275\u0275componentInstance().trackByLogId, true);
    \u0275\u0275domElementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function LogDetailComponent_Conditional_8_Conditional_76_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "div", 16)(1, "span", 17);
    \u0275\u0275text(2, "Created By");
    \u0275\u0275domElementEnd();
...
function LogDetailComponent_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(61, LogDetailComponent_Conditional_8_Conditional_61_Template, 6, 1, "section", 14);
    \u0275\u0275domElementStart(62, "section", 23)(63, "h5");
    \u0275\u0275text(64, "Audit Information");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(65, "div", 15)(66, "div", 16)(67, "span", 17);
    \u0275\u0275text(68, "Log ID");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(69, "span", 21);
    \u0275\u0275text(70);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(71, "div", 16)(72, "span", 17);
    \u0275\u0275text(73, "Created");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(74, "span", 18);
    \u0275\u0275text(75);
    \u0275\u0275domElementEnd()();
    \u0275\u0275conditionalCreate(76, LogDetailComponent_Conditional_8_Conditional_76_Template, 5, 1, "div", 16);
    \u0275\u0275conditionalCreate(77, LogDetailComponent_Conditional_8_Conditional_77_Template, 10, 2);
    \u0275\u0275domElementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.childLogs().length > 0 ? 61 : -1);
    \u0275\u0275advance(9);
    \u0275\u0275textInterpolate(logData_r1.log_id);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(logData_r1.create_dt_tm_formatted);
    \u0275\u0275advance();
    \u0275\u0275conditional(logData_r1.create_prsnl_name ? 76 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(logData_r1.updt_cnt > 0 ? 77 : -1);
  }
}
...
var LogDetailComponent = class _LogDetailComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LogDetailComponent, selectors: [["app-log-detail"]], outputs: { closed: "closed", viewPayload: "viewPayload" }, decls: 10, vars: 1, consts: [[1, "log-detail-panel"], [1, "panel-header"], ["aria-label", "Close", 1, "close-btn", 3, "click"], ["aria-hidden", "true"], [1, "loading-state"], [1, "panel-content"], [1, "empty-state"], [1, "spinner"], [1, "detail-section", "header-section"], [1, "log-type-status"], [1, "type-badge"], [1, "status-badge"], [1, "log-title"], [1, "log-summary"], [1, "detail-section"], [1, "detail-grid"], [1, "detail-item"], [1, "label"], [1, "value"], [1, "value", "duration"], [1, "detail-item", "full-width"], [1, "value", "code"], [1, "detail-section", "payload-section"], [1, "detail-section", "audit-section"], [1, "value", "error-message"], [1, "payload-info"], [1, "view-payload-btn", 3, "click"], [1, "child-logs"], [1, "child-log"], [1, "child-log", 3, "click"], [1, "child-type"], [1, "child-title"], [1, "child-status"]], template: function LogDetailComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(6, "\xD7");
      \u0275\u0275domElementEnd()()();
      \u0275\u0275conditionalCreate(7, LogDetailComponent_Conditional_7_Template, 4, 0, "div", 4)(8, LogDetailComponent_Conditional_8_Template, 78, 24, "div", 5)(9, LogDetailComponent_Conditional_9_Template, 3, 0, "div", 6);
      \u0275\u0275domElementEnd();
    }
    if (rf & 2) {
      let tmp_0_0;
...
//# sourceMappingURL=chunk-3276DIC3.js.map
