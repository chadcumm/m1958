...
function PatientDetailComponent_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(93);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(94, PatientDetailComponent_Conditional_3_Conditional_94_Template, 2, 1, "div", 37);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_1_0;
...
var PatientDetailComponent = class _PatientDetailComponent {
   ...
   * Only validates coded fields that are configured for submission and have values
   */
  validateMappings() {
    ...
    const codedFieldMappings = [
      ["DE04_001", client.de04_001_preferred_language],
      ["DE04_005", client.de04_005_immigration_status],
      ["DE04_007", client.de04_007_gender_identity],
      ["DE04_008", client.de04_008_sexual_orientation],
      ["DE04_012", client.de04_012_citizenship_status],
      ["DE04_013", client.de04_013_education],
      ["DE04_014", client.de04_014_employment],
      ["DE04_015", client.de04_015_income_source],
      ["DE04_017", client.de04_017_housing],
      ["DE04_018", client.de04_018_household_income],
      ["DE04_020", client.de04_020_legal_status]
    ];
    for (const [fieldCode, value] of codedFieldMappings) {
   ...
   */
  getMappingStatus(fieldCode) {
    const validation = this.fieldValidations().get(fieldCode);
    if (!validation)
      return "not-checked";
