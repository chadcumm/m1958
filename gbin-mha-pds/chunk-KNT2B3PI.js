...
(() => {
  ...
  `, changeDetection: ChangeDetectionStrategy.OnPush, styles: ["/* angular:styles/component:scss;4e42bf48dd8ecc57b0d50a6dc9ece5af715f15e9e2ddaaa8a836ff511a9e7e6e;/Users/chadcummings/Github/gbin-mha-pds/src/app/config-editor/sections/config-section-mirth.ts */\n.section-content {\n  max-width: 800px;\n}\n.form-grid {\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n  gap: 20px;\n}\n@media (max-width: 600px) {\n  .form-grid {\n    grid-template-columns: 1fr;\n  }\n}\n.full-width {\n  grid-column: 1/-1;\n}\n.form-group {\n  display: flex;\n  flex-direction: column;\n  gap: 6px;\n}\n.form-group label {\n  font-weight: 500;\n  color: #333;\n  font-size: 14px;\n  display: flex;\n  align-items: center;\n  gap: 8px;\n}\n.form-group label .badge {\n  display: inline-block;\n  padding: 2px 8px;\n  background-color: #28a745;\n  color: white;\n  font-size: 11px;\n  font-weight: 600;\n  border-radius: 12px;\n  text-transform: uppercase;\n  letter-spacing: 0.5px;\n}\n.form-group .form-control {\n  padding: 10px 12px;\n  border: 1px solid #ced4da;\n  border-radius: 4px;\n  font-size: 14px;\n  transition: border-color 0.2s, box-shadow 0.2s;\n}\n.form-group .form-control:focus {\n  outline: none;\n  border-color: #0078d4;\n  box-shadow: 0 0 0 3px rgba(0, 120, 212, 0.1);\n}\n.form-group .form-control::placeholder {\n  color: #adb5bd;\n}\n.form-group .help-text {\n  color: #6c757d;\n  font-size: 12px;\n}\n.password-field {\n  display: flex;\n  gap: 8px;\n}\n.password-field .form-control {\n  flex: 1;\n}\n.password-field .password-toggle {\n  padding: 10px 16px;\n  border: 1px solid #ced4da;\n  background-color: #f8f9fa;\n  border-radius: 4px;\n  font-size: 13px;\n  cursor: pointer;\n  transition: background-color 0.2s;\n}\n.password-field .password-toggle:hover {\n  background-color: #e9ecef;\n}\n.test-connection-section {\n  margin-top: 24px;\n  padding-top: 20px;\n  border-top: 1px solid #e9ecef;\n  display: flex;\n  align-items: center;\n  gap: 12px;\n}\n.test-connection-section .btn-outline {\n  padding: 10px 20px;\n  border: 1px solid #0078d4;\n  background: transparent;\n  color: #0078d4;\n  border-radius: 4px;\n  font-size: 14px;\n  cursor: pointer;\n  transition: all 0.2s;\n}\n.test-connection-section .btn-outline:hover:not(:disabled) {\n  background-color: #0078d4;\n  color: white;\n}\n.test-connection-section .btn-outline:disabled {\n  border-color: #ced4da;\n  color: #6c757d;\n  cursor: not-allowed;\n}\n"] }]
  }], null, { config: [{
    type: Input
  }], configChange: [{
    type: Output
