...
function OperationsComponent_Conditional_98_Conditional_32_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 42)(1, "a", 43);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
...
function OperationsComponent_Conditional_98_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(31);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275conditionalCreate(32, OperationsComponent_Conditional_98_Conditional_32_Template, 3, 6, "div", 42);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_1_0;
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((tmp_11_0 = ctx_r0.dataExtractResult()) == null ? null : tmp_11_0.summary == null ? null : tmp_11_0.summary.submission_count);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((tmp_12_0 = ctx_r0.dataExtractResult()) == null ? null : tmp_12_0.summary == null ? null : tmp_12_0.summary.error_count);
    \u0275\u0275advance();
    \u0275\u0275conditional(((tmp_13_0 = ctx_r0.dataExtractResult()) == null ? null : tmp_13_0.log_id) ? 32 : -1);
  }
}
...
var OperationsComponent = class _OperationsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _OperationsComponent, selectors: [["app-operations"]], decls: 112, vars: 61, consts: [[1, "operations-container"], [1, "operations-header"], [1, "header-content"], [1, "subtitle"], [1, "system-overview-btn", 3, "click"], [1, "btn-icon"], [1, "modules-grid"], [1, "module-card", 3, "dragover", "drop"], [1, "module-title-row"], ["draggable", "true", "title", "Drag to reorder", 1, "drag-handle", 3, "dragstart", "dragend"], [1, "description"], [1, "mode-selector"], [1, "mode-option"], ["type", "radio", "name", "commitMode", 3, "ngModelChange", "value", "ngModel", "disabled"], [1, "mode-label"], [1, "mode-desc"], [1, "run-button", 3, "click", "disabled"], [1, "manager-result", 3, "success", "error"], [1, "search-row"], ["type", "text", "placeholder", "Enter FIN NBR...", 1, "fin-input", 3, "ngModelChange", "input", "keydown.enter", "ngModel", "disabled"], [1, "search-button", 3, "click", "disabled"], [1, "spinner"], [1, "add-patient-result", "error"], [1, "encounter-table-wrap"], [1, "add-patient-result", 3, "success", "error"], ["type", "radio", "name", "dataCommitMode", 3, "ngModelChange", "value", "ngModel", "disabled"], [1, "mode-selector", 2, "margin-top", "16px"], ["type", "radio", "name", "dataMode", 3, "ngModelChange", "value", "ngModel", "disabled"], [1, "dummy-count-row"], [1, "data-manager-result", 3, "success", "error"], [1, "trigger-button", 3, "click", "disabled"], [1, "trigger-result", 3, "success", "error"], [1, "manager-result"], [1, "result-status"], [1, "status-badge"], [1, "result-message"], [1, "result-timing"], [1, "result-details"], [1, "detail-grid"], [1, "detail-item"], [1, "detail-label"], [1, "detail-value"], [1, "result-actions"], [1, "view-log-link", 3, "routerLink", "queryParams"], [1, "status-badge", "error"], [1, "encounter-table"], [3, "selected"], [3, "click"], ["type", "radio", "name", "encounterSelect", 3, "click", "checked"], ["type", "radio", "name", "addPatientCommitMode", 3, "ngModelChange", "value", "ngModel", "disabled"], [1, "add-patient-result"], ["type", "number", "min", "1", "max", "50", 1, "dummy-count-input", 3, "ngModelChange", "ngModel", "disabled"], [1, "data-manager-result"], [1, "trigger-result"], [1, "trigger-status"], [1, "trigger-message"], [1, "trigger-details"], [3, "closed", "viewLog"]], template: function OperationsComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(98, OperationsComponent_Conditional_98_Template, 33, 17, "div", 29);
      \u0275\u0275elementEnd();
        ...
        @if (dataExtractResult()) {
          <div class="data-manager-result"
            ...
            <div class="result-details">
              ...
              <div class="detail-grid">
                <div class="detail-item">
                  <span class="detail-label">Episodes Processed</span>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(OperationsComponent, { className: "OperationsComponent", filePath: "src/app/operations/operations.ts", lineNumber: 1119 });
})();
export {
  OperationsComponent
};
