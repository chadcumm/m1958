  ...
  revertPatientRecords(personId, recordType = "ALL", serviceRecordIds, onSuccess, onError) {
    ...
    const requestData = JSON.stringify({
      revert_patient_params: {
        ...
        service_record_ids: serviceRecordIds ? serviceRecordIds.join(",") : "",
        commit_mode: 1
      }
    });
    this.cclService.load({
...
function ServiceListComponent_For_22_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "span", 7);
    \u0275\u0275text(1);
    \u0275\u0275domElementEnd();
...
function ServiceListComponent_For_22_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(10, ServiceListComponent_For_22_Conditional_10_Template, 2, 4, "span", 3);
    \u0275\u0275text(11);
    \u0275\u0275domElementEnd();
...
var ServiceListComponent = class _ServiceListComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ServiceListComponent, selectors: [["app-service-list"]], inputs: { services: [1, "services"], activeSubmitFields: [1, "activeSubmitFields"], fieldValidations: [1, "fieldValidations"] }, decls: 24, vars: 1, consts: [[1, "service-list"], [1, "service-table"], [1, "field-indicator", 3, "title"], [1, "mapping-indicator", 3, "class", "title"], [1, "duration"], [1, "hse-id"], [1, "status-badge", "submission-hover", 3, "title"], [1, "mapping-indicator", 3, "title"], ["colspan", "8", 1, "no-data"]], template: function ServiceListComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275repeaterCreate(21, ServiceListComponent_For_22_Template, 27, 32, "tr", null, ctx.trackByServiceId, true, ServiceListComponent_ForEmpty_23_Template, 3, 0, "tr");
      \u0275\u0275domElementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(21);
...
function EpisodeListComponent_Conditional_2_For_1_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(144);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(145, EpisodeListComponent_Conditional_2_For_1_Conditional_20_Conditional_145_Template, 1, 3, "app-service-list", 23)(146, EpisodeListComponent_Conditional_2_For_1_Conditional_20_Conditional_146_Template, 2, 0, "p", 24);
    \u0275\u0275elementEnd();
...
var PatientActionsSidebarComponent = class _PatientActionsSidebarComponent {
  ...
  confirmRevertSelected() {
    ...
    const hasEpisodes = selectedIds.some((id) => id.startsWith("episode_"));
    const hasClient = selectedIds.some((id) => id.startsWith("client_"));
    ...
    const operations = [];
    if (hasEpisodes)
      operations.push({ type: "EPISODE" });
    if (hasClient)
      operations.push({ type: "CLIENT" });
    ...
    const executeNext = () => {
      ...
      this.patientsService.revertPatientRecords(personId, op.type, op.serviceIds, () => {
        completed++;
        executeNext();
      }, (error) => {
