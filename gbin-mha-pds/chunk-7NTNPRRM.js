...
var ConfigSectionMirth = class _ConfigSectionMirth {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConfigSectionMirth, selectors: [["app-config-section-mirth"]], inputs: { config: "config" }, outputs: { configChange: "configChange" }, decls: 38, vars: 7, consts: [[1, "section-content"], [1, "form-grid"], [1, "form-group", "full-width"], ["for", "mirthUrl"], ["type", "url", "id", "mirthUrl", "placeholder", "https://mirth-server.example.com:8443/api", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "help-text"], [1, "form-group"], ["for", "mirthUsername"], ["type", "text", "id", "mirthUsername", "placeholder", "API username", 1, "form-control", 3, "ngModelChange", "ngModel"], ["for", "mirthPassword"], [1, "password-field"], ["id", "mirthPassword", "placeholder", "API password", 1, "form-control", 3, "ngModelChange", "type", "ngModel"], ["type", "button", 1, "password-toggle", 3, "click"], ["for", "mirthTimeout"], ["type", "number", "id", "mirthTimeout", "min", "5", "max", "300", "step", "5", 1, "form-control", 3, "ngModelChange", "ngModel"], ["for", "mirthRetries"], ["type", "number", "id", "mirthRetries", "min", "0", "max", "10", "step", "1", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "test-connection-section"], ["type", "button", "disabled", "", "title", "Connection testing will be available in a future release", 1, "btn", "btn-outline"]], template: function ConfigSectionMirth_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("ngModelChange", function ConfigSectionMirth_Template_input_ngModelChange_16_listener($event) {
        return ctx.onFieldChange("PASSWORD", $event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(17, "button", 12);
      \u0275\u0275listener("click", function ConfigSectionMirth_Template_button_click_17_listener() {
        return ctx.togglePasswordVisibility();
      });
      \u0275\u0275text(18);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(19, "small", 5);
      \u0275\u0275text(20, "Leave blank to keep existing password");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(21, "div", 6)(22, "label", 13);
      \u0275\u0275text(23, "Timeout (seconds)");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(24, "input", 14);
      \u0275\u0275listener("ngModelChange", function ConfigSectionMirth_Template_input_ngModelChange_24_listener($event) {
        return ctx.onFieldChange("TIMEOUT_SECONDS", $event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(25, "small", 5);
      \u0275\u0275text(26, "Connection timeout (5-300 seconds)");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(27, "div", 6)(28, "label", 15);
      \u0275\u0275text(29, "Retry Attempts");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275text(32, "Number of retries on connection failure (0-10)");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(33, "div", 17)(34, "button", 18);
      \u0275\u0275text(35, " Test Connection ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(36, "small", 5);
      \u0275\u0275text(37, "Connection testing not yet implemented");
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(5);
...
(() => {
  ...
  `, changeDetection: ChangeDetectionStrategy.OnPush, styles: ["/* angular:styles/component:scss;2fa9fc9abc393a0187511eb3cf6ae82defb613556f451c9cba9495a34275c265;/Users/chadcummings/Github/chadcumm/gbin-mha-pds/src/app/config-editor/sections/config-section-mirth.ts */\n.section-content {\n  max-width: 800px;\n}\n.form-grid {\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n  gap: 20px;\n}\n@media (max-width: 600px) {\n  .form-grid {\n    grid-template-columns: 1fr;\n  }\n}\n.full-width {\n  grid-column: 1/-1;\n}\n.form-group {\n  display: flex;\n  flex-direction: column;\n  gap: 6px;\n}\n.form-group label {\n  font-weight: 500;\n  color: #333;\n  font-size: 14px;\n}\n.form-group .form-control {\n  padding: 10px 12px;\n  border: 1px solid #ced4da;\n  border-radius: 4px;\n  font-size: 14px;\n  transition: border-color 0.2s, box-shadow 0.2s;\n}\n.form-group .form-control:focus {\n  outline: none;\n  border-color: #0078d4;\n  box-shadow: 0 0 0 3px rgba(0, 120, 212, 0.1);\n}\n.form-group .form-control::placeholder {\n  color: #adb5bd;\n}\n.form-group .help-text {\n  color: #6c757d;\n  font-size: 12px;\n}\n.password-field {\n  display: flex;\n  gap: 8px;\n}\n.password-field .form-control {\n  flex: 1;\n}\n.password-field .password-toggle {\n  padding: 10px 16px;\n  border: 1px solid #ced4da;\n  background-color: #f8f9fa;\n  border-radius: 4px;\n  font-size: 13px;\n  cursor: pointer;\n  transition: background-color 0.2s;\n}\n.password-field .password-toggle:hover {\n  background-color: #e9ecef;\n}\n.test-connection-section {\n  margin-top: 24px;\n  padding-top: 20px;\n  border-top: 1px solid #e9ecef;\n  display: flex;\n  align-items: center;\n  gap: 12px;\n}\n.test-connection-section .btn-outline {\n  padding: 10px 20px;\n  border: 1px solid #0078d4;\n  background: transparent;\n  color: #0078d4;\n  border-radius: 4px;\n  font-size: 14px;\n  cursor: pointer;\n  transition: all 0.2s;\n}\n.test-connection-section .btn-outline:hover:not(:disabled) {\n  background-color: #0078d4;\n  color: white;\n}\n.test-connection-section .btn-outline:disabled {\n  border-color: #ced4da;\n  color: #6c757d;\n  cursor: not-allowed;\n}\n"] }]
  }], null, { config: [{
    type: Input
  }], configChange: [{
    type: Output
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConfigSectionMirth, { className: "ConfigSectionMirth", filePath: "src/app/config-editor/sections/config-section-mirth.ts", lineNumber: 230 });
})();
...
var ConfigSectionProcessing = class _ConfigSectionProcessing {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConfigSectionProcessing, selectors: [["app-config-section-processing"]], inputs: { config: "config" }, outputs: { configChange: "configChange" }, decls: 49, vars: 15, consts: [[1, "section-content"], [1, "toggle-list"], [1, "toggle-item"], [1, "toggle-info"], [1, "warning-badge"], [1, "toggle-switch"], ["type", "checkbox", 3, "change", "checked"], [1, "toggle-slider"], [1, "status-summary"], [1, "status-grid"], [1, "status-item"], [1, "status-label"], [1, "status-value"]], template: function ConfigSectionProcessing_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275domElementEnd()()();
      \u0275\u0275domElementStart(30, "div", 8)(31, "h4");
      \u0275\u0275text(32, "Current Status");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(33, "div", 9)(34, "div", 10)(35, "span", 11);
      \u0275\u0275text(36, "Mode:");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(37, "span", 12);
      \u0275\u0275text(38);
      \u0275\u0275domElementEnd()();
      \u0275\u0275domElementStart(39, "div", 10)(40, "span", 11);
      \u0275\u0275text(41, "Logging:");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(42, "span", 12);
      \u0275\u0275text(43);
      \u0275\u0275domElementEnd()();
      \u0275\u0275domElementStart(44, "div", 10)(45, "span", 11);
      \u0275\u0275text(46, "Notifications:");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(47, "span", 12);
      \u0275\u0275text(48);
      \u0275\u0275domElementEnd()()()()();
    }
    if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConfigSectionProcessing, { className: "ConfigSectionProcessing", filePath: "src/app/config-editor/sections/config-section-processing.ts", lineNumber: 263 });
})();

// src/app/config-editor/sections/config-section-submit-fields.ts
var _forTrack0 = ($index, $item) => $item.key;
var _forTrack1 = ($index, $item) => $item.FIELD_CODE;
function ConfigSectionSubmitFields_For_19_Conditional_10_For_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 20)(1, "label", 21)(2, "input", 22);
    \u0275\u0275listener("change", function ConfigSectionSubmitFields_For_19_Conditional_10_For_2_Template_input_change_2_listener($event) {
      const field_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.onFieldToggle(field_r5, $event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275element(3, "span", 23);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275classProp("active", field_r5.ACTIVE_IND === 1);
    \u0275\u0275advance(2);
...
function ConfigSectionSubmitFields_For_19_Conditional_10_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function ConfigSectionSubmitFields_For_19_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 17);
    \u0275\u0275repeaterCreate(1, ConfigSectionSubmitFields_For_19_Conditional_10_For_2_Template, 9, 5, "div", 18, _forTrack1);
    \u0275\u0275conditionalCreate(3, ConfigSectionSubmitFields_For_19_Conditional_10_Conditional_3_Template, 2, 0, "div", 19);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ConfigSectionSubmitFields_For_19_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 11)(1, "div", 12);
    \u0275\u0275listener("click", function ConfigSectionSubmitFields_For_19_Template_div_click_1_listener() {
    ...
    \u0275\u0275text(9);
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(10, ConfigSectionSubmitFields_For_19_Conditional_10_Template, 4, 1, "div", 17);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r2.collapsedGroups()[entry_r2.key] ? 10 : -1);
  }
}
function ConfigSectionSubmitFields_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
...
var ConfigSectionSubmitFields = class _ConfigSectionSubmitFields {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConfigSectionSubmitFields, selectors: [["app-config-section-submit-fields"]], inputs: { fields: "fields", fieldsByCategory: "fieldsByCategory" }, outputs: { fieldsChange: "fieldsChange" }, decls: 21, vars: 4, consts: [[1, "section-content"], [1, "controls-bar"], [1, "search-box"], ["type", "text", "placeholder", "Search fields...", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "bulk-actions"], [1, "btn", "btn-small", "btn-outline", 3, "click"], [1, "stats"], [1, "stat-item"], [1, "field-groups"], [1, "field-group", 3, "collapsed"], [1, "empty-state"], [1, "field-group"], [1, "group-header", 3, "click"], [1, "group-title"], [1, "expand-icon"], [1, "group-stats"], [1, "active-count"], [1, "group-content"], [1, "field-item", 3, "active"], [1, "no-results"], [1, "field-item"], [1, "field-checkbox"], ["type", "checkbox", 3, "change", "checked"], [1, "checkmark"], [1, "field-info"], [1, "field-code"], [1, "field-description"]], template: function ConfigSectionSubmitFields_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("click", function ConfigSectionSubmitFields_Template_button_click_5_listener() {
        return ctx.enableAll();
      });
      \u0275\u0275text(6, "Enable All");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(7, "button", 5);
      \u0275\u0275listener("click", function ConfigSectionSubmitFields_Template_button_click_7_listener() {
        return ctx.disableAll();
      });
      \u0275\u0275text(8, "Disable All");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(9, "div", 6)(10, "span", 7)(11, "strong");
      \u0275\u0275text(12);
      \u0275\u0275elementEnd();
      \u0275\u0275text(13, " of ");
      ...
      \u0275\u0275repeaterCreate(18, ConfigSectionSubmitFields_For_19_Template, 11, 8, "div", 9, _forTrack0);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(20, ConfigSectionSubmitFields_Conditional_20_Template, 3, 0, "div", 10);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(3);
    ...
    <div class="section-content">
      ...
      <div class="controls-bar">
        ...
        <div class="bulk-actions">
          <button class="btn btn-small btn-outline" (click)="enableAll()">Enable All</button>
          <button class="btn btn-small btn-outline" (click)="disableAll()">Disable All</button>
        </div>
        <div class="stats">
          <span class="stat-item">
            <strong>{{ activeCount() }}</strong> of <strong>{{ totalCount() }}</strong> active
          </span>
        </div>
      </div>
            ...
            @if (!collapsedGroups()[entry.key]) {
              <div class="group-content">
                @for (field of filterFields(entry.fields); track field.FIELD_CODE) {
                  <div class="field-item" [class.active]="field.ACTIVE_IND === 1">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConfigSectionSubmitFields, { className: "ConfigSectionSubmitFields", filePath: "src/app/config-editor/sections/config-section-submit-fields.ts", lineNumber: 354 });
})();

// src/app/config-editor/sections/config-section-code-tables.ts
var _forTrack02 = ($index, $item) => $item.CODE_TABLE_ID;
var _forTrack12 = ($index, $item) => $item.CODE_TABLE_ID + "-" + $item.CODE;
function ConfigSectionCodeTables_For_14_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", table_r1.CODE_TABLE_ID);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2(" ", table_r1.CODE_TABLE_NAME, " (", ctx_r1.getMappingCountForTable(table_r1.CODE_TABLE_ID), ") ");
  }
}
function ConfigSectionCodeTables_For_40_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("href", mapping_r3.CODE_SYSTEM, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.shortenUrl(mapping_r3.CODE_SYSTEM), " ");
  }
}
function ConfigSectionCodeTables_For_40_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
...
function ConfigSectionCodeTables_For_40_Conditional_13_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const mapping_r3 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(mapping_r3.CODE_VALUE_SOURCE);
  }
}
...
function ConfigSectionCodeTables_For_40_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td", 14)(2, "span", 20);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "td", 15)(5, "code");
    \u0275\u0275text(6);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275conditionalCreate(10, ConfigSectionCodeTables_For_40_Conditional_10_Template, 2, 2, "a", 21)(11, ConfigSectionCodeTables_For_40_Conditional_11_Template, 2, 0, "span", 22);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "td", 18);
    \u0275\u0275conditionalCreate(13, ConfigSectionCodeTables_For_40_Conditional_13_Template, 2, 1, "span", 23)(14, ConfigSectionCodeTables_For_40_Conditional_14_Template, 2, 0, "span", 22);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r1.getTableName(mapping_r3.CODE_TABLE_ID));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(mapping_r3.CODE);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(mapping_r3.LABEL);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(mapping_r3.CODE_SYSTEM ? 10 : 11);
    \u0275\u0275advance(3);
    \u0275\u0275conditional(mapping_r3.CODE_VALUE_SOURCE ? 13 : 14);
  }
}
...
function ConfigSectionCodeTables_Conditional_42_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 19)(1, "button", 25);
...
var ConfigSectionCodeTables = class _ConfigSectionCodeTables {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConfigSectionCodeTables, selectors: [["app-config-section-code-tables"]], inputs: { codeTables: "codeTables", codeTableMappings: "codeTableMappings" }, decls: 43, vars: 7, consts: [[1, "section-content"], [1, "info-banner"], [1, "info-icon"], [1, "controls-bar"], [1, "search-box"], ["type", "text", "placeholder", "Search code tables or mappings...", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "filter-select"], [1, "form-control", 3, "ngModelChange", "ngModel"], ["value", ""], [3, "value"], [1, "stats"], [1, "stat-item"], [1, "mappings-table-container"], [1, "mappings-table"], [1, "col-table"], [1, "col-code"], [1, "col-label"], [1, "col-system"], [1, "col-source"], [1, "pagination"], [1, "table-badge"], ["target", "_blank", 1, "system-link", 3, "href"], [1, "no-value"], [1, "source-text"], ["colspan", "5", 1, "empty-row"], [1, "btn-page", 3, "click", "disabled"], [1, "page-info"]], template: function ConfigSectionCodeTables_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "span", 2);
      \u0275\u0275text(3, "i");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(4, "span");
      \u0275\u0275text(5, "Code tables are read-only. Contact your system administrator to modify code table mappings.");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(6, "div", 3)(7, "div", 4)(8, "input", 5);
      \u0275\u0275listener("ngModelChange", function ConfigSectionCodeTables_Template_input_ngModelChange_8_listener($event) {
        return ctx.searchTerm.set($event);
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(9, "div", 6)(10, "select", 7);
      \u0275\u0275listener("ngModelChange", function ConfigSectionCodeTables_Template_select_ngModelChange_10_listener($event) {
        return ctx.selectedTable.set($event);
      });
      \u0275\u0275elementStart(11, "option", 8);
      \u0275\u0275text(12);
      \u0275\u0275elementEnd();
      \u0275\u0275repeaterCreate(13, ConfigSectionCodeTables_For_14_Template, 2, 3, "option", 9, _forTrack02);
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275text(23, " mappings ");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(24, "div", 12)(25, "table", 13)(26, "thead")(27, "tr")(28, "th", 14);
      \u0275\u0275text(29, "Code Table");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(30, "th", 15);
      \u0275\u0275text(31, "Code");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(32, "th", 16);
      \u0275\u0275text(33, "Label");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275repeaterCreate(39, ConfigSectionCodeTables_For_40_Template, 15, 5, "tr", null, _forTrack12);
      \u0275\u0275conditionalCreate(41, ConfigSectionCodeTables_Conditional_41_Template, 3, 0, "tr");
      \u0275\u0275elementEnd()()();
      \u0275\u0275conditionalCreate(42, ConfigSectionCodeTables_Conditional_42_Template, 11, 6, "div", 19);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(8);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ConfigSectionCodeTables, [{
    type: Component,
    args: [{ selector: "app-config-section-code-tables", standalone: true, imports: [CommonModule, FormsModule], template: `
    <div class="section-content">
      <!-- Info Banner -->
      <div class="info-banner">
        <span class="info-icon">i</span>
        <span>Code tables are read-only. Contact your system administrator to modify code table mappings.</span>
      </div>
          ...
          <select
            ...
            @for (table of codeTables; track table.CODE_TABLE_ID) {
              <option [value]="table.CODE_TABLE_ID">
                {{ table.CODE_TABLE_NAME }} ({{ getMappingCountForTable(table.CODE_TABLE_ID) }})
              </option>
            }
          </select>
        </div>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConfigSectionCodeTables, { className: "ConfigSectionCodeTables", filePath: "src/app/config-editor/sections/config-section-code-tables.ts", lineNumber: 355 });
})();

// src/app/config-editor/sections/mapping-editor-drawer.ts
var _forTrack03 = ($index, $item) => $item.field;
...
function MappingEditorDrawer_Conditional_2_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(23, "Notes / Description");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "input", 25);
    \u0275\u0275listener("ngModelChange", function MappingEditorDrawer_Conditional_2_Conditional_18_Template_input_ngModelChange_24_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("ngModelChange", function MappingEditorDrawer_Conditional_2_Conditional_18_Template_input_ngModelChange_28_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275text(30, "CCL function to call for custom data retrieval");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(31, "div", 16)(32, "label");
    \u0275\u0275text(33, "Description");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "textarea", 27);
    \u0275\u0275listener("ngModelChange", function MappingEditorDrawer_Conditional_2_Conditional_18_Template_textarea_ngModelChange_34_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.updateField("DESCRIPTION", $event));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(35, "div", 28)(36, "div", 29)(37, "label")(38, "input", 30);
    \u0275\u0275listener("change", function MappingEditorDrawer_Conditional_2_Conditional_18_Template_input_change_38_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.updateField("ALPHA_RESONSE_IND", $event.target.checked ? 1 : 0));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275text(39, " Alpha Response ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(40, "span", 18);
    \u0275\u0275text(41, "Maps to alpha response from DTA");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(42, "div", 29)(43, "label")(44, "input", 30);
    \u0275\u0275listener("change", function MappingEditorDrawer_Conditional_2_Conditional_18_Template_input_change_44_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.updateField("CONSTANT_IND", $event.target.checked ? 1 : 0));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275text(45, " Constant Value ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(46, "span", 18);
    \u0275\u0275text(47, "Uses constant value from pairs");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function MappingEditorDrawer_Conditional_2_Conditional_19_Conditional_1_For_24_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr")(1, "td")(2, "input", 30);
    \u0275\u0275listener("change", function MappingEditorDrawer_Conditional_2_Conditional_19_Conditional_1_For_24_Template_input_change_2_listener($event) {
      const \u0275$index_158_r7 = \u0275\u0275restoreView(_r6).$index;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.updatePairField(\u0275$index_158_r7, "ACTIVE_IND", $event.target.checked ? 1 : 0));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(3, "td")(4, "input", 46);
    \u0275\u0275listener("ngModelChange", function MappingEditorDrawer_Conditional_2_Conditional_19_Conditional_1_For_24_Template_input_ngModelChange_4_listener($event) {
      const \u0275$index_158_r7 = \u0275\u0275restoreView(_r6).$index;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.updatePairField(\u0275$index_158_r7, "TYPE", $event));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "td")(6, "input", 46);
    \u0275\u0275listener("ngModelChange", function MappingEditorDrawer_Conditional_2_Conditional_19_Conditional_1_For_24_Template_input_ngModelChange_6_listener($event) {
      const \u0275$index_158_r7 = \u0275\u0275restoreView(_r6).$index;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.updatePairField(\u0275$index_158_r7, "KEY_REF", $event));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "td")(8, "select", 47);
    \u0275\u0275listener("ngModelChange", function MappingEditorDrawer_Conditional_2_Conditional_19_Conditional_1_For_24_Template_select_ngModelChange_8_listener($event) {
      const \u0275$index_158_r7 = \u0275\u0275restoreView(_r6).$index;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.updatePairField(\u0275$index_158_r7, "KEY_REF_TYPE", $event));
    });
    ...
    \u0275\u0275text(16, "Constant");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(17, "td")(18, "input", 46);
    \u0275\u0275listener("ngModelChange", function MappingEditorDrawer_Conditional_2_Conditional_19_Conditional_1_For_24_Template_input_ngModelChange_18_listener($event) {
      const \u0275$index_158_r7 = \u0275\u0275restoreView(_r6).$index;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.updatePairField(\u0275$index_158_r7, "PDS_VALUE", $event));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(19, "td")(20, "select", 47);
    \u0275\u0275listener("ngModelChange", function MappingEditorDrawer_Conditional_2_Conditional_19_Conditional_1_For_24_Template_select_ngModelChange_20_listener($event) {
      const \u0275$index_158_r7 = \u0275\u0275restoreView(_r6).$index;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.updatePairField(\u0275$index_158_r7, "PDS_VALUE_TYPE", $event));
    });
    \u0275\u0275elementStart(21, "option", 52);
    \u0275\u0275text(22, "MHA PDS Code");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(28, "LOINC");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(29, "td")(30, "input", 46);
    \u0275\u0275listener("ngModelChange", function MappingEditorDrawer_Conditional_2_Conditional_19_Conditional_1_For_24_Template_input_ngModelChange_30_listener($event) {
      const \u0275$index_158_r7 = \u0275\u0275restoreView(_r6).$index;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.updatePairField(\u0275$index_158_r7, "DISPLAY", $event));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(31, "td")(32, "input", 56);
    \u0275\u0275listener("ngModelChange", function MappingEditorDrawer_Conditional_2_Conditional_19_Conditional_1_For_24_Template_input_ngModelChange_32_listener($event) {
      const \u0275$index_158_r7 = \u0275\u0275restoreView(_r6).$index;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.updatePairField(\u0275$index_158_r7, "PRIORITY", $event));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(33, "td")(34, "button", 57);
    \u0275\u0275listener("click", function MappingEditorDrawer_Conditional_2_Conditional_19_Conditional_1_For_24_Template_button_click_34_listener() {
      const \u0275$index_158_r7 = \u0275\u0275restoreView(_r6).$index;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.removePair(\u0275$index_158_r7));
    });
    \u0275\u0275text(35, "\xD7");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const pair_r8 = ctx.$implicit;
    \u0275\u0275classProp("inactive", pair_r8.ACTIVE_IND !== 1);
    \u0275\u0275advance(2);
    \u0275\u0275property("checked", pair_r8.ACTIVE_IND === 1);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", pair_r8.TYPE);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", pair_r8.KEY_REF);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", pair_r8.KEY_REF_TYPE);
    \u0275\u0275advance(10);
    \u0275\u0275property("ngModel", pair_r8.PDS_VALUE);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", pair_r8.PDS_VALUE_TYPE);
    \u0275\u0275advance(10);
    \u0275\u0275property("ngModel", pair_r8.DISPLAY);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngModel", pair_r8.PRIORITY);
  }
}
function MappingEditorDrawer_Conditional_2_Conditional_19_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 31)(1, "table", 35)(2, "thead")(3, "tr")(4, "th", 36);
    \u0275\u0275text(5, "Active");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(13, "PDS Value");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "th", 41);
    \u0275\u0275text(15, "PDS Type");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "th", 42);
    \u0275\u0275text(17, "Display");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "th", 43);
    \u0275\u0275text(19, "Priority");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275repeaterCreate(23, MappingEditorDrawer_Conditional_2_Conditional_19_Conditional_1_For_24_Template, 36, 10, "tr", 45, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function MappingEditorDrawer_Conditional_2_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, MappingEditorDrawer_Conditional_2_Conditional_19_Conditional_1_Template, 25, 0, "div", 31)(2, MappingEditorDrawer_Conditional_2_Conditional_19_Conditional_2_Template, 3, 0, "div", 32);
    \u0275\u0275elementStart(3, "div", 33)(4, "button", 34);
    \u0275\u0275listener("click", function MappingEditorDrawer_Conditional_2_Conditional_19_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.editedMapping().PAIRS && ctx_r1.editedMapping().PAIRS.length > 0 ? 1 : 2);
  }
}
function MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_4_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("ngModelChange", function MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_4_For_2_Template_input_ngModelChange_1_listener($event) {
      const \u0275$index_244_r11 = \u0275\u0275restoreView(_r10).$index;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.updateTableField(\u0275$index_244_r11, "TABLE", $event));
    });
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("ngModelChange", function MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_4_For_2_Template_input_ngModelChange_2_listener($event) {
      const \u0275$index_244_r11 = \u0275\u0275restoreView(_r10).$index;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.updateTableField(\u0275$index_244_r11, "FIELD_NAME", $event));
    });
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("ngModelChange", function MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_4_For_2_Template_input_ngModelChange_3_listener($event) {
      const \u0275$index_244_r11 = \u0275\u0275restoreView(_r10).$index;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.updateTableField(\u0275$index_244_r11, "PRIORITY", $event));
    });
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_4_For_2_Template_button_click_4_listener() {
      const \u0275$index_244_r11 = \u0275\u0275restoreView(_r10).$index;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.removeTable(\u0275$index_244_r11));
    });
    \u0275\u0275text(5, "\xD7");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", table_r12.TABLE);
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", table_r12.FIELD_NAME);
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", table_r12.PRIORITY);
  }
}
function MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 59);
    \u0275\u0275repeaterCreate(1, MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_4_For_2_Template, 6, 3, "div", 62, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_11_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("ngModelChange", function MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_11_For_2_Template_input_ngModelChange_1_listener($event) {
      const \u0275$index_271_r14 = \u0275\u0275restoreView(_r13).$index;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.updateDtaField(\u0275$index_271_r14, "DTA", $event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "input", 65);
    \u0275\u0275listener("ngModelChange", function MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_11_For_2_Template_input_ngModelChange_2_listener($event) {
      const \u0275$index_271_r14 = \u0275\u0275restoreView(_r13).$index;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.updateDtaField(\u0275$index_271_r14, "PRIORITY", $event));
    });
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_11_For_2_Template_button_click_3_listener() {
      const \u0275$index_271_r14 = \u0275\u0275restoreView(_r13).$index;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.removeDta(\u0275$index_271_r14));
    });
    \u0275\u0275text(4, "\xD7");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const dta_r15 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", dta_r15.DTA);
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", dta_r15.PRIORITY);
  }
}
function MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 59);
    \u0275\u0275repeaterCreate(1, MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_11_For_2_Template, 5, 2, "div", 62, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_18_For_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 62)(1, "input", 68);
    \u0275\u0275listener("ngModelChange", function MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_18_For_2_Template_input_ngModelChange_1_listener($event) {
      const \u0275$index_296_r17 = \u0275\u0275restoreView(_r16).$index;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.updateCodeSetField(\u0275$index_296_r17, "CODE_SET", $event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "input", 65);
    \u0275\u0275listener("ngModelChange", function MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_18_For_2_Template_input_ngModelChange_2_listener($event) {
      const \u0275$index_296_r17 = \u0275\u0275restoreView(_r16).$index;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.updateCodeSetField(\u0275$index_296_r17, "PRIORITY", $event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "button", 66);
    \u0275\u0275listener("click", function MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_18_For_2_Template_button_click_3_listener() {
      const \u0275$index_296_r17 = \u0275\u0275restoreView(_r16).$index;
      const ctx_r1 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r1.removeCodeSet(\u0275$index_296_r17));
    });
    \u0275\u0275text(4, "\xD7");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const cs_r18 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", cs_r18.CODE_SET);
    \u0275\u0275advance();
    \u0275\u0275property("ngModel", cs_r18.PRIORITY);
  }
}
function MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 59);
    \u0275\u0275repeaterCreate(1, MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_18_For_2_Template, 5, 2, "div", 62, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
...
function MappingEditorDrawer_Conditional_2_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 10)(1, "div", 58)(2, "h4");
    \u0275\u0275text(3, "Source Tables");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(4, MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_4_Template, 3, 0, "div", 59)(5, MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_5_Template, 2, 0, "p", 60);
    ...
    \u0275\u0275text(7, "+ Add Table");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "div", 58)(9, "h4");
    \u0275\u0275text(10, "Discrete Task Assays (DTAs)");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(11, MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_11_Template, 3, 0, "div", 59)(12, MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_12_Template, 2, 0, "p", 60);
    ...
    \u0275\u0275text(14, "+ Add DTA");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(15, "div", 58)(16, "h4");
    \u0275\u0275text(17, "Code Sets");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(18, MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_18_Template, 3, 0, "div", 59)(19, MappingEditorDrawer_Conditional_2_Conditional_20_Conditional_19_Template, 2, 0, "p", 60);
...
function MappingEditorDrawer_Conditional_2_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 10)(1, "div", 69)(2, "h4");
    ...
    \u0275\u0275text(20, "Value Metadata");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "p", 70);
    \u0275\u0275text(22, " FHIR code system and value set URL for the coded value (valueCodeableConcept). ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "div", 16)(24, "label");
    \u0275\u0275text(25, "Code System");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "input", 74);
    ...
    \u0275\u0275text(29, "Value Set URL");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "input", 75);
    \u0275\u0275listener("ngModelChange", function MappingEditorDrawer_Conditional_2_Conditional_21_Template_input_ngModelChange_30_listener($event) {
      \u0275\u0275restoreView(_r19);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(31, "div", 16)(32, "label");
    \u0275\u0275text(33, "Code Value Source");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "input", 76);
    \u0275\u0275listener("ngModelChange", function MappingEditorDrawer_Conditional_2_Conditional_21_Template_input_ngModelChange_34_listener($event) {
      \u0275\u0275restoreView(_r19);
      const ctx_r1 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(9);
    \u0275\u0275property("ngModel", ((tmp_5_0 = ctx_r1.editedMapping().VALUE_METADATA) == null ? null : tmp_5_0.CODE_SYSTEM) || "");
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ((tmp_6_0 = ctx_r1.editedMapping().VALUE_METADATA) == null ? null : tmp_6_0.VALUE_SET_URL) || "");
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ((tmp_7_0 = ctx_r1.editedMapping().VALUE_METADATA) == null ? null : tmp_7_0.CODE_VALUE_SOURCE) || "");
  }
}
...
function MappingEditorDrawer_Conditional_2_Conditional_23_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, MappingEditorDrawer_Conditional_2_Conditional_23_For_2_Template, 2, 1, "div", 77, _forTrack03);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function MappingEditorDrawer_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(18, MappingEditorDrawer_Conditional_2_Conditional_18_Template, 48, 7, "div", 10);
    \u0275\u0275conditionalCreate(19, MappingEditorDrawer_Conditional_2_Conditional_19_Template, 6, 1, "div", 10);
    \u0275\u0275conditionalCreate(20, MappingEditorDrawer_Conditional_2_Conditional_20_Template, 22, 3, "div", 10);
    \u0275\u0275conditionalCreate(21, MappingEditorDrawer_Conditional_2_Conditional_21_Template, 35, 6, "div", 10);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" Pairs (", ((tmp_5_0 = ctx_r1.editedMapping().PAIRS) == null ? null : tmp_5_0.length) || 0, ") ");
    \u0275\u0275advance();
...
var MappingEditorDrawer = class _MappingEditorDrawer {
  ...
  updateValueMetadata(field, value) {
    ...
    if (!current)
      return;
    const valueMetadata = current.VALUE_METADATA || { CODE_SYSTEM: "", VALUE_SET_URL: "", CODE_VALUE_SOURCE: "" };
    this.editedMapping.set(__spreadProps(__spreadValues({}, current), {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MappingEditorDrawer, selectors: [["app-mapping-editor-drawer"]], inputs: { mapping: [1, "mapping"], isOpen: [1, "isOpen"] }, outputs: { save: "save", cancel: "cancel" }, decls: 3, vars: 4, consts: [[1, "drawer-backdrop"], [1, "drawer-panel"], [1, "drawer-backdrop", 3, "click"], [1, "drawer-header"], [1, "header-content"], [1, "header-subtitle"], ["title", "Close", 1, "close-btn", 3, "click"], [1, "drawer-tabs"], [1, "tab-btn", 3, "click"], [1, "drawer-content"], [1, "tab-panel"], [1, "drawer-footer"], [1, "validation-errors"], [1, "footer-buttons"], [1, "btn", "btn-secondary", 3, "click"], [1, "btn", "btn-primary", 3, "click"], [1, "form-group"], ["type", "text", "disabled", "", 1, "form-control", 3, "value"], [1, "help-text"], [1, "form-control", 3, "ngModelChange", "ngModel"], ["value", "mapping"], ["value", "freetext"], ["value", "date_time"], ["value", "number"], ["value", "boolean"], ["type", "text", "placeholder", "Short description of this field", 1, "form-control", 3, "ngModelChange", "ngModel"], ["type", "text", "placeholder", "CCL function name (optional)", 1, "form-control", 3, "ngModelChange", "ngModel"], ["rows", "3", "placeholder", "Detailed description of this mapping", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "form-row"], [1, "form-group", "checkbox-group"], ["type", "checkbox", 3, "change", "checked"], [1, "pairs-table-container"], [1, "empty-state"], [1, "add-row-container"], [1, "add-btn", 3, "click"], [1, "pairs-table"], [1, "col-active"], [1, "col-type"], [1, "col-key"], [1, "col-key-type"], [1, "col-pds"], [1, "col-pds-type"], [1, "col-display"], [1, "col-priority"], [1, "col-actions"], [3, "inactive"], ["type", "text", 1, "inline-input", 3, "ngModelChange", "ngModel"], [1, "inline-select", 3, "ngModelChange", "ngModel"], ["value", "ALPHA_RESPONSE_DISPLAY"], ["value", "CODE_VALUE_DISPLAY"], ["value", "CODE_VALUE"], ["value", "CONSTANT"], ["value", "MHA_PDS_CODE"], ["value", "FREETEXT"], ["value", "SNOMED"], ["value", "LOINC"], ["type", "number", 1, "inline-input", "inline-number", 3, "ngModelChange", "ngModel"], ["title", "Remove pair", 1, "delete-btn", 3, "click"], [1, "source-section"], [1, "source-list"], [1, "no-items"], [1, "add-btn", "small", 3, "click"], [1, "source-item"], ["type", "text", "placeholder", "Table name", 1, "form-control", 3, "ngModelChange", "ngModel"], ["type", "text", "placeholder", "Field name", 1, "form-control", 3, "ngModelChange", "ngModel"], ["type", "number", "placeholder", "Priority", 1, "form-control", "priority-input", 3, "ngModelChange", "ngModel"], ["title", "Remove", 1, "delete-btn", 3, "click"], ["type", "text", "placeholder", "DTA name", 1, "form-control", "flex-grow", 3, "ngModelChange", "ngModel"], ["type", "number", "placeholder", "Code Set Number", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "fhir-section"], [1, "section-description"], ["type", "text", "placeholder", "e.g., 76691-5", 1, "form-control", 3, "ngModelChange", "ngModel"], ["type", "text", "placeholder", "e.g., Gender identity", 1, "form-control", 3, "ngModelChange", "ngModel"], ["type", "text", "placeholder", "e.g., http://loinc.org", 1, "form-control", 3, "ngModelChange", "ngModel"], ["type", "text", "placeholder", "e.g., http://snomed.info/sct", 1, "form-control", 3, "ngModelChange", "ngModel"], ["type", "text", "placeholder", "e.g., http://ontariohealth.ca/fhir/ValueSet/...", 1, "form-control", 3, "ngModelChange", "ngModel"], ["type", "text", "placeholder", "e.g., SNOMED CT, MHA PDS v1.2", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "error-item"]], template: function MappingEditorDrawer_Template(rf, ctx) {
    if (rf & 1) {
...
function ConfigSectionMappings_For_34_Conditional_27_Template(rf, ctx) {
  if (rf & 1) {
...
function ConfigSectionMappings_For_34_Conditional_31_Conditional_1_For_5_Template(rf, ctx) {
  if (rf & 1) {
...
function ConfigSectionMappings_For_34_Conditional_31_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 40)(1, "h5");
    \u0275\u0275text(2, "Source Tables");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 42);
    \u0275\u0275repeaterCreate(4, ConfigSectionMappings_For_34_Conditional_31_Conditional_1_For_5_Template, 7, 3, "div", 43, _forTrack2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function ConfigSectionMappings_For_34_Conditional_31_Conditional_2_For_5_Template(rf, ctx) {
  if (rf & 1) {
...
function ConfigSectionMappings_For_34_Conditional_31_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 40)(1, "h5");
    \u0275\u0275text(2, "Discrete Task Assays (DTAs)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 47);
    \u0275\u0275repeaterCreate(4, ConfigSectionMappings_For_34_Conditional_31_Conditional_2_For_5_Template, 5, 2, "div", 48, _forTrack3);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const mapping_r3 = \u0275\u0275nextContext(2).$implicit;
...
function ConfigSectionMappings_For_34_Conditional_31_Conditional_3_For_21_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
...
function ConfigSectionMappings_For_34_Conditional_31_Conditional_3_For_21_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 55);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function ConfigSectionMappings_For_34_Conditional_31_Conditional_3_For_21_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr")(1, "td")(2, "input", 54);
    \u0275\u0275listener("change", function ConfigSectionMappings_For_34_Conditional_31_Conditional_3_For_21_Template_input_change_2_listener($event) {
    ...
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(8, ConfigSectionMappings_For_34_Conditional_31_Conditional_3_For_21_Conditional_8_Template, 2, 1, "span", 55);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "td")(10, "code");
    \u0275\u0275text(11);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(12, ConfigSectionMappings_For_34_Conditional_31_Conditional_3_For_21_Conditional_12_Template, 2, 1, "span", 55);
    \u0275\u0275elementEnd();
...
function ConfigSectionMappings_For_34_Conditional_31_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 40)(1, "h5");
    ...
    \u0275\u0275repeaterCreate(20, ConfigSectionMappings_For_34_Conditional_31_Conditional_3_For_21_Template, 17, 10, "tr", 53, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const mapping_r3 = \u0275\u0275nextContext(2).$implicit;
...
function ConfigSectionMappings_For_34_Conditional_31_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
...
function ConfigSectionMappings_For_34_Conditional_31_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, ConfigSectionMappings_For_34_Conditional_31_Conditional_1_Template, 6, 0, "div", 40);
    \u0275\u0275conditionalCreate(2, ConfigSectionMappings_For_34_Conditional_31_Conditional_2_Template, 6, 0, "div", 40);
    \u0275\u0275conditionalCreate(3, ConfigSectionMappings_For_34_Conditional_31_Conditional_3_Template, 22, 0, "div", 40)(4, ConfigSectionMappings_For_34_Conditional_31_Conditional_4_Template, 3, 0, "div", 41);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const mapping_r3 = \u0275\u0275nextContext().$implicit;
...
function ConfigSectionMappings_For_34_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(18, "span", 29)(19, "span", 30);
    \u0275\u0275text(20, "Pairs:");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function ConfigSectionMappings_For_34_Template_button_click_24_listener($event) {
      const mapping_r3 = \u0275\u0275restoreView(_r2).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
    ...
    \u0275\u0275conditionalCreate(27, ConfigSectionMappings_For_34_Conditional_27_Template, 2, 0, "span", 35)(28, ConfigSectionMappings_For_34_Conditional_28_Template, 2, 0, "span", 36);
    \u0275\u0275conditionalCreate(29, ConfigSectionMappings_For_34_Conditional_29_Template, 2, 0, "span", 37);
    \u0275\u0275conditionalCreate(30, ConfigSectionMappings_For_34_Conditional_30_Template, 2, 0, "span", 38);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(31, ConfigSectionMappings_For_34_Conditional_31_Template, 5, 3, "div", 39);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const mapping_r3 = ctx.$implicit;
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(mapping_r3.FUNCTION ? 17 : -1);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(mapping_r3.PAIRS.length || 0);
    \u0275\u0275advance(5);
    \u0275\u0275conditional(ctx_r3.isFieldActiveForSubmission(mapping_r3.MHA_PDS_FIELD_NAME) ? 27 : 28);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(mapping_r3.CONSTANT_IND === 1 ? 29 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(mapping_r3.ALPHA_RESONSE_IND === 1 ? 30 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r3.expandedMappings()[mapping_r3.MHA_PDS_FIELD_NAME] ? 31 : -1);
  }
}
...
var ConfigSectionMappings = class _ConfigSectionMappings {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConfigSectionMappings, selectors: [["app-config-section-mappings"]], inputs: { mappings: "mappings", submitFields: "submitFields" }, outputs: { mappingsChange: "mappingsChange" }, decls: 37, vars: 10, consts: [[1, "section-content"], [1, "controls-bar"], [1, "search-box"], ["type", "text", "placeholder", "Search mappings...", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "filter-select"], [1, "form-control", 3, "ngModelChange", "ngModel"], ["value", ""], [3, "value"], ["value", "active"], ["value", "inactive"], [1, "stats"], [1, "stat-item"], [1, "stat-item", "submission-stats"], [1, "active-count"], [1, "inactive-count"], [1, "mappings-list"], [1, "mapping-item", 3, "expanded", "submission-inactive"], [1, "empty-state"], [3, "save", "cancel", "mapping", "isOpen"], [1, "mapping-item"], [1, "mapping-header", 3, "click"], [1, "mapping-info"], [1, "mapping-title"], [1, "expand-icon"], ["title", "Active for submission", 1, "submission-indicator", "active"], ["title", "Not active for submission", 1, "submission-indicator", "inactive"], [1, "field-name"], [1, "field-notes"], [1, "mapping-meta"], [1, "meta-item"], [1, "meta-label"], [1, "meta-value"], [1, "mapping-actions"], ["title", "Edit mapping", 1, "edit-btn", 3, "click"], [1, "mapping-badges"], [1, "badge", "badge-active"], [1, "badge", "badge-inactive"], [1, "badge", "badge-constant"], [1, "badge", "badge-alpha"], [1, "mapping-details"], [1, "detail-section"], [1, "no-pairs"], [1, "source-list"], [1, "source-item"], [1, "source-table"], [1, "source-field"], [1, "source-priority"], [1, "dta-list"], [1, "dta-item"], [1, "dta-name"], [1, "dta-priority"], [1, "pairs-table-container"], [1, "pairs-table"], [3, "inactive"], ["type", "checkbox", 3, "change", "checked"], [1, "ref-type"]], template: function ConfigSectionMappings_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div", 2)(3, "input", 3);
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275repeaterCreate(8, ConfigSectionMappings_For_9_Template, 2, 3, "option", 7, _forTrack04);
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275repeaterCreate(33, ConfigSectionMappings_For_34_Template, 32, 15, "div", 16, _forTrack13);
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance();
      \u0275\u0275property("mapping", ctx.selectedMapping())("isOpen", ctx.drawerOpen());
    }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConfigSectionMappings, { className: "ConfigSectionMappings", filePath: "src/app/config-editor/sections/config-section-mappings.ts", lineNumber: 622 });
})();

// src/app/config-editor/sections/config-section-fhir-codes.ts
var _forTrack05 = ($index, $item) => $item.RESOURCE_TYPE + "-" + $item.FIELD_NAME + "-" + $item.CODE;
...
var ConfigSectionFhirCodes = class _ConfigSectionFhirCodes {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConfigSectionFhirCodes, selectors: [["app-config-section-fhir-codes"]], inputs: { fhirCodes: "fhirCodes" }, decls: 48, vars: 5, consts: [[1, "section-content"], [1, "info-banner"], [1, "info-icon"], [1, "controls-bar"], [1, "filter-select"], [1, "form-control", 3, "ngModelChange", "ngModel"], ["value", ""], [3, "value"], [1, "stats"], [1, "stat-item"], [1, "codes-table-container"], [1, "codes-table"], [1, "col-resource"], [1, "col-field"], [1, "col-code"], [1, "col-label"], [1, "col-system"], [1, "col-default"], [3, "is-default"], [1, "resource-summary"], [1, "summary-grid"], [1, "summary-card"], [1, "resource-badge"], ["target", "_blank", 1, "system-link", 3, "href", "title"], [1, "no-value"], [1, "default-badge"], ["colspan", "6", 1, "empty-row"], [1, "summary-type"], [1, "summary-count"], [1, "summary-fields"], [1, "field-tag"]], template: function ConfigSectionFhirCodes_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(38, "tbody");
      \u0275\u0275repeaterCreate(39, ConfigSectionFhirCodes_For_40_Template, 17, 8, "tr", 18, _forTrack05);
...
var _forTrack06 = ($index, $item) => $item.NURSE_UNIT_CD;
var _forTrack14 = ($index, $item) => $item.LOCATION_CD;
...
function ConfigSectionMhaLocations_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(13, ConfigSectionMhaLocations_Conditional_11_For_14_Template, 12, 5, "tr", 7, _forTrack06);
    \u0275\u0275domElementEnd()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function ConfigSectionMhaLocations_Conditional_13_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, ConfigSectionMhaLocations_Conditional_13_Conditional_10_For_2_Template, 10, 6, "div", 26, _forTrack14, false, ConfigSectionMhaLocations_Conditional_13_Conditional_10_ForEmpty_3_Template, 3, 1, "div", 27);
    \u0275\u0275domElementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
var _forTrack07 = ($index, $item) => $item.MHA_PDS_FIELD_NAME;
var _forTrack15 = ($index, $item) => $item.KEY_REF;
...
function ConfigSectionMappingTester_Conditional_35_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(7, "Try:");
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(8, ConfigSectionMappingTester_Conditional_35_Conditional_6_For_9_Template, 2, 1, "button", 37, _forTrack15);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const field_r4 = \u0275\u0275nextContext();
...
var ConfigSectionMappingTester = class _ConfigSectionMappingTester {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConfigSectionMappingTester, selectors: [["app-config-section-mapping-tester"]], inputs: { mappings: "mappings", codeTableMappings: "codeTableMappings" }, decls: 38, vars: 9, consts: [[1, "section-content"], [1, "info-banner"], [1, "info-icon"], [1, "test-form"], [1, "form-row"], [1, "form-group", "field-select"], ["for", "fieldCode"], ["id", "fieldCode", 1, "form-control", 3, "ngModelChange", "ngModel"], ["value", ""], [3, "value"], [1, "form-group", "source-input"], ["for", "sourceValue"], ["id", "sourceValue", "type", "text", "placeholder", "Enter the Cerner value to test...", 1, "form-control", 3, "ngModelChange", "keyup.enter", "ngModel"], [1, "form-group", "type-select"], ["for", "sourceType"], ["id", "sourceType", 1, "form-control", 3, "ngModelChange", "ngModel"], ["value", "CODE_VALUE_DISPLAY"], ["value", "ALPHA_RESPONSE_DISPLAY"], ["value", "LITERAL"], [1, "form-group", "button-group"], [1, "btn", "btn-primary", 3, "click", "disabled"], [1, "btn", "btn-secondary"], [1, "field-info-panel"], [1, "result-panel", 3, "found", "not-found"], [1, "error-banner"], [1, "spinner-small"], [1, "btn", "btn-secondary", 3, "click"], [1, "field-info-header"], [1, "field-name"], [1, "field-type-badge", 3, "class"], [1, "field-info-details"], [1, "detail-item", "warning"], [1, "field-type-badge"], [1, "detail-item"], [1, "label"], [1, "value"], [1, "detail-item", "suggestions"], [1, "suggestion-chip"], [1, "suggestion-chip", 3, "click"], [1, "result-panel"], [1, "result-header"], [1, "result-body"], [1, "result-section"], [1, "result-grid"], [1, "result-item"], [1, "result-section", "error-section"], [1, "result-icon", "success"], [1, "result-title"], [1, "result-icon", "error"], [1, "code-value"], [1, "label-value"], [1, "result-item", "full-width"], ["target", "_blank", 1, "link", 3, "href"], [1, "code-table-badge"], [1, "error-message"], [1, "error-hint"], [1, "error-icon"], [1, "dismiss-btn", 3, "click"]], template: function ConfigSectionMappingTester_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275repeaterCreate(14, ConfigSectionMappingTester_For_15_Template, 2, 3, "option", 9, _forTrack07);
      \u0275\u0275elementEnd()();
...
var MirthValidatorService = class _MirthValidatorService {
  ...
  errorLookup = /* @__PURE__ */ new Map([
    ...
    // DE04.001-006 - Basic Demographics
    ["DE04_001_001", "Sex CODE Not Found"],
    ["DE04_001_002", "Sex LABEL Not Found"],
    ["DE04_001_003", "Sex CODE_SYSTEM Not Found"],
    ["DE04_002_001", "Preferred Language CODE Not Found"],
    ["DE04_002_002", "Preferred Language LABEL Not Found"],
    ["DE04_002_003", "Preferred Language CODE_SYSTEM Not Found"],
    ["DE04_005_001", "Phone Number Not Found"],
    ["DE04_006_001", "Marital Status CODE Not Found"],
    ...
    // DE10 - Service
    ["DE10_001_001", "Service Date Not Found"],
    ["DE10_002_001", "Service Type CODE Not Found"]
  ]);
...
var DataAnalyzerService = class _DataAnalyzerService {
  ...
  clientFieldDefinitions = [
    ...
    // DE04 - Demographics
    { field_code: "DE04.001", field_name: "Sex", source_column: "sex", coded: true, code_table: "CT-002", record_type: "client" },
    { field_code: "DE04.002", field_name: "Preferred Language", source_column: "preferred_language", coded: true, code_table: "CT-021", record_type: "client" },
    { field_code: "DE04.005", field_name: "Phone Number", source_column: "phone_number", record_type: "client" },
    // DE04 - SDOH Fields
    ...
    { field_code: "DE04.013", field_name: "Highest Education Level", source_column: "highest_education_level", sdoh: true, code_table: "CT-013", record_type: "client" },
    ...
    { field_code: "DE04.015", field_name: "Personal Income Source", source_column: "personal_income_source", sdoh: true, code_table: "CT-015", record_type: "client" },
    ...
    { field_code: "DE04.018", field_name: "Total Household Income", source_column: "total_household_income", sdoh: true, code_table: "CT-018", record_type: "client" },
    { field_code: "DE04.019", field_name: "Number of People Income Supports", source_column: "number_of_people_income_supports", sdoh: true, code_table: "CT-018", record_type: "client" },
  ...
  serviceFieldDefinitions = [
    // DE10 - Service
    { field_code: "DE10.001", field_name: "Service Date", source_column: "service_date", required: true, record_type: "service" },
    { field_code: "DE10.002", field_name: "Service Type", source_column: "service_type", coded: true, code_table: "CT-025", record_type: "service" },
    { field_code: "DE10.003", field_name: "Service Location", source_column: "service_location", coded: true, code_table: "CT-026", record_type: "service" },
    { field_code: "DE10.004", field_name: "Provider Type", source_column: "provider_type", coded: true, code_table: "CT-031", record_type: "service" }
  ];
  /**
...
var _forTrack08 = ($index, $item) => $item.record_id;
var _forTrack16 = ($index, $item) => $item.field_code;
...
function ConfigSectionDataAnalyzer_Conditional_27_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(15, ConfigSectionDataAnalyzer_Conditional_27_Conditional_17_For_16_Template, 10, 3, "tr", null, _forTrack16);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function ConfigSectionDataAnalyzer_Conditional_27_Conditional_24_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(28, ConfigSectionDataAnalyzer_Conditional_27_Conditional_24_For_29_Template, 21, 13, "tr", 50, _forTrack16);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function ConfigSectionDataAnalyzer_Conditional_27_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(22, ConfigSectionDataAnalyzer_Conditional_27_For_23_Template, 13, 12, "div", 29, _forTrack08);
    \u0275\u0275elementEnd()();
...
var ConfigSectionDataAnalyzer = class _ConfigSectionDataAnalyzer {
  ...
  databaseLoaded = computed(() => {
    try {
      const data = JSON.parse(this.databaseJson());
      return data.clients?.length > 0 || data.CLIENTS?.length > 0;
    } catch {
      return false;
    }
  ...
  episodeCount = computed(() => {
    try {
      const data = JSON.parse(this.databaseJson());
      return data.episodes?.length || data.EPISODES?.length || 0;
    } catch {
      return 0;
    }
  ...
  serviceCount = computed(() => {
    try {
      const data = JSON.parse(this.databaseJson());
      return data.services?.length || data.SERVICES?.length || 0;
    } catch {
      return 0;
    }
  ...
  runAnalysis() {
    if (!this.config)
      return;
    try {
      const dbData = JSON.parse(this.databaseJson());
      const normalizedData = {
        clients: dbData.clients || dbData.CLIENTS || [],
        episodes: dbData.episodes || dbData.EPISODES || [],
        services: dbData.services || dbData.SERVICES || []
      };
...
function ConfigEditorComponent_Conditional_15_For_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(3, ConfigEditorComponent_Conditional_15_For_3_Conditional_3_Template, 2, 0, "span", 39);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function ConfigEditorComponent_Conditional_15_Case_11_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-config-section-mirth", 40);
...
function ConfigEditorComponent_Conditional_15_Case_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, ConfigEditorComponent_Conditional_15_Case_11_Conditional_0_Template, 1, 1, "app-config-section-mirth", 34);
  }
  if (rf & 2) {
    let tmp_2_0;
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function ConfigEditorComponent_Conditional_15_Case_12_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-config-section-submission", 40);
...
function ConfigEditorComponent_Conditional_15_Case_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, ConfigEditorComponent_Conditional_15_Case_12_Conditional_0_Template, 1, 1, "app-config-section-submission", 34);
  }
  if (rf & 2) {
    let tmp_2_0;
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function ConfigEditorComponent_Conditional_15_Case_13_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-config-section-processing", 40);
...
function ConfigEditorComponent_Conditional_15_Case_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, ConfigEditorComponent_Conditional_15_Case_13_Conditional_0_Template, 1, 1, "app-config-section-processing", 34);
  }
  if (rf & 2) {
    let tmp_2_0;
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function ConfigEditorComponent_Conditional_15_Case_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-config-section-submit-fields", 41);
    \u0275\u0275listener("fieldsChange", function ConfigEditorComponent_Conditional_15_Case_14_Template_app_config_section_submit_fields_fieldsChange_0_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function ConfigEditorComponent_Conditional_15_Case_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-config-section-code-tables", 31);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function ConfigEditorComponent_Conditional_15_Case_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-config-section-mappings", 42);
    \u0275\u0275listener("mappingsChange", function ConfigEditorComponent_Conditional_15_Case_16_Template_app_config_section_mappings_mappingsChange_0_listener($event) {
      \u0275\u0275restoreView(_r12);
      const ctx_r1 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275property("mappings", ctx_r1.mappings())("submitFields", ctx_r1.submitFields());
  }
}
function ConfigEditorComponent_Conditional_15_Case_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-config-section-mapping-tester", 33);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function ConfigEditorComponent_Conditional_15_Case_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-config-section-data-analyzer", 34);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function ConfigEditorComponent_Conditional_15_Case_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-config-section-fhir-codes", 35);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function ConfigEditorComponent_Conditional_15_Case_20_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-config-section-mha-locations", 43);
    \u0275\u0275listener("locationsChange", function ConfigEditorComponent_Conditional_15_Case_20_Template_app_config_section_mha_locations_locationsChange_0_listener($event) {
      \u0275\u0275restoreView(_r13);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function ConfigEditorComponent_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(2, ConfigEditorComponent_Conditional_15_For_3_Template, 4, 4, "button", 25, _forTrack09);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275conditionalCreate(11, ConfigEditorComponent_Conditional_15_Case_11_Template, 1, 1)(12, ConfigEditorComponent_Conditional_15_Case_12_Template, 1, 1)(13, ConfigEditorComponent_Conditional_15_Case_13_Template, 1, 1)(14, ConfigEditorComponent_Conditional_15_Case_14_Template, 1, 2, "app-config-section-submit-fields", 30)(15, ConfigEditorComponent_Conditional_15_Case_15_Template, 1, 2, "app-config-section-code-tables", 31)(16, ConfigEditorComponent_Conditional_15_Case_16_Template, 1, 2, "app-config-section-mappings", 32)(17, ConfigEditorComponent_Conditional_15_Case_17_Template, 1, 2, "app-config-section-mapping-tester", 33)(18, ConfigEditorComponent_Conditional_15_Case_18_Template, 1, 1, "app-config-section-data-analyzer", 34)(19, ConfigEditorComponent_Conditional_15_Case_19_Template, 1, 1, "app-config-section-fhir-codes", 35)(20, ConfigEditorComponent_Conditional_15_Case_20_Template, 1, 1, "app-config-section-mha-locations", 36);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    let tmp_4_0;
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional((tmp_4_0 = ctx_r1.activeTab()) === "mirth" ? 11 : tmp_4_0 === "submission" ? 12 : tmp_4_0 === "processing" ? 13 : tmp_4_0 === "submit_fields" ? 14 : tmp_4_0 === "code_tables" ? 15 : tmp_4_0 === "mappings" ? 16 : tmp_4_0 === "mapping_tester" ? 17 : tmp_4_0 === "data_analyzer" ? 18 : tmp_4_0 === "fhir_codes" ? 19 : tmp_4_0 === "mha_locations" ? 20 : -1);
  }
}
...
var ConfigEditorComponent = class _ConfigEditorComponent {
  ...
  tabs = [
    ...
    { id: "code_tables", label: "Code Tables", icon: "table", description: "32 code tables (read-only)", editable: false },
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConfigEditorComponent, selectors: [["app-config-editor"]], decls: 17, vars: 7, consts: [[1, "config-editor-container"], [1, "page-header"], [1, "header-content"], [1, "header-title"], [1, "page-description"], [1, "header-actions"], [1, "btn", "btn-secondary", 3, "click", "disabled"], [1, "status-bar"], [1, "notification", 3, "class"], [1, "loading-overlay"], [1, "main-content"], [1, "empty-state"], [1, "btn", "btn-primary", 3, "click", "disabled"], [1, "spinner-small"], [1, "status-item"], [1, "status-label"], [1, "status-value"], [1, "status-item", "status-unsaved"], [1, "status-badge"], [1, "notification"], [1, "notification-message"], [1, "notification-dismiss", 3, "click"], [1, "loading-content"], [1, "spinner"], [1, "tab-navigation"], [1, "tab-button", 3, "active"], [1, "tab-content"], [1, "tab-header"], [1, "tab-description"], [1, "tab-panel"], [3, "fields", "fieldsByCategory"], [3, "codeTables", "codeTableMappings"], [3, "mappings", "submitFields"], [3, "mappings", "codeTableMappings"], [3, "config"], [3, "fhirCodes"], [3, "locations"], [1, "tab-button", 3, "click"], [1, "tab-label"], [1, "tab-readonly-badge"], [3, "configChange", "config"], [3, "fieldsChange", "fields", "fieldsByCategory"], [3, "mappingsChange", "mappings", "submitFields"], [3, "locationsChange", "locations"], [1, "btn", "btn-primary", 3, "click"]], template: function ConfigEditorComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(15, ConfigEditorComponent_Conditional_15_Template, 21, 3, "div", 10);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConfigEditorComponent, { className: "ConfigEditorComponent", filePath: "src/app/config-editor/config-editor.ts", lineNumber: 88 });
})();
export {
