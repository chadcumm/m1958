...
function SystemOverviewPanelComponent_Conditional_30_Template(rf, ctx) {
  if (rf & 1) {
...
function SystemOverviewPanelComponent_Conditional_31_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 11)(1, "span", 26);
    \u0275\u0275text(2, "!");
    \u0275\u0275elementEnd();
...
function SystemOverviewPanelComponent_Conditional_32_Template(rf, ctx) {
  if (rf & 1) {
...
function SystemOverviewPanelComponent_Conditional_33_For_18_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr", 30);
    \u0275\u0275listener("click", function SystemOverviewPanelComponent_Conditional_33_For_18_Template_tr_click_0_listener() {
...
function SystemOverviewPanelComponent_Conditional_33_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 27);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "div", 28)(3, "table")(4, "thead")(5, "tr")(6, "th");
    \u0275\u0275text(7, "Started");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "th");
    \u0275\u0275text(9, "Duration");
    ...
    \u0275\u0275repeaterCreate(17, SystemOverviewPanelComponent_Conditional_33_For_18_Template, 12, 9, "tr", 29, \u0275\u0275componentInstance().trackByLogId, true);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
var SystemOverviewPanelComponent = class _SystemOverviewPanelComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SystemOverviewPanelComponent, selectors: [["app-system-overview-panel"]], outputs: { closed: "closed", viewLog: "viewLog" }, decls: 71, vars: 4, consts: [[1, "overview-panel"], [1, "panel-header"], ["aria-label", "Close", 1, "close-btn", 3, "click"], ["aria-hidden", "true"], [1, "panel-content"], [1, "overview-section"], [1, "diagram-container"], [3, "definition"], [1, "section-description"], [1, "diagram-container", "diagram-large"], [1, "loading-state"], [1, "error-state"], [1, "empty-state"], [1, "overview-section", "legend-section"], [1, "legend-grid"], [1, "legend-item"], [1, "legend-badge", "stage1"], [1, "legend-text"], [1, "legend-badge", "stage2"], [1, "mt-3"], [1, "legend-grid", "bundle-types"], [1, "legend-badge", "bundle-sreoc"], [1, "legend-badge", "bundle-sdoh"], [1, "legend-badge", "bundle-hs"], [1, "legend-badge", "bundle-sa"], [1, "spinner"], [1, "error-icon"], [1, "runs-summary"], [1, "runs-table"], [1, "run-row"], [1, "run-row", 3, "click"], [1, "start-time"], [1, "duration"], [1, "status-badge"], [1, "record-count"], [1, "error-count"]], template: function SystemOverviewPanelComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(15, "Stage 1: Manager Process Detail");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275text(22, "Stage 2: Transmission Process Detail");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(23, "p", 8);
      \u0275\u0275text(24, " Dynamic bundle determination based on pending data in EPISODE, CLIENT, SERVICE, and APPOINTMENT tables ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(25, "div", 9);
      \u0275\u0275element(26, "app-mermaid-diagram", 7);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(27, "section", 5)(28, "h5");
      \u0275\u0275text(29, "Recent Manager Runs");
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(30, SystemOverviewPanelComponent_Conditional_30_Template, 4, 0, "div", 10)(31, SystemOverviewPanelComponent_Conditional_31_Template, 5, 1, "div", 11)(32, SystemOverviewPanelComponent_Conditional_32_Template, 3, 0, "div", 12)(33, SystemOverviewPanelComponent_Conditional_33_Template, 19, 2);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(34, "section", 13)(35, "h5");
      \u0275\u0275text(36, "Processing Stages");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(37, "div", 14)(38, "div", 15)(39, "span", 16);
      \u0275\u0275text(40, "Stage 1");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(41, "span", 17);
      \u0275\u0275text(42, "Data Extraction (Hourly) - Extract episodes, clients, services, appointments");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(43, "div", 15)(44, "span", 18);
      \u0275\u0275text(45, "Stage 2");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(46, "span", 17);
      \u0275\u0275text(47, "Data Transmission (Daily) - Build JSON and send to Ontario Health");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(48, "h5", 19);
      \u0275\u0275text(49, "FHIR Bundle Types");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(50, "div", 20)(51, "div", 15)(52, "span", 21);
      \u0275\u0275text(53, "SERVICE_REQUEST_EOC");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(54, "span", 17);
      \u0275\u0275text(55, "New episode with referral and health program data");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(56, "div", 15)(57, "span", 22);
      \u0275\u0275text(58, "CLIENT_SDOH");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(59, "span", 17);
      \u0275\u0275text(60, "Client demographics and social determinants of health");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(61, "div", 15)(62, "span", 23);
      \u0275\u0275text(63, "HEALTH_SERVICES");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(64, "span", 17);
      \u0275\u0275text(65, "Service events (encounters) with provider organization");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(66, "div", 15)(67, "span", 24);
      \u0275\u0275text(68, "SCHEDULED_APPOINTMENT");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(69, "span", 17);
      \u0275\u0275text(70, "Scheduled appointments linked to episodes");
      \u0275\u0275elementEnd()()()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(12);
      ...
      \u0275\u0275advance(4);
      \u0275\u0275conditional(ctx.loading() ? 30 : ctx.error() ? 31 : ctx.recentRuns().length === 0 ? 32 : 33);
    }
