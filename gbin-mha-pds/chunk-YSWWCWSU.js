...
var AuditPayloadParserService = class _AuditPayloadParserService {
  ...
  extractFromOrganization(deCode, orgs) {
    ...
    if (!org)
      return null;
    if (deCode === "DE07.001") {
      const ohfs = this.findIdentifierBySystem(org.identifier, "OHFS");
      return ohfs ? { value_sent: ohfs } : null;
    }
    if (deCode === "DE07.002") {
      const connex = this.findIdentifierBySystem(org.identifier, "ConnexOrg");
      return connex ? { value_sent: connex } : null;
    }
    if (deCode === "DE07.003") {
  ...
  extractFromLocation(deCode, locations) {
    ...
    if (!loc)
      return null;
    if (deCode === "DE08.001") {
      const site = this.findIdentifierBySystem(loc.identifier, "ConnexSite");
      return site ? { value_sent: site } : null;
    }
    if (deCode === "DE08.002") {
  ...
  extractFromServiceRequest(deCode, requests) {
    ...
    switch (deCode) {
      case "DE05.001":
        return sr.identifier?.[0]?.value ? { value_sent: sr.identifier[0].value } : null;
      case "DE05.002":
        return sr.authoredOn ? { value_sent: sr.authoredOn } : null;
      case "DE05.004": {
        const display = this.getExtensionCodeDisplay(sr.extension, "referralSourceType");
        return display ? { mapped_code: display } : null;
      }
      case "DE05.005": {
        const display = this.getExtensionCodeDisplay(sr.extension, "ReferralType");
        return display ? { mapped_code: display } : null;
      }
      default:
        return null;
  ...
  extractFromEpisodeOfCare(deCode, episodes) {
    ...
    switch (deCode) {
      ...
      case "DE06.008": {
        const date = this.getExtensionValueDate(eoc.extension, "ServiceInitiationDate");
        return date ? { value_sent: date } : null;
      }
      case "DE06.009": {
        const date = this.getExtensionValueDate(eoc.extension, "eligibilityScreeningDate");
        return date ? { value_sent: date } : null;
      }
      default:
        return null;
  ...
  extractFromHealthcareService(deCode, services) {
    ...
    switch (deCode) {
      case "DE09.001": {
        const prog = this.findIdentifierBySystem(hs.identifier, "ConnexProgram");
        return prog ? { value_sent: prog } : null;
      }
      case "DE09.002":
        return hs.name ? { value_sent: hs.name } : null;
      case "DE09.003": {
        const fc = this.getExtensionCodeDisplay(hs.extension, "functionalCentreCode");
        return fc ? { mapped_code: fc } : null;
      }
      default:
        return null;
    }
  ...
  extractFromEncounter(deCode, encounters) {
    ...
    switch (deCode) {
      case "DE10.001":
        return enc.identifier?.[0]?.value ? { value_sent: enc.identifier[0].value } : null;
      case "DE10.002": {
        const cls = enc.class;
      ...
      case "DE10.005": {
        const mins = this.getExtensionValueInteger(enc.extension, "directminutes");
        return mins !== null ? { value_sent: String(mins) } : null;
      }
      case "DE10.007":
  ...
  extractFromPatient(deCode, patients) {
    ...
    switch (deCode) {
      ...
      case "DE02.001": {
        const mrn = this.findPatientIdentifierByTypeCode(patient.identifier, "MR");
        return mrn ? { value_sent: mrn } : null;
      }
      case "DE02.003": {
        const jhn = this.findPatientIdentifierByTypeCode(patient.identifier, "JHN");
        return jhn ? { value_sent: jhn } : null;
      }
      case "DE03.001": {
  ...
  // =========================================================================
  /**
   * Find an identifier value by matching a partial system URL.
   * e.g., findIdentifierBySystem(ids, 'OHFS') matches system containing 'OHFS'.
   */
  findIdentifierBySystem(identifiers, systemFragment) {
    if (!Array.isArray(identifiers))
      return null;
    for (const id of identifiers) {
      if (id.system && id.system.includes(systemFragment) && id.value) {
        return id.value;
      }
    }
    return null;
   ...
   * e.g., findPatientIdentifierByTypeCode(ids, 'MR') for medical record number.
   */
  findPatientIdentifierByTypeCode(identifiers, typeCode) {
    if (!Array.isArray(identifiers))
      return null;
    for (const id of identifiers) {
  ...
  /**
   * Get the display value from a coded extension (valueCodeableConcept).
   * Matches extension by partial URL fragment.
   */
  getExtensionCodeDisplay(extensions, urlFragment) {
    if (!Array.isArray(extensions))
      return null;
    for (const ext of extensions) {
      if (ext.url && ext.url.includes(urlFragment)) {
        const display = ext.valueCodeableConcept?.coding?.[0]?.display;
        if (display)
          return display;
      }
    }
   ...
   */
  getExtensionValueDate(extensions, urlFragment) {
    if (!Array.isArray(extensions))
      return null;
    for (const ext of extensions) {
      if (ext.url && ext.url.includes(urlFragment) && ext.valueDate) {
   ...
   */
  getExtensionValueInteger(extensions, urlFragment) {
    if (!Array.isArray(extensions))
      return null;
    for (const ext of extensions) {
      if (ext.url && ext.url.includes(urlFragment) && ext.valueInteger !== void 0 && ext.valueInteger !== null) {
...
function AuditDataPointsComponent_Conditional_1_For_18_For_4_Template(rf, ctx) {
  if (rf & 1) {
...
function AuditDataPointsComponent_Conditional_1_For_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "tr", 10)(1, "td", 11);
    \u0275\u0275text(2);
    \u0275\u0275domElementEnd()();
    \u0275\u0275repeaterCreate(3, AuditDataPointsComponent_Conditional_1_For_18_For_4_Template, 13, 8, "tr", 12, _forTrack1);
  }
  if (rf & 2) {
...
function AuditDataPointsComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(17, AuditDataPointsComponent_Conditional_1_For_18_Template, 5, 1, null, null, _forTrack02);
    \u0275\u0275domElementEnd()()();
  }
  if (rf & 2) {
...
var AuditDataPointsComponent = class _AuditDataPointsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AuditDataPointsComponent, selectors: [["app-audit-data-points"]], inputs: { dataPoints: [1, "dataPoints"], bundleType: [1, "bundleType"] }, decls: 2, vars: 1, consts: [[1, "no-data-points"], [1, "data-points-container", 3, "class"], [1, "data-points-container"], [1, "data-points-table"], [1, "col-de-code"], [1, "col-field"], [1, "col-value"], [1, "col-mapped-code"], [1, "col-mapped-label"], [1, "col-code-system"], [1, "group-header-row"], ["colspan", "6"], [1, "data-point-row", 3, "mapped-row"], [1, "data-point-row"], [1, "col-de-code", "mono"], [1, "col-mapped-code", "mono"]], template: function AuditDataPointsComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275conditionalCreate(0, AuditDataPointsComponent_Conditional_0_Template, 2, 0, "div", 0)(1, AuditDataPointsComponent_Conditional_1_Template, 19, 2, "div", 1);
    }
    if (rf & 2) {
...
(() => {
  ...
  `, styles: ['/* angular:styles/component:scss;9e98cc6f4f304bd178fae19df76aa1393d3cf7e21f93e72a23739666aa516d0b;/Users/chadcummings/Github/chadcumm/gbin-mha-pds/src/app/audit/components/audit-data-points.ts */\n.data-points-container {\n  border-left: 3px solid #dee2e6;\n  margin: 4px 0;\n  overflow-x: auto;\n}\n.data-points-container.border-eoc {\n  border-left-color: #2563eb;\n}\n.data-points-container.border-sdoh {\n  border-left-color: #16a34a;\n}\n.data-points-container.border-hse {\n  border-left-color: #ea580c;\n}\n.data-points-table {\n  width: 100%;\n  border-collapse: collapse;\n  font-size: 0.75rem;\n}\n.data-points-table th,\n.data-points-table td {\n  padding: 4px 8px;\n  text-align: left;\n  border-bottom: 1px solid #f0f0f0;\n}\n.data-points-table th {\n  background: #f8f9fa;\n  font-weight: 600;\n  color: #495057;\n  white-space: nowrap;\n  font-size: 0.6875rem;\n  text-transform: uppercase;\n  letter-spacing: 0.3px;\n}\n.group-header-row td {\n  background: #f1f3f5;\n  font-weight: 600;\n  font-size: 0.6875rem;\n  color: #495057;\n  text-transform: uppercase;\n  letter-spacing: 0.3px;\n  padding: 6px 8px;\n  border-bottom: 1px solid #dee2e6;\n}\n.data-point-row:hover {\n  background: #f8f9fa;\n}\n.data-point-row.mapped-row {\n  background: #fffbeb;\n}\n.data-point-row.mapped-row:hover {\n  background: #fef3c7;\n}\n.mono {\n  font-family:\n    "SFMono-Regular",\n    Consolas,\n    "Liberation Mono",\n    Menlo,\n    monospace;\n  font-size: 0.6875rem;\n}\n.col-de-code {\n  width: 80px;\n}\n.col-field {\n  min-width: 140px;\n}\n.col-value {\n  min-width: 120px;\n}\n.col-mapped-code {\n  width: 120px;\n}\n.col-mapped-label {\n  min-width: 140px;\n}\n.col-code-system {\n  min-width: 100px;\n  font-size: 0.625rem;\n  color: #6c757d;\n}\n.no-data-points {\n  text-align: center;\n  color: #6c757d;\n  font-size: 0.8125rem;\n  font-style: italic;\n  padding: 16px;\n}\n'] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AuditDataPointsComponent, { className: "AuditDataPointsComponent", filePath: "src/app/audit/components/audit-data-points.ts", lineNumber: 148 });
})();
...
function AuditBundleListComponent_Conditional_2_For_41_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
...
function AuditBundleListComponent_Conditional_2_For_41_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
...
function AuditBundleListComponent_Conditional_2_For_41_Conditional_21_Conditional_3_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
...
function AuditBundleListComponent_Conditional_2_For_41_Conditional_21_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 32)(1, "span", 34)(2, "span", 35);
    \u0275\u0275text(3, "Channel:");
    \u0275\u0275elementEnd();
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "span", 34)(6, "span", 35);
    \u0275\u0275text(7, "Message:");
    \u0275\u0275elementEnd();
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "span", 34)(10, "span", 35);
    \u0275\u0275text(11, "Response:");
    \u0275\u0275elementEnd();
    \u0275\u0275text(12);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(13, AuditBundleListComponent_Conditional_2_For_41_Conditional_21_Conditional_3_Conditional_13_Template, 5, 1, "span", 34);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const meta_r6 = ctx;
...
function AuditBundleListComponent_Conditional_2_For_41_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr", 28)(1, "td", 30)(2, "div", 31);
    \u0275\u0275conditionalCreate(3, AuditBundleListComponent_Conditional_2_For_41_Conditional_21_Conditional_3_Template, 14, 4, "div", 32);
    \u0275\u0275element(4, "app-audit-data-points", 33);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    let tmp_12_0;
    ...
    \u0275\u0275advance();
    \u0275\u0275property("dataPoints", bundle_r4.data_points)("bundleType", bundle_r4.bundle_type);
  }
}
function AuditBundleListComponent_Conditional_2_For_41_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr", 20);
    \u0275\u0275listener("click", function AuditBundleListComponent_Conditional_2_For_41_Template_tr_click_0_listener() {
      const bundle_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.toggleBundle(bundle_r4.submission_batch_id));
    });
    \u0275\u0275elementStart(1, "td", 17)(2, "span", 21);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(12);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "td")(14, "span", 25);
    \u0275\u0275text(15);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "td", 18);
    \u0275\u0275conditionalCreate(17, AuditBundleListComponent_Conditional_2_For_41_Conditional_17_Template, 2, 4, "span", 26)(18, AuditBundleListComponent_Conditional_2_For_41_Conditional_18_Template, 2, 0, "span", 27);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "td", 19);
    \u0275\u0275text(20);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(21, AuditBundleListComponent_Conditional_2_For_41_Conditional_21_Template, 5, 3, "tr", 28);
  }
  if (rf & 2) {
    let tmp_21_0;
...
function AuditBundleListComponent_Conditional_2_ForEmpty_42_Template(rf, ctx) {
  if (rf & 1) {
...
function AuditBundleListComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AuditBundleListComponent_Conditional_2_Template_button_click_16_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.expandAll());
    });
    \u0275\u0275text(17, "\u25BC Expand All");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "button", 14);
    \u0275\u0275listener("click", function AuditBundleListComponent_Conditional_2_Template_button_click_18_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.collapseAll());
    });
    \u0275\u0275text(19, "\u25B6 Collapse All");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(20, "div", 15)(21, "table", 16)(22, "thead")(23, "tr");
    \u0275\u0275element(24, "th", 17);
    ...
    \u0275\u0275text(30, "Response ID");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "th");
    \u0275\u0275text(32, "Submission Date");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(38, "Data Points");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(39, "tbody");
    \u0275\u0275repeaterCreate(40, AuditBundleListComponent_Conditional_2_For_41_Template, 22, 15, null, null, _forTrack03, false, AuditBundleListComponent_Conditional_2_ForEmpty_42_Template, 3, 0, "tr");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var AuditBundleListComponent = class _AuditBundleListComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AuditBundleListComponent, selectors: [["app-audit-bundle-list"]], inputs: { bundles: [1, "bundles"], loading: [1, "loading"] }, outputs: { filteredBundlesChange: "filteredBundlesChange" }, decls: 3, vars: 1, consts: [[1, "loading-state"], [1, "empty-state"], [1, "spinner"], [1, "summary-bar"], [1, "summary-counts"], [1, "total-count"], [1, "type-count"], [1, "summary-actions"], [1, "type-filter", 3, "ngModelChange", "ngModel"], ["value", "ALL"], ["value", "SERVICE_REQUEST_EOC"], ["value", "CLIENT_SDOH"], ["value", "HEALTH_SERVICES"], ["title", "Expand all", 1, "action-btn", 3, "click"], ["title", "Collapse all", 1, "action-btn", 3, "click"], [1, "table-wrapper"], [1, "bundle-table"], [1, "col-expand"], [1, "col-http"], [1, "col-count"], [1, "bundle-row", 3, "click"], [1, "expand-icon"], [1, "type-badge"], [1, "col-id", 3, "title"], [1, "col-date"], [1, "status-badge"], [1, "http-badge", 3, "class", "title"], [1, "http-na"], [1, "expanded-row"], [1, "http-badge", 3, "title"], ["colspan", "8"], [1, "expanded-content"], [1, "mirth-meta-bar"], [3, "dataPoints", "bundleType"], [1, "meta-item"], [1, "meta-label"], [1, "mono"], ["colspan", "8", 1, "no-matches"]], template: function AuditBundleListComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275conditionalCreate(0, AuditBundleListComponent_Conditional_0_Template, 3, 0, "div", 0)(1, AuditBundleListComponent_Conditional_1_Template, 2, 0, "div", 1)(2, AuditBundleListComponent_Conditional_2_Template, 43, 7);
    }
    if (rf & 2) {
...
(() => {
  ...
  `, styles: ['/* angular:styles/component:scss;52b7a78ce411502744c2f14e1fc5de2ac09efc094a10ae55b78d884fa2614fdf;/Users/chadcummings/Github/chadcumm/gbin-mha-pds/src/app/audit/components/audit-bundle-list.ts */\n.loading-state {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  gap: 0.5rem;\n  padding: 3rem;\n  color: #6c757d;\n  font-size: 0.875rem;\n}\n.spinner {\n  display: inline-block;\n  width: 20px;\n  height: 20px;\n  border: 2px solid #e9ecef;\n  border-top-color: #1a365d;\n  border-radius: 50%;\n  animation: spin 0.6s linear infinite;\n}\n@keyframes spin {\n  to {\n    transform: rotate(360deg);\n  }\n}\n.empty-state {\n  text-align: center;\n  color: #6c757d;\n  font-size: 0.9375rem;\n  font-style: italic;\n  padding: 3rem;\n}\n.summary-bar {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  flex-wrap: wrap;\n  gap: 0.75rem;\n  padding: 0.75rem 0;\n  margin-bottom: 0.5rem;\n  border-bottom: 1px solid #e9ecef;\n}\n.summary-counts {\n  display: flex;\n  align-items: center;\n  gap: 0.75rem;\n}\n.summary-counts .total-count {\n  font-weight: 600;\n  color: #1a365d;\n  font-size: 0.875rem;\n}\n.summary-counts .type-count {\n  font-size: 0.8125rem;\n  color: #6c757d;\n}\n.summary-actions {\n  display: flex;\n  align-items: center;\n  gap: 0.5rem;\n}\n.type-filter {\n  padding: 0.375rem 0.5rem;\n  border: 1px solid #ced4da;\n  border-radius: 4px;\n  font-size: 0.8125rem;\n  color: #495057;\n  background: white;\n  cursor: pointer;\n}\n.type-filter:focus {\n  outline: none;\n  border-color: #1a365d;\n  box-shadow: 0 0 0 2px rgba(26, 54, 93, 0.15);\n}\n.action-btn {\n  padding: 0.375rem 0.625rem;\n  border: 1px solid #ced4da;\n  border-radius: 4px;\n  background: white;\n  font-size: 0.75rem;\n  color: #495057;\n  cursor: pointer;\n  transition: background-color 0.15s;\n}\n.action-btn:hover {\n  background: #e9ecef;\n}\n.table-wrapper {\n  overflow-x: auto;\n}\n.bundle-table {\n  width: 100%;\n  border-collapse: collapse;\n  font-size: 0.8125rem;\n}\n.bundle-table th,\n.bundle-table td {\n  padding: 0.5rem 0.625rem;\n  text-align: left;\n  border-bottom: 1px solid #dee2e6;\n}\n.bundle-table th {\n  background: #f8f9fa;\n  font-weight: 600;\n  color: #495057;\n  white-space: nowrap;\n  font-size: 0.75rem;\n  text-transform: uppercase;\n  letter-spacing: 0.3px;\n}\n.col-expand {\n  width: 32px;\n  text-align: center;\n  padding-left: 0.5rem;\n  padding-right: 0;\n}\n.col-count {\n  text-align: center;\n  width: 80px;\n}\n.bundle-row {\n  cursor: pointer;\n  transition: background-color 0.15s;\n}\n.bundle-row:hover {\n  background: #f1f3f4;\n}\n.bundle-row:nth-child(4n+1) {\n  background: #fafbfc;\n}\n.bundle-row:nth-child(4n+1):hover {\n  background: #f1f3f4;\n}\n.expand-icon {\n  color: #6c757d;\n  font-size: 0.6875rem;\n}\n.type-badge {\n  display: inline-block;\n  padding: 2px 8px;\n  border-radius: 4px;\n  font-size: 0.6875rem;\n  font-weight: 500;\n  white-space: nowrap;\n}\n.type-badge.badge-eoc {\n  background: #dbeafe;\n  color: #1e40af;\n}\n.type-badge.badge-sdoh {\n  background: #dcfce7;\n  color: #166534;\n}\n.type-badge.badge-hse {\n  background: #ffedd5;\n  color: #9a3412;\n}\n.status-badge {\n  display: inline-block;\n  padding: 2px 8px;\n  border-radius: 4px;\n  font-size: 0.6875rem;\n  font-weight: 500;\n  text-transform: uppercase;\n}\n.status-badge.status-accepted {\n  background: #d4edda;\n  color: #155724;\n}\n.status-badge.status-submitted {\n  background: #dbeafe;\n  color: #1e40af;\n}\n.status-badge.status-error {\n  background: #f8d7da;\n  color: #721c24;\n}\n.col-http {\n  text-align: center;\n  width: 56px;\n}\n.http-badge {\n  display: inline-block;\n  padding: 2px 6px;\n  border-radius: 4px;\n  font-size: 0.6875rem;\n  font-weight: 600;\n  font-family:\n    "SFMono-Regular",\n    Consolas,\n    "Liberation Mono",\n    Menlo,\n    monospace;\n}\n.http-badge.http-success {\n  background: #d4edda;\n  color: #155724;\n}\n.http-badge.http-error {\n  background: #f8d7da;\n  color: #721c24;\n}\n.http-badge.http-other {\n  background: #e2e3e5;\n  color: #383d41;\n}\n.http-na {\n  color: #adb5bd;\n  font-size: 0.75rem;\n}\n.mirth-meta-bar {\n  display: flex;\n  flex-wrap: wrap;\n  gap: 1rem;\n  padding: 6px 12px;\n  margin-bottom: 4px;\n  background: #e8f4fd;\n  border-radius: 4px;\n  font-size: 0.6875rem;\n  color: #495057;\n}\n.meta-item {\n  display: inline-flex;\n  align-items: center;\n  gap: 4px;\n}\n.meta-label {\n  font-weight: 600;\n  color: #6c757d;\n}\n.mono {\n  font-family:\n    "SFMono-Regular",\n    Consolas,\n    "Liberation Mono",\n    Menlo,\n    monospace;\n  font-size: 0.6875rem;\n}\n.col-id {\n  font-family:\n    "SFMono-Regular",\n    Consolas,\n    "Liberation Mono",\n    Menlo,\n    monospace;\n  font-size: 0.75rem;\n  color: #495057;\n  cursor: default;\n}\n.col-date {\n  white-space: nowrap;\n  color: #6c757d;\n  font-size: 0.8125rem;\n}\n.expanded-row td {\n  padding: 0;\n  background: #f8f9fa;\n  border-bottom: 2px solid #dee2e6;\n}\n.expanded-content {\n  padding: 8px 12px 12px 40px;\n}\n.no-matches {\n  text-align: center;\n  color: #6c757d;\n  font-style: italic;\n  padding: 2rem !important;\n}\n@media (max-width: 768px) {\n  .summary-bar {\n    flex-direction: column;\n    align-items: flex-start;\n  }\n  .summary-actions {\n    flex-wrap: wrap;\n  }\n}\n'] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AuditBundleListComponent, { className: "AuditBundleListComponent", filePath: "src/app/audit/components/audit-bundle-list.ts", lineNumber: 466 });
})();
...
var AuditExportService = class _AuditExportService {
   ...
   */
  exportToCSV(patient, bundles) {
    const csvContent = this.buildCSV(patient, bundles);
   ...
   */
  buildCSV(patient, bundles) {
    const rows = [];
    rows.push(this.CSV_HEADERS.map((h) => this.escapeCSVValue(h)).join(","));
    for (const bundle of bundles) {
      if (bundle.data_points.length === 0) {
        rows.push(this.buildRow(patient, bundle, null));
      } else {
        for (const dataPoint of bundle.data_points) {
          rows.push(this.buildRow(patient, bundle, dataPoint));
        }
      }
    }
    return "\uFEFF" + rows.join("\r\n");
   ...
   */
  buildRow(patient, bundle, dataPoint) {
...
function AuditComponent_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "app-audit-bundle-list", 13);
    \u0275\u0275listener("filteredBundlesChange", function AuditComponent_Conditional_7_Template_app_audit_bundle_list_filteredBundlesChange_9_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("bundles", ctx_r0.bundles())("loading", ctx_r0.loadingBundles());
  }
}
...
var AuditComponent = class _AuditComponent {
  ...
  onExportCSV() {
    ...
    if (bundles.length === 0)
      return;
    this.auditExportService.exportToCSV(patient, bundles);
  }
  static \u0275fac = function AuditComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AuditComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AuditComponent, selectors: [["app-audit"]], decls: 10, vars: 2, consts: [[1, "audit-container"], [1, "audit-header"], [3, "patientSelected"], [1, "audit-content"], [1, "audit-error"], [1, "audit-placeholder"], [1, "audit-loading"], [1, "error-icon"], [1, "audit-patient-info"], [1, "patient-name"], [1, "patient-mrn"], [1, "bundle-count"], ["title", "Export audit data as CSV spreadsheet", 1, "export-btn", 3, "click", "disabled"], [3, "filteredBundlesChange", "bundles", "loading"], [1, "spinner"]], template: function AuditComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(7, AuditComponent_Conditional_7_Template, 10, 7)(8, AuditComponent_Conditional_8_Template, 3, 0, "div", 5)(9, AuditComponent_Conditional_9_Template, 3, 0, "div", 6);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(6);
