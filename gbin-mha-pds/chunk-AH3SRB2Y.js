...
} from "./chunk-LRF3IYJ3.js";
import {
  MhaPdsConfigurationService
} from "./chunk-Y34IXHXQ.js";
import {
  AppStatusService,
  CodeValueService,
  FormsModule,
...
function SecurityComponent_Conditional_16_Conditional_10_Conditional_9_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(4);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r0.lookupResult().position);
  }
}
function SecurityComponent_Conditional_16_Conditional_10_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(7, SecurityComponent_Conditional_16_Conditional_10_Conditional_9_Conditional_7_Template, 2, 0, "span", 39)(8, SecurityComponent_Conditional_16_Conditional_10_Conditional_9_Conditional_8_Template, 2, 0, "span", 40)(9, SecurityComponent_Conditional_16_Conditional_10_Conditional_9_Conditional_9_Template, 2, 1, "span", 41);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
    \u0275\u0275classProp("lookup-added", ctx_r0.lookupResult().added)("lookup-exists", ctx_r0.lookupResult().alreadyExists);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.lookupResult().name);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(ctx_r0.lookupResult().position);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.lookupResult().added ? 7 : ctx_r0.lookupResult().alreadyExists ? 8 : 9);
  }
}
function SecurityComponent_Conditional_16_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 33)(7, "mpage-select", 34);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(8, SecurityComponent_Conditional_16_Conditional_10_Conditional_8_Template, 2, 0, "span", 28);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(9, SecurityComponent_Conditional_16_Conditional_10_Conditional_9_Template, 10, 7, "div", 35);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.lookupResult() ? 9 : -1);
  }
}
function SecurityComponent_Conditional_16_For_24_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(tab_r8.label);
  }
}
...
function SecurityComponent_Conditional_16_For_29_For_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "td", 19)(1, "input", 44);
    \u0275\u0275listener("change", function SecurityComponent_Conditional_16_For_29_For_5_Template_input_change_1_listener($event) {
      ...
      const position_r12 = \u0275\u0275nextContext().$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.toggleTabAccess(position_r12, tab_r11.key, $event));
    });
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("checked", ctx_r0.isPositionInTab(position_r12, tab_r11.key))("disabled", ctx_r0.isSuperuserPosition(position_r12));
  }
}
function SecurityComponent_Conditional_16_For_29_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(2);
    \u0275\u0275conditionalCreate(3, SecurityComponent_Conditional_16_For_29_Conditional_3_Template, 2, 0, "span", 42);
    \u0275\u0275elementEnd();
    \u0275\u0275repeaterCreate(4, SecurityComponent_Conditional_16_For_29_For_5_Template, 2, 2, "td", 19, _forTrack0);
    \u0275\u0275elementStart(6, "td", 20)(7, "button", 43);
    \u0275\u0275listener("click", function SecurityComponent_Conditional_16_For_29_Template_button_click_7_listener() {
      const position_r12 = \u0275\u0275restoreView(_r9).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r0.removePosition(position_r12));
    });
    \u0275\u0275text(8, " Remove ");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275classProp("superuser-row", ctx_r0.isSuperuserPosition(position_r12));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", position_r12, " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r0.isSuperuserPosition(position_r12) ? 3 : -1);
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r0.allTabs);
    \u0275\u0275advance(3);
    \u0275\u0275property("disabled", ctx_r0.isSuperuserPosition(position_r12))("title", ctx_r0.isSuperuserPosition(position_r12) ? "Remove from superusers first" : "Remove position");
  }
}
...
function SecurityComponent_Conditional_16_Conditional_33_Conditional_1_Conditional_4_For_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("mousedown", function SecurityComponent_Conditional_16_Conditional_33_Conditional_1_Conditional_4_For_1_Template_div_mousedown_0_listener() {
      const pos_r15 = \u0275\u0275restoreView(_r14).$implicit;
      const ctx_r0 = \u0275\u0275nextContext(5);
      return \u0275\u0275resetView(ctx_r0.selectPosition(pos_r15));
    });
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(pos_r15);
  }
}
function SecurityComponent_Conditional_16_Conditional_33_Conditional_1_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, SecurityComponent_Conditional_16_Conditional_33_Conditional_1_Conditional_4_For_1_Template, 2, 1, "div", 31, \u0275\u0275repeaterTrackByIdentity);
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(4);
...
function SecurityComponent_Conditional_16_Conditional_33_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(4, SecurityComponent_Conditional_16_Conditional_33_Conditional_1_Conditional_4_Template, 2, 0)(5, SecurityComponent_Conditional_16_Conditional_33_Conditional_1_Conditional_5_Template, 2, 0, "div", 30);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(3);
...
function SecurityComponent_Conditional_16_Conditional_33_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(1, SecurityComponent_Conditional_16_Conditional_33_Conditional_1_Template, 6, 2, "div", 27);
    \u0275\u0275conditionalCreate(2, SecurityComponent_Conditional_16_Conditional_33_Conditional_2_Template, 2, 0, "span", 28);
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
  ...
  onPersonnelSelected() {
    ...
    const check = () => {
      if (this.prsnlService.has(personId)) {
        ...
        if (!alreadyExists) {
          this.pendingPositions.update((pp) => [...pp, position]);
        }
        this.lookupResult.set({
          ...
          @if (lookupResult()) {
            <div class="lookup-result" [class.lookup-added]="lookupResult()!.added" [class.lookup-exists]="lookupResult()!.alreadyExists">
              ...
              @if (lookupResult()!.added) {
                <span class="lookup-status status-success">Added to matrix</span>
              } @else if (lookupResult()!.alreadyExists) {
                <span class="lookup-status">Already configured</span>
              } @else {
                <span class="lookup-status status-error">{{ lookupResult()!.position }}</span>
              }
            </div>
          }
        </div>
