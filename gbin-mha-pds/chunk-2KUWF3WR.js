...
function ServiceListComponent_For_23_Conditional_28_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275domElementStart(0, "button", 10);
    \u0275\u0275domListener("click", function ServiceListComponent_For_23_Conditional_28_Template_button_click_0_listener($event) {
      \u0275\u0275restoreView(_r3);
      const service_r1 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext();
...
function ServiceListComponent_For_23_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(26);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(27, "td", 7);
    \u0275\u0275conditionalCreate(28, ServiceListComponent_For_23_Conditional_28_Template, 2, 2, "button", 8);
    \u0275\u0275domElementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r1.hasPowerForm(service_r1) ? 28 : -1);
  }
}
function ServiceListComponent_ForEmpty_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "tr")(1, "td", 11);
...
var ServiceListComponent = class _ServiceListComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ServiceListComponent, selectors: [["app-service-list"]], inputs: { services: [1, "services"], personId: [1, "personId"], encntrId: [1, "encntrId"], activeSubmitFields: [1, "activeSubmitFields"], fieldValidations: [1, "fieldValidations"] }, decls: 25, vars: 1, consts: [[1, "service-list"], [1, "service-table"], [1, "field-indicator", 3, "title"], [1, "mapping-indicator", 3, "class", "title"], [1, "duration"], [1, "hse-id"], [1, "status-badge", "submission-hover", 3, "title"], [1, "actions"], [1, "powerform-btn", 3, "title"], [1, "mapping-indicator", 3, "title"], [1, "powerform-btn", 3, "click", "title"], ["colspan", "9", 1, "no-data"]], template: function ServiceListComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275repeaterCreate(22, ServiceListComponent_For_23_Template, 29, 33, "tr", null, ctx.trackByServiceId, true, ServiceListComponent_ForEmpty_24_Template, 3, 0, "tr");
      \u0275\u0275domElementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(22);
    ...
    <tbody>
      @for (service of services(); track trackByServiceId($index, service)) {
        <tr>
          ...
          <td>
            <span class="status-badge submission-hover" [class]="getSubmissionStatusClass(service.submission_status)"
...
function EpisodeListComponent_Conditional_2_For_1_Conditional_20_Conditional_20_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275classMap(ctx_r2.getMappingStatus("DE05_005", episode_r2.referral_source_type));
    \u0275\u0275property("title", ctx_r2.getMappingTooltip("DE05_005", episode_r2.referral_source_type));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r2.getMappingStatus("DE05_005", episode_r2.referral_source_type) === "valid" ? "\u2713" : "\u2717");
  }
}
...
function EpisodeListComponent_Conditional_2_For_1_Conditional_20_Conditional_141_Template(rf, ctx) {
  if (rf & 1) {
...
function EpisodeListComponent_Conditional_2_For_1_Conditional_20_Conditional_145_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-service-list", 23);
  }
  if (rf & 2) {
    const episode_r2 = \u0275\u0275nextContext(2).$implicit;
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function EpisodeListComponent_Conditional_2_For_1_Conditional_20_Conditional_150_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-appointment-list", 26);
  }
  if (rf & 2) {
    const episode_r2 = \u0275\u0275nextContext(2).$implicit;
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function EpisodeListComponent_Conditional_2_For_1_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 12)(1, "div", 15)(2, "h4");
    ...
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "div", 17)(12, "label");
    \u0275\u0275element(13, "span", 18);
    \u0275\u0275text(14, " Received Date (DE05.002) ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "span");
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "div", 17)(18, "label");
    \u0275\u0275element(19, "span", 18);
    \u0275\u0275conditionalCreate(20, EpisodeListComponent_Conditional_2_For_1_Conditional_20_Conditional_20_Template, 2, 4, "span", 19);
    \u0275\u0275text(21, " Source (DE05.003) ");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275conditionalCreate(27, EpisodeListComponent_Conditional_2_For_1_Conditional_20_Conditional_27_Template, 2, 4, "span", 19);
    \u0275\u0275text(28, " Type (DE05.004) ");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "div", 16)(35, "div", 17)(36, "label");
    ...
    \u0275\u0275element(43, "span", 18);
    \u0275\u0275conditionalCreate(44, EpisodeListComponent_Conditional_2_For_1_Conditional_20_Conditional_44_Template, 2, 4, "span", 19);
    \u0275\u0275text(45, " Status (DE06.002) ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(46, "span");
    \u0275\u0275text(47);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(48, "div", 17)(49, "label");
    \u0275\u0275element(50, "span", 18);
    ...
    \u0275\u0275element(56, "span", 18);
    \u0275\u0275text(57, " Eligibility Screening (DE06.004) ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(58, "span");
    \u0275\u0275text(59);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(60, "div", 16)(61, "div", 17)(62, "label");
    \u0275\u0275element(63, "span", 18);
    ...
    \u0275\u0275element(69, "span", 18);
    \u0275\u0275text(70, " Service Initiation (DE06.008) ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(71, "span");
    \u0275\u0275text(72);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(73, "div", 17)(74, "label");
    \u0275\u0275element(75, "span", 18);
    \u0275\u0275text(76, " Enrollment Date (DE06.009) ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(77, "span");
    \u0275\u0275text(78);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(79, "div", 17)(80, "label");
    \u0275\u0275element(81, "span", 18);
    \u0275\u0275text(82, " Termination Date (DE06.010) ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(83, "span");
    \u0275\u0275text(84);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(85, "div", 16)(86, "div", 17)(87, "label");
    \u0275\u0275element(88, "span", 18);
    \u0275\u0275conditionalCreate(89, EpisodeListComponent_Conditional_2_For_1_Conditional_20_Conditional_89_Template, 2, 4, "span", 19);
    \u0275\u0275text(90, " Termination Reason (DE06.011) ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(91, "span");
    \u0275\u0275text(92);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(93, "div", 15)(94, "h4");
    \u0275\u0275text(95, "Health Program (DE09)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(96, "div", 16)(97, "div", 17)(98, "label");
    \u0275\u0275element(99, "span", 18);
    \u0275\u0275conditionalCreate(100, EpisodeListComponent_Conditional_2_For_1_Conditional_20_Conditional_100_Template, 2, 4, "span", 19);
    \u0275\u0275text(101, " Program Number (DE09.001) ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(102, "span");
    \u0275\u0275text(103);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(104, "div", 17)(105, "label");
    \u0275\u0275element(106, "span", 18);
    \u0275\u0275text(107, " Program Name (DE09.002) ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(108, "span");
    \u0275\u0275text(109);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(110, "div", 17)(111, "label");
    \u0275\u0275element(112, "span", 18);
    \u0275\u0275conditionalCreate(113, EpisodeListComponent_Conditional_2_For_1_Conditional_20_Conditional_113_Template, 2, 4, "span", 19);
    \u0275\u0275text(114, " Functional Centre (DE09.003) ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(115, "span");
    \u0275\u0275text(116);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(117, "div", 20)(118, "h4");
    \u0275\u0275text(119, "Submission");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(120, "div", 16)(121, "div", 17)(122, "label");
    \u0275\u0275text(123, "Status");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(124, "span", 7);
    \u0275\u0275text(125);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(126, "div", 17)(127, "label");
    \u0275\u0275text(128, "Submitted");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(129, "span");
    \u0275\u0275text(130);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(131, "div", 17)(132, "label");
    \u0275\u0275text(133, "Batch ID");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(134, "span");
    \u0275\u0275text(135);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(136, "div", 17)(137, "label");
    \u0275\u0275text(138, "Response ID");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(139, "span");
    \u0275\u0275text(140);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(141, EpisodeListComponent_Conditional_2_For_1_Conditional_20_Conditional_141_Template, 5, 1, "div", 21);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(142, "div", 22)(143, "h4");
    \u0275\u0275text(144);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(145, EpisodeListComponent_Conditional_2_For_1_Conditional_20_Conditional_145_Template, 1, 5, "app-service-list", 23)(146, EpisodeListComponent_Conditional_2_For_1_Conditional_20_Conditional_146_Template, 2, 0, "p", 24);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(147, "div", 25)(148, "h4");
    \u0275\u0275text(149);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(150, EpisodeListComponent_Conditional_2_For_1_Conditional_20_Conditional_150_Template, 1, 3, "app-appointment-list", 26)(151, EpisodeListComponent_Conditional_2_For_1_Conditional_20_Conditional_151_Template, 2, 0, "p", 27);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const episode_r2 = \u0275\u0275nextContext().$implicit;
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.getMappingStatus("DE05_005", episode_r2.referral_source_type) !== "not-checked" ? 20 : -1);
    \u0275\u0275advance(3);
...
function EpisodeListComponent_Conditional_2_For_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(17, EpisodeListComponent_Conditional_2_For_1_Conditional_17_Template, 3, 0, "button", 10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "span", 11);
    \u0275\u0275text(19);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(20, EpisodeListComponent_Conditional_2_For_1_Conditional_20_Template, 152, 81, "div", 12);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function EpisodeListComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, EpisodeListComponent_Conditional_2_For_1_Template, 21, 11, "div", 2, \u0275\u0275componentInstance().trackByEpisodeId, true);
  }
  if (rf & 2) {
              ...
              <div class="field-row">
                ...
                <div class="field">
                  <label>
                    ...
                    @if (getMappingStatus('DE05_005', episode.referral_source_type) !== 'not-checked') {
                      <span class="mapping-indicator" [class]="getMappingStatus('DE05_005', episode.referral_source_type)"
                        [title]="getMappingTooltip('DE05_005', episode.referral_source_type)">{{ getMappingStatus('DE05_005', episode.referral_source_type) === 'valid' ? '&#10003;' : '&#10007;' }}</span>
                    }
                    Source (DE05.003)
                  </label>
...
var PatientDetailComponent = class _PatientDetailComponent {
  ...
  validateMappings() {
    ...
    for (const episode of this.episodes()) {
      ...
      addField("DE05_005", episode.referral_source_type);
