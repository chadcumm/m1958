...
function ReferenceComponent_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(90, "SERVICE -> ENCOUNTER");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(91, "td");
    \u0275\u0275text(92, "One-to-One");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(93, "td");
    \u0275\u0275text(94, "Each service links to a specific encounter");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(95, "tr")(96, "td");
    \u0275\u0275text(97, "APPOINTMENT -> SCH_EVENT");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(98, "td");
    \u0275\u0275text(99, "One-to-One");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(100, "td");
    \u0275\u0275text(101, "Each appointment links to a Cerner scheduled event");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(102, "tr")(103, "td");
    \u0275\u0275text(104, "ALL TABLES -> LOG");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(105, "td");
    \u0275\u0275text(106, "One-to-Many");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(107, "td");
    \u0275\u0275text(108, "Activity tracking for all MHA PDS tables");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(109, "tr")(110, "td");
    \u0275\u0275text(111, "LOG -> LOG");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(112, "td");
    \u0275\u0275text(113, "Self-referential");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(114, "td");
    \u0275\u0275text(115, "Hierarchical logging via parent_log_id");
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
...
function ReferenceComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4, " The MHA PDS system uses Mirth Connect as an integration engine to transform Cerner JSON data into FHIR R4 bundles and submit them to Ontario Health. The process consists of three channels that work in sequence, with callback destinations that POST responses back to Cerner for status tracking. ");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "p");
    \u0275\u0275text(26, "Transforms Cerner JSON into FHIR R4 resources. Creates bundles based on SUBMIT_BUNDLE configuration. Validates data against MHA PDS profiles. Posts error responses back to Cerner API on transformation failure.");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "div", 17)(28, "span", 18);
    \u0275\u0275text(29, "Source: Channel Reader");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "span", 19);
    \u0275\u0275text(31, "Dest 1: Channel Writer");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(32, "span", 19);
    \u0275\u0275text(33, "Dest 2: Cerner Callback");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(34, "div", 14)(35, "div", 15);
    \u0275\u0275text(36, "03");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "div", 16)(38, "h3");
    \u0275\u0275text(39, "Ontario Health Submission");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(40, "p");
    \u0275\u0275text(41, "Authenticates via OAuth2 with OneID Federation. POSTs FHIR bundles to OH Provider API. Posts OH response back to Cerner API for status tracking and error logging.");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(42, "div", 17)(43, "span", 18);
    \u0275\u0275text(44, "Source: Channel Reader");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(45, "span", 19);
    \u0275\u0275text(46, "Dest 1: Get Token");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(47, "span", 19);
    \u0275\u0275text(48, "Dest 2: HTTPS POST");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(49, "span", 19);
    \u0275\u0275text(50, "Dest 3: Cerner Callback");
    \u0275\u0275elementEnd()()()()()();
    \u0275\u0275elementStart(51, "section", 8)(52, "h2");
    \u0275\u0275text(53, "System Overview Diagram");
    \u0275\u0275elementEnd();
    \u0275\u0275element(54, "app-mermaid-diagram", 20);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(55, "section", 8)(56, "h2");
    \u0275\u0275text(57, "Channel 01: Data Poller Script Logic");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(58, "p", 12);
    \u0275\u0275text(59, " The Data Poller channel triggers daily at 2:00 AM, retrieves MHA PDS data from Cerner, and converts it to NDJSON format for patient-by-patient processing. ");
    \u0275\u0275elementEnd();
    \u0275\u0275element(60, "app-mermaid-diagram", 21);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(61, "section", 8)(62, "h2");
    \u0275\u0275text(63, "Channel 02: FHIR Transformation Script Logic");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(64, "p", 12);
    \u0275\u0275text(65, " The FHIR Transformation channel processes each patient record, creates FHIR profiles using a code template library, and assembles bundles based on the SUBMIT_BUNDLE array. ");
    \u0275\u0275elementEnd();
    \u0275\u0275element(66, "app-mermaid-diagram", 22);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(67, "section", 8)(68, "h2");
    \u0275\u0275text(69, "Channel 02: Code Template Hierarchy");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(70, "p", 12);
    \u0275\u0275text(71, " The FHIR transformation uses a library of code templates that create and cache FHIR profiles, then assemble them into bundles with proper cross-references. ");
    \u0275\u0275elementEnd();
    \u0275\u0275element(72, "app-mermaid-diagram", 23);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(73, "section", 8)(74, "h2");
    \u0275\u0275text(75, "Channel 03: OAuth2 Authentication Flow");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(76, "p", 12);
    \u0275\u0275text(77, " Ontario Health requires OAuth2 authentication using a signed JWT client assertion. The token is cached and reused until 2 minutes before expiry. ");
    \u0275\u0275elementEnd();
    \u0275\u0275element(78, "app-mermaid-diagram", 24);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(79, "section", 25)(80, "h2");
    \u0275\u0275text(81, "FHIR Resource Profiles");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(82, "p", 12);
    \u0275\u0275text(83, " The FHIR Transformation channel creates these MHA PDS-compliant FHIR R4 resources: ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(84, "div", 26)(85, "div", 27)(86, "h4");
    \u0275\u0275text(87, "Core Resources");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(88, "ul", 28)(89, "li")(90, "code");
    \u0275\u0275text(91, "Patient");
    \u0275\u0275elementEnd();
    \u0275\u0275text(92, " - DE01-DE04 client demographics");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(93, "li")(94, "code");
    \u0275\u0275text(95, "Organization");
    \u0275\u0275elementEnd();
    \u0275\u0275text(96, " - DE07 HSP organization");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(97, "li")(98, "code");
    \u0275\u0275text(99, "Location");
    \u0275\u0275elementEnd();
    \u0275\u0275text(100, " - DE08 HSP site");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(101, "div", 27)(102, "h4");
    \u0275\u0275text(103, "Episode Resources");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(104, "ul", 28)(105, "li")(106, "code");
    \u0275\u0275text(107, "ServiceRequest");
    \u0275\u0275elementEnd();
    \u0275\u0275text(108, " - DE05 referral info");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(109, "li")(110, "code");
    \u0275\u0275text(111, "EpisodeOfCare");
    \u0275\u0275elementEnd();
    \u0275\u0275text(112, " - DE06 episode tracking");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(113, "li")(114, "code");
    \u0275\u0275text(115, "HealthcareService");
    \u0275\u0275elementEnd();
    \u0275\u0275text(116, " - DE09 health program");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(117, "div", 27)(118, "h4");
    \u0275\u0275text(119, "Service Resources");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(120, "ul", 28)(121, "li")(122, "code");
    \u0275\u0275text(123, "Encounter");
    \u0275\u0275elementEnd();
    \u0275\u0275text(124, " - DE10 health service events");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(125, "li")(126, "code");
    \u0275\u0275text(127, "Appointment");
    \u0275\u0275elementEnd();
    \u0275\u0275text(128, " - DE06.006-007 (cancelled only)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(129, "li")(130, "code");
    \u0275\u0275text(131, "Condition");
    \u0275\u0275elementEnd();
    \u0275\u0275text(132, " - Mental health condition");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(133, "div", 27)(134, "h4");
    \u0275\u0275text(135, "SDOH Observations (DE04)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(136, "ul", 28)(137, "li")(138, "code");
    \u0275\u0275text(139, "Observation-GenderIdentity");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(140, "li")(141, "code");
    \u0275\u0275text(142, "Observation-SexualOrientation");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(143, "li")(144, "code");
    \u0275\u0275text(145, "Observation-CitizenshipStatus");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(146, "li")(147, "code");
    \u0275\u0275text(148, "Observation-LevelOfEducation");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(149, "li")(150, "code");
    \u0275\u0275text(151, "Observation-EmploymentStatus");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(152, "li")(153, "code");
    \u0275\u0275text(154, "Observation-PersonalIncomeSource");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(155, "li")(156, "code");
    \u0275\u0275text(157, "Observation-HousingStatus");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(158, "li")(159, "code");
    \u0275\u0275text(160, "Observation-TotalHouseholdIncome");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(161, "li")(162, "code");
    \u0275\u0275text(163, "Observation-NumberOfPeopleIncomeSupports");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(164, "li")(165, "code");
    \u0275\u0275text(166, "Observation-LegalStatus");
    \u0275\u0275elementEnd()()()()()();
    \u0275\u0275elementStart(167, "section", 29)(168, "h2");
    \u0275\u0275text(169, "Bundle Types");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(170, "p", 12);
    \u0275\u0275text(171, " Each patient episode can generate one or more FHIR bundles based on the SUBMIT_BUNDLE array. Bundles are determined by data availability and episode state. ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(172, "table", 30)(173, "thead")(174, "tr")(175, "th");
    \u0275\u0275text(176, "Bundle Type");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(177, "th");
    \u0275\u0275text(178, "Contains");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(179, "th");
    \u0275\u0275text(180, "When Used");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(181, "tbody")(182, "tr")(183, "td")(184, "code");
    \u0275\u0275text(185, "SERVICE_REQUEST_EOC");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(186, "td");
    \u0275\u0275text(187, "Patient, Organization, Location, ServiceRequest, EpisodeOfCare, HealthcareService");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(188, "td");
    \u0275\u0275text(189, "New episode with referral and program enrollment");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(190, "tr")(191, "td")(192, "code");
    \u0275\u0275text(193, "CLIENT_SDOH");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(194, "td");
    \u0275\u0275text(195, "Patient, Organization, Location, Condition, 10\xD7 Observation profiles");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(196, "td");
    \u0275\u0275text(197, "Episode has socio-demographic data (DE04)");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(198, "tr")(199, "td")(200, "code");
    \u0275\u0275text(201, "HEALTH_SERVICES");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(202, "td");
    \u0275\u0275text(203, "Patient, Organization, Location, ServiceRequest, EpisodeOfCare, Encounter, HealthcareService");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(204, "td");
    \u0275\u0275text(205, "Episode has service events (DE10)");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(206, "tr")(207, "td")(208, "code");
    \u0275\u0275text(209, "SCHEDULED_APPOINTMENT");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(210, "td");
    \u0275\u0275text(211, "Patient, Organization, Location, EpisodeOfCare, Appointment");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(212, "td");
    \u0275\u0275text(213, "First appointment was missed/cancelled only");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(214, "section", 31)(215, "h2");
    \u0275\u0275text(216, "Integration Endpoints");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(217, "table", 32)(218, "thead")(219, "tr")(220, "th");
    \u0275\u0275text(221, "Endpoint");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(229, "Cerner MHA PDS Data API");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(230, "td")(231, "code");
    \u0275\u0275text(232, "m1958.gbrh_cd.cerncd.com/mpages/reports/gbin_mha_pds_data");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(233, "td");
    \u0275\u0275text(234, "GET");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(235, "tr")(236, "td");
    \u0275\u0275text(237, "OneID OAuth Token");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(238, "td")(239, "code");
    \u0275\u0275text(240, "login.pst.oneidfederation.ehealthontario.ca/oidc/access_token");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(241, "td");
    \u0275\u0275text(242, "POST");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(243, "tr")(244, "td");
    \u0275\u0275text(245, "Ontario Health FHIR API");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(246, "td")(247, "code");
    \u0275\u0275text(248, "provider.pst.ehealthontario.ca/api2/fhir/mha/Bundle");
    \u0275\u0275elementEnd()();
...
var ReferenceComponent = class _ReferenceComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReferenceComponent, selectors: [["app-reference"]], decls: 13, vars: 6, consts: [[1, "reference-container"], [1, "reference-header"], [1, "subtitle"], [1, "tab-navigation"], [1, "tab-button", 3, "click"], [1, "diagram-section"], [1, "table-summary"], [1, "table-card"], [1, "erd-section"], ["diagramId", "mha-pds-erd", 3, "definition"], [1, "relationships-section"], [1, "relationships-table"], [1, "section-intro"], [1, "channel-summary"], [1, "channel-card"], [1, "channel-number"], [1, "channel-content"], [1, "channel-tags"], [1, "tag", "source"], [1, "tag", "dest"], ["diagramId", "mirth-flow", 3, "definition"], ["diagramId", "channel-01", 3, "definition"], ["diagramId", "channel-02", 3, "definition"], ["diagramId", "code-templates", 3, "definition"], ["diagramId", "channel-03", 3, "definition"], [1, "fhir-section"], [1, "profiles-grid"], [1, "profile-group"], [1, "profile-list"], [1, "bundles-section"], [1, "bundles-table"], [1, "endpoints-section"], [1, "endpoints-table"]], template: function ReferenceComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275conditionalCreate(11, ReferenceComponent_Conditional_11_Template, 116, 1);
      \u0275\u0275conditionalCreate(12, ReferenceComponent_Conditional_12_Template, 251, 5);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(7);
          ...
          <table class="relationships-table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>One-to-One</td>
                <td>Each service links to a specific encounter</td>
              </tr>
              <tr>
                <td>APPOINTMENT -> SCH_EVENT</td>
                <td>One-to-One</td>
                <td>Each appointment links to a Cerner scheduled event</td>
              </tr>
              <tr>
                <td>ALL TABLES -> LOG</td>
                <td>One-to-Many</td>
                <td>Activity tracking for all MHA PDS tables</td>
              </tr>
              <tr>
                <td>LOG -> LOG</td>
                <td>Self-referential</td>
                <td>Hierarchical logging via parent_log_id</td>
              </tr>
            </tbody>
          </table>
        </section>
      ...
      @if (activeTab() === 'mirth') {
        <section class="diagram-section">
          ...
          <p class="section-intro">
            ...
            that work in sequence, with callback destinations that POST responses back to Cerner for
            status tracking.
          </p>
          ...
          <div class="channel-summary">
            ...
            <div class="channel-card">
              ...
              <div class="channel-content">
                ...
                <p>Transforms Cerner JSON into FHIR R4 resources. Creates bundles based on SUBMIT_BUNDLE configuration. Validates data against MHA PDS profiles. Posts error responses back to Cerner API on transformation failure.</p>
                <div class="channel-tags">
                  <span class="tag source">Source: Channel Reader</span>
                  <span class="tag dest">Dest 1: Channel Writer</span>
                  <span class="tag dest">Dest 2: Cerner Callback</span>
                </div>
              </div>
            </div>
            <div class="channel-card">
              ...
              <div class="channel-content">
                ...
                <p>Authenticates via OAuth2 with OneID Federation. POSTs FHIR bundles to OH Provider API. Posts OH response back to Cerner API for status tracking and error logging.</p>
                <div class="channel-tags">
                  <span class="tag source">Source: Channel Reader</span>
                  <span class="tag dest">Dest 1: Get Token</span>
                  <span class="tag dest">Dest 2: HTTPS POST</span>
                  <span class="tag dest">Dest 3: Cerner Callback</span>
                </div>
              </div>
            </div>
          </div>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReferenceComponent, { className: "ReferenceComponent", filePath: "src/app/reference/reference.ts", lineNumber: 668 });
})();
export {
  ReferenceComponent
};
