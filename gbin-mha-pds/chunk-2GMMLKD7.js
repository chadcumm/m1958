...
var ReportsService = class _ReportsService {
  ...
  reportRegistry = computed(() => {
    ...
    return reports.filter((r) => r.ACTIVE_IND === 1 && this.accessControl.canAccessReport(r)).sort((a, b) => (a.SORT_SEQ ?? 0) - (b.SORT_SEQ ?? 0));
  ...
  normalizeSpreadsheetResponse(raw) {
    const report = raw.reportResponse ?? raw.report_response ?? raw.REPORT_RESPONSE ?? raw;
  ...
  normalizeMpageTableResponse(raw) {
    const report = raw.reportResponse ?? raw.report_response ?? raw.REPORT_RESPONSE ?? raw;
    return {
      request_type: report.requestType ?? report.request_type ?? report.REQUEST_TYPE ?? "",
      title: report.title ?? report.TITLE ?? "",
      status: report.status ?? report.STATUS ?? "FAILED",
      error_message: report.errorMessage ?? report.error_message ?? report.ERROR_MESSAGE ?? "",
      record_count: report.recordCount ?? report.record_count ?? report.RECORD_COUNT ?? 0,
      run_dt_tm: report.runDtTm ?? report.run_dt_tm ?? report.RUN_DT_TM ?? "",
...
function MpageTableRendererComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
...
function MpageTableRendererComponent_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 8)(1, "mpage-table", 9);
    \u0275\u0275listener("filteredData", function MpageTableRendererComponent_Conditional_13_Template_mpage_table_filteredData_1_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onFilteredData($event));
    });
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("data", ctx_r1.data().data)("params", ctx_r1.mappedParams());
  }
}
var MpageTableRendererComponent = class _MpageTableRendererComponent {
  ...
  _filteredData = signal([], ...ngDevMode ? [{ debugName: "_filteredData" }] : []);
  filteredCount = computed(() => {
    const filtered = this._filteredData();
    return filtered.length > 0 ? filtered.length : this.data().record_count;
  }, ...ngDevMode ? [{ debugName: "filteredCount" }] : []);
  ...
  exportCSV() {
    ...
    for (const row of rows) {
      csvRows.push(headers.map((h) => this.escapeCSV(String(row[h] ?? ""))).join(","));
    }
    const csvContent = "\uFEFF" + csvRows.join("\r\n");
    this.triggerDownload(csvContent, `${this.data().title}_${this.timestamp()}.csv`, "text/csv;charset=utf-8");
  }
  exportExcel() {
    import("./chunk-J4FXGVOT.js").then((XLSX) => {
      const rows = this.getExportData();
      ...
      const anchor = document.createElement("a");
      anchor.href = url;
      anchor.download = `${this.data().title}_${this.timestamp()}.xlsx`;
      anchor.style.display = "none";
      document.body.appendChild(anchor);
      anchor.click();
      setTimeout(() => {
  ...
  getExportData() {
    const filtered = this._filteredData();
    return filtered.length > 0 ? filtered : this.data().data;
  }
  timestamp() {
    return (/* @__PURE__ */ new Date()).toISOString().slice(0, 10);
  }
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MpageTableRendererComponent, selectors: [["app-mpage-table-renderer"]], inputs: { data: [1, "data"], tableParams: [1, "tableParams"] }, decls: 14, vars: 4, consts: [[1, "mpage-table-renderer"], [1, "toolbar"], [1, "toolbar-left"], [1, "text-muted"], [1, "toolbar-right"], ["title", "Export to CSV", 1, "export-btn", 3, "click"], ["title", "Export to Excel", 1, "export-btn", 3, "click"], [1, "text-muted", "mt-3"], ["coRemainingScreenSpace", "", 3, "shorten"], [3, "filteredData", "data", "params"]], template: function MpageTableRendererComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div", 2)(3, "h5");
      \u0275\u0275text(4);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275listener("click", function MpageTableRendererComponent_Template_button_click_8_listener() {
        return ctx.exportCSV();
      });
      \u0275\u0275text(9, " CSV ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(10, "button", 6);
      \u0275\u0275listener("click", function MpageTableRendererComponent_Template_button_click_10_listener() {
        return ctx.exportExcel();
      });
      \u0275\u0275text(11, " Excel ");
      \u0275\u0275elementEnd()()();
      \u0275\u0275conditionalCreate(12, MpageTableRendererComponent_Conditional_12_Template, 2, 0, "p", 7)(13, MpageTableRendererComponent_Conditional_13_Template, 2, 3, "div", 8);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(ctx.data().title);
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate2(" ", ctx.filteredCount(), " records \xB7 ", ctx.data().run_dt_tm, " ");
      \u0275\u0275advance(6);
      \u0275\u0275conditional(ctx.data().status === "NO_DATA" ? 12 : 13);
    }
  }, dependencies: [MpageTableComponent, RemainingScreenSpaceDirective], styles: ["\n\n.toolbar[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: baseline;\n  justify-content: space-between;\n  margin-bottom: 0.5rem;\n  flex-wrap: wrap;\n  gap: 0.5rem;\n}\n.toolbar-left[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: baseline;\n  gap: 0.5rem;\n  flex-wrap: wrap;\n}\n.toolbar-left[_ngcontent-%COMP%]   h5[_ngcontent-%COMP%] {\n  margin: 0;\n}\n.toolbar-right[_ngcontent-%COMP%] {\n  display: flex;\n  gap: 6px;\n}\n.export-btn[_ngcontent-%COMP%] {\n  padding: 4px 12px;\n  border: 1px solid #ced4da;\n  border-radius: 4px;\n  font-size: 13px;\n  font-weight: 500;\n  cursor: pointer;\n  background: white;\n  color: #495057;\n  transition: all 0.15s;\n}\n.export-btn[_ngcontent-%COMP%]:hover {\n  background: #e9ecef;\n  border-color: #adb5bd;\n}"], changeDetection: 0 });
};
(() => {
    ...
    <div class="mpage-table-renderer">
      <div class="toolbar">
        ...
        <div class="toolbar-right">
          ...
          <button class="export-btn" (click)="exportExcel()" title="Export to Excel">
            Excel
          </button>
        </div>
      </div>
  ...
  `, styles: ["/* angular:styles/component:scss;7d42886a7b16331153c6e01726c9db4857ae5adebafc5d6402a39d0256b62cf0;/Users/chadcummings/Github/chadcumm/gbin-mha-pds/src/app/reports/components/mpage-table-renderer.ts */\n.toolbar {\n  display: flex;\n  align-items: baseline;\n  justify-content: space-between;\n  margin-bottom: 0.5rem;\n  flex-wrap: wrap;\n  gap: 0.5rem;\n}\n.toolbar-left {\n  display: flex;\n  align-items: baseline;\n  gap: 0.5rem;\n  flex-wrap: wrap;\n}\n.toolbar-left h5 {\n  margin: 0;\n}\n.toolbar-right {\n  display: flex;\n  gap: 6px;\n}\n.export-btn {\n  padding: 4px 12px;\n  border: 1px solid #ced4da;\n  border-radius: 4px;\n  font-size: 13px;\n  font-weight: 500;\n  cursor: pointer;\n  background: white;\n  color: #495057;\n  transition: all 0.15s;\n}\n.export-btn:hover {\n  background: #e9ecef;\n  border-color: #adb5bd;\n}\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MpageTableRendererComponent, { className: "MpageTableRendererComponent", filePath: "src/app/reports/components/mpage-table-renderer.ts", lineNumber: 89 });
})();
...
function RunReportModalComponent_Conditional_25_Template(rf, ctx) {
  if (rf & 1) {
...
function RunReportModalComponent_Conditional_26_For_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("ngModelChange", function RunReportModalComponent_Conditional_26_For_5_Template_input_ngModelChange_3_listener($event) {
...
function RunReportModalComponent_Conditional_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 12)(1, "h6");
    \u0275\u0275text(2, "Parameters");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 17);
    \u0275\u0275repeaterCreate(4, RunReportModalComponent_Conditional_26_For_5_Template, 4, 5, "div", 18, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function RunReportModalComponent_Conditional_27_Template(rf, ctx) {
  if (rf & 1) {
...
var RunReportModalComponent = class _RunReportModalComponent {
  ...
  categoryLabel = computed(() => {
    const key = this.report().CATEGORY;
    if (!key)
      return "";
    const match = this.accessControlService.availableCategories().find((c) => c.key === key);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RunReportModalComponent, selectors: [["app-run-report-modal"]], inputs: { report: [1, "report"] }, outputs: { execute: "execute", cancel: "cancel" }, decls: 33, vars: 7, consts: [[1, "modal-backdrop", 3, "click"], [1, "modal-dialog", 3, "click"], [1, "modal-header"], [1, "modal-title"], [1, "modal-close", 3, "click"], [1, "modal-body"], [1, "report-description"], [1, "report-meta"], [1, "meta-row"], [1, "meta-label"], [1, "meta-value", "badge-render"], [1, "meta-value", "mono"], [1, "params-section"], [1, "no-params"], [1, "modal-footer"], [1, "btn", "btn-secondary", 3, "click"], [1, "btn", "btn-primary", 3, "click"], [1, "params-grid"], [1, "param-row"], [1, "param-label", 3, "for"], [1, "param-input", 3, "ngModelChange", "id", "type", "ngModel"]], template: function RunReportModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(24);
      \u0275\u0275elementEnd()();
      \u0275\u0275conditionalCreate(25, RunReportModalComponent_Conditional_25_Template, 5, 1, "div", 8);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(26, RunReportModalComponent_Conditional_26_Template, 6, 0, "div", 12)(27, RunReportModalComponent_Conditional_27_Template, 2, 0, "p", 13);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(28, "div", 14)(29, "button", 15);
      \u0275\u0275listener("click", function RunReportModalComponent_Template_button_click_29_listener() {
        return ctx.cancel.emit();
      });
      \u0275\u0275text(30, "Cancel");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(31, "button", 16);
      \u0275\u0275listener("click", function RunReportModalComponent_Template_button_click_31_listener() {
        return ctx.onExecute();
      });
      \u0275\u0275text(32, "Execute Report");
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(4);
      ...
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate(ctx.report().CCL_SCRIPT);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.report().CATEGORY ? 25 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.paramKeys().length > 0 ? 26 : 27);
    }
      ...
      <div class="modal-dialog" (click)="$event.stopPropagation()">
        ...
        <div class="modal-body">
          ...
          <div class="report-meta">
            ...
            <div class="meta-row">
              <span class="meta-label">CCL Script:</span>
              <span class="meta-value mono">{{ report().CCL_SCRIPT }}</span>
            </div>
            @if (report().CATEGORY) {
              <div class="meta-row">
                <span class="meta-label">Category:</span>
                <span class="meta-value badge-render">{{ categoryLabel() }}</span>
              </div>
            }
          </div>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RunReportModalComponent, { className: "RunReportModalComponent", filePath: "src/app/reports/components/run-report-modal.ts", lineNumber: 264 });
})();
