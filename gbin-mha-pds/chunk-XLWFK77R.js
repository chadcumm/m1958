...
var PatientsService = class _PatientsService {
  ...
  loadPatientDetail(clientId) {
    ...
    this._error.set(null);
    const requestData = JSON.stringify({ patient_detail_params: { client_id: clientId } });
    this.cclService.load({
      customScript: {
        script: [{
          name: "gbin_mha_pds_service:group1",
...
function ServiceListComponent_For_20_Template(rf, ctx) {
  if (rf & 1) {
...
function ServiceListComponent_ForEmpty_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "tr")(1, "td", 4);
...
var ServiceListComponent = class _ServiceListComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ServiceListComponent, selectors: [["app-service-list"]], inputs: { services: [1, "services"] }, decls: 22, vars: 1, consts: [[1, "service-list"], [1, "service-table"], [1, "duration"], [1, "org"], ["colspan", "7", 1, "no-data"]], template: function ServiceListComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275repeaterCreate(19, ServiceListComponent_For_20_Template, 15, 7, "tr", null, ctx.trackByServiceId, true, ServiceListComponent_ForEmpty_21_Template, 3, 0, "tr");
      \u0275\u0275domElementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(19);
  ...
  <table class="service-table">
    ...
    <tbody>
      @for (service of services(); track trackByServiceId($index, service)) {
        ...
        <tr>
          <td colspan="7" class="no-data">No services recorded</td>
        </tr>
      }
    </tbody>
  </table>
...
function EpisodeListComponent_Conditional_2_For_1_Conditional_16_Conditional_108_Template(rf, ctx) {
  if (rf & 1) {
...
function EpisodeListComponent_Conditional_2_For_1_Conditional_16_Conditional_112_Template(rf, ctx) {
  if (rf & 1) {
...
function EpisodeListComponent_Conditional_2_For_1_Conditional_16_Conditional_113_Template(rf, ctx) {
  if (rf & 1) {
...
function EpisodeListComponent_Conditional_2_For_1_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(46, "Assessment Date");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(47, "span");
    \u0275\u0275text(48);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(49, "div", 12)(50, "div", 13)(51, "label");
    \u0275\u0275text(52, "Service Initiation");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(53, "span");
    \u0275\u0275text(54);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(55, "div", 13)(56, "label");
    \u0275\u0275text(57, "Enrollment Date");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(58, "span");
    \u0275\u0275text(59);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(60, "div", 13)(61, "label");
    \u0275\u0275text(62, "Termination Date");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(63, "span");
    \u0275\u0275text(64);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(65, "div", 13)(66, "label");
    \u0275\u0275text(67, "Termination Reason");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(68, "span");
    \u0275\u0275text(69);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(70, "div", 11)(71, "h4");
    \u0275\u0275text(72, "Health Program (DE09)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(73, "div", 12)(74, "div", 13)(75, "label");
    \u0275\u0275text(76, "Program Number");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(77, "span");
    \u0275\u0275text(78);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(79, "div", 13)(80, "label");
    \u0275\u0275text(81, "Program Name");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(82, "span");
    \u0275\u0275text(83);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(84, "div", 13)(85, "label");
    \u0275\u0275text(86, "Functional Centre");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(87, "span");
    \u0275\u0275text(88);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(89, "div", 14)(90, "h4");
    \u0275\u0275text(91, "Submission");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(92, "div", 12)(93, "div", 13)(94, "label");
    \u0275\u0275text(95, "Status");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(96, "span", 7);
    \u0275\u0275text(97);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(98, "div", 13)(99, "label");
    \u0275\u0275text(100, "Submitted");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(107);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(108, EpisodeListComponent_Conditional_2_For_1_Conditional_16_Conditional_108_Template, 5, 1, "div", 15);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(109, "div", 16)(110, "h4");
    \u0275\u0275text(111);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(112, EpisodeListComponent_Conditional_2_For_1_Conditional_16_Conditional_112_Template, 1, 1, "app-service-list", 17)(113, EpisodeListComponent_Conditional_2_For_1_Conditional_16_Conditional_113_Template, 2, 0, "p", 18);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(episode_r2.error_message ? 108 : -1);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("Services (", episode_r2.services.length || 0, ")");
    \u0275\u0275advance();
    \u0275\u0275conditional(episode_r2.services && episode_r2.services.length > 0 ? 112 : 113);
  }
}
function EpisodeListComponent_Conditional_2_For_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(15);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(16, EpisodeListComponent_Conditional_2_For_1_Conditional_16_Template, 114, 23, "div", 10);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.isEpisodeExpanded(episode_r2.episode_id) ? 16 : -1);
  }
}
function EpisodeListComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, EpisodeListComponent_Conditional_2_For_1_Template, 17, 9, "div", 2, \u0275\u0275componentInstance().trackByEpisodeId, true);
  }
  if (rf & 2) {
...
function PatientDetailComponent_Conditional_3_Conditional_25_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 28);
    \u0275\u0275text(1, "\u2713");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "span");
    \u0275\u0275text(3, "SDOH Data Complete");
    \u0275\u0275elementEnd();
  }
}
function PatientDetailComponent_Conditional_3_Conditional_26_Conditional_4_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" +", ctx_r1.sdohMissingFields().length - 3, " more");
  }
}
function PatientDetailComponent_Conditional_3_Conditional_26_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 29);
    \u0275\u0275text(1);
    \u0275\u0275conditionalCreate(2, PatientDetailComponent_Conditional_3_Conditional_26_Conditional_4_Conditional_2_Template, 2, 1, "span");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" Missing: ", ctx_r1.sdohMissingFields().slice(0, 3).join(", "), " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.sdohMissingFields().length > 3 ? 2 : -1);
  }
}
function PatientDetailComponent_Conditional_3_Conditional_26_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 28);
    \u0275\u0275text(1, "\u26A0");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "span");
    \u0275\u0275text(3, "SDOH Data Incomplete");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(4, PatientDetailComponent_Conditional_3_Conditional_26_Conditional_4_Template, 3, 2, "span", 29);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275conditional(ctx_r1.sdohMissingFields().length > 0 ? 4 : -1);
  }
}
function PatientDetailComponent_Conditional_3_Conditional_34_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 26)(1, "div", 30)(2, "div", 31)(3, "label");
    \u0275\u0275text(4, "First Name");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "span");
    \u0275\u0275text(6);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "div", 31)(8, "label");
    ...
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "div", 31)(18, "label");
    \u0275\u0275text(19, "Date of Birth");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "span");
    \u0275\u0275text(21);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(22, "div", 31)(23, "label");
    \u0275\u0275text(24, "Estimated DOB");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(((tmp_2_0 = ctx_r1.client()) == null ? null : tmp_2_0.de01_001_first_name) || "-");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_3_0 = ctx_r1.client()) == null ? null : tmp_3_0.de01_002_middle_name) || "-");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_4_0 = ctx_r1.client()) == null ? null : tmp_4_0.de01_003_last_name) || "-");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_5_0 = ctx_r1.client()) == null ? null : tmp_5_0.de01_004_date_of_birth_formatted) || "-");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_6_0 = ctx_r1.client()) == null ? null : tmp_6_0.de01_005_estimated_dob_flag) === 1 ? "Yes" : "No");
  }
}
function PatientDetailComponent_Conditional_3_Conditional_41_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 26)(1, "div", 30)(2, "div", 31)(3, "label");
    \u0275\u0275text(4, "MRN (DE02.001)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "span");
    \u0275\u0275text(6);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "div", 31)(8, "label");
    \u0275\u0275text(9, "Vendor ID (DE02.002)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "span");
    \u0275\u0275text(11);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "div", 31)(13, "label");
    \u0275\u0275text(14, "Health Card # (DE02.003)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "span");
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "div", 31)(18, "label");
    \u0275\u0275text(19, "HCN Type (DE02.004)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "span");
    \u0275\u0275text(21);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(22, "div", 31)(23, "label");
    \u0275\u0275text(24, "Issuing Authority (DE02.005)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "span");
    \u0275\u0275text(26);
    \u0275\u0275elementEnd()()()();
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(((tmp_2_0 = ctx_r1.client()) == null ? null : tmp_2_0.de02_001_mrn) || "-");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_3_0 = ctx_r1.client()) == null ? null : tmp_3_0.de02_002_vendor_id) || "-");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_4_0 = ctx_r1.client()) == null ? null : tmp_4_0.de02_003_hcn) || "-");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_5_0 = ctx_r1.client()) == null ? null : tmp_5_0.de02_004_hcn_type) || "-");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_6_0 = ctx_r1.client()) == null ? null : tmp_6_0.de02_005_issuing_authority) || "-");
  }
}
function PatientDetailComponent_Conditional_3_Conditional_48_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 26)(1, "div", 30)(2, "div", 31)(3, "label");
    \u0275\u0275text(4, "Address Use (DE03.001)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "span");
    \u0275\u0275text(6);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "div", 31)(8, "label");
    \u0275\u0275text(9, "City (DE03.002)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "span");
    \u0275\u0275text(11);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "div", 31)(13, "label");
    \u0275\u0275text(14, "Province (DE03.003)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "span");
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "div", 31)(18, "label");
    \u0275\u0275text(19, "Postal Code (DE03.004)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "span");
    \u0275\u0275text(21);
    \u0275\u0275elementEnd()()()();
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(((tmp_2_0 = ctx_r1.client()) == null ? null : tmp_2_0.de03_001_address_use) || "-");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_3_0 = ctx_r1.client()) == null ? null : tmp_3_0.de03_002_city) || "-");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_4_0 = ctx_r1.client()) == null ? null : tmp_4_0.de03_003_province) || "-");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_5_0 = ctx_r1.client()) == null ? null : tmp_5_0.de03_004_postal_code) || "-");
  }
}
function PatientDetailComponent_Conditional_3_Conditional_55_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 26)(1, "div", 32)(2, "div", 31)(3, "label");
    \u0275\u0275text(4, "Preferred Language (DE04.001)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "span");
    \u0275\u0275text(6);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "div", 31)(8, "label");
    \u0275\u0275text(9, "Interpreter Needed (DE04.002)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "span");
    \u0275\u0275text(11);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "div", 31)(13, "label");
    \u0275\u0275text(14, "Birth Country (DE04.003)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "span");
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "div", 31)(18, "label");
    \u0275\u0275text(19, "Arrival Date Canada (DE04.004)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "span");
    \u0275\u0275text(21);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(22, "div", 31)(23, "label");
    \u0275\u0275text(24, "Immigration Status (DE04.005)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "span");
    \u0275\u0275text(26);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(27, "div", 31)(28, "label");
    \u0275\u0275text(29, "Indigenous Identity (DE04.006)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "span");
    \u0275\u0275text(31);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(32, "div", 31)(33, "label");
    \u0275\u0275text(34, "Gender Identity (DE04.007)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "span");
    \u0275\u0275text(36);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(37, "div", 31)(38, "label");
    \u0275\u0275text(39, "Sexual Orientation (DE04.008)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(40, "span");
    \u0275\u0275text(41);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(42, "div", 31)(43, "label");
    \u0275\u0275text(44, "Veteran Status (DE04.009)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(45, "span");
    \u0275\u0275text(46);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(47, "div", 31)(48, "label");
    \u0275\u0275text(49, "Disability Status (DE04.010)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(50, "span");
    \u0275\u0275text(51);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(52, "div", 31)(53, "label");
    \u0275\u0275text(54, "Racial Identity (DE04.011)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(55, "span");
    \u0275\u0275text(56);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(57, "div", 31)(58, "label");
    \u0275\u0275text(59, "Citizenship Status (DE04.012)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(60, "span");
    \u0275\u0275text(61);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(62, "div", 31)(63, "label");
    \u0275\u0275text(64, "Education (DE04.013)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(65, "span");
    \u0275\u0275text(66);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(67, "div", 31)(68, "label");
    \u0275\u0275text(69, "Employment (DE04.014)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(70, "span");
    \u0275\u0275text(71);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(72, "div", 31)(73, "label");
    \u0275\u0275text(74, "Income Source (DE04.015)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(75, "span");
    \u0275\u0275text(76);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(77, "div", 31)(78, "label");
    \u0275\u0275text(79, "Income Amount (DE04.016)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(80, "span");
    \u0275\u0275text(81);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(82, "div", 31)(83, "label");
    \u0275\u0275text(84, "Housing (DE04.017)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(85, "span");
    \u0275\u0275text(86);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(87, "div", 31)(88, "label");
    \u0275\u0275text(89, "Household Income (DE04.018)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(90, "span");
    \u0275\u0275text(91);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(92, "div", 31)(93, "label");
    \u0275\u0275text(94, "Household Size (DE04.019)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(95, "span");
    \u0275\u0275text(96);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(97, "div", 31)(98, "label");
    \u0275\u0275text(99, "Legal Status (DE04.020)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(100, "span");
    \u0275\u0275text(101);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(102, "div", 31)(103, "label");
    \u0275\u0275text(104, "French Language Services (DE04.021)");
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(((tmp_2_0 = ctx_r1.client()) == null ? null : tmp_2_0.de04_001_preferred_language) || "-");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_3_0 = ctx_r1.client()) == null ? null : tmp_3_0.de04_002_interpreter_needed) || "-");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_4_0 = ctx_r1.client()) == null ? null : tmp_4_0.de04_003_birth_country) || "-");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_5_0 = ctx_r1.client()) == null ? null : tmp_5_0.de04_004_arrival_date_canada) || "-");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_6_0 = ctx_r1.client()) == null ? null : tmp_6_0.de04_005_immigration_status) || "-");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_7_0 = ctx_r1.client()) == null ? null : tmp_7_0.de04_006_indigenous_identity) || "-");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_8_0 = ctx_r1.client()) == null ? null : tmp_8_0.de04_007_gender_identity) || "-");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_9_0 = ctx_r1.client()) == null ? null : tmp_9_0.de04_008_sexual_orientation) || "-");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_10_0 = ctx_r1.client()) == null ? null : tmp_10_0.de04_009_veteran_status) || "-");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_11_0 = ctx_r1.client()) == null ? null : tmp_11_0.de04_010_disability_status) || "-");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_12_0 = ctx_r1.client()) == null ? null : tmp_12_0.de04_011_racial_identity) || "-");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_13_0 = ctx_r1.client()) == null ? null : tmp_13_0.de04_012_citizenship_status) || "-");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_14_0 = ctx_r1.client()) == null ? null : tmp_14_0.de04_013_education) || "-");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_15_0 = ctx_r1.client()) == null ? null : tmp_15_0.de04_014_employment) || "-");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_16_0 = ctx_r1.client()) == null ? null : tmp_16_0.de04_015_income_source) || "-");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_17_0 = ctx_r1.client()) == null ? null : tmp_17_0.de04_016_income_amount) || "-");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_18_0 = ctx_r1.client()) == null ? null : tmp_18_0.de04_017_housing) || "-");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_19_0 = ctx_r1.client()) == null ? null : tmp_19_0.de04_018_household_income) || "-");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_20_0 = ctx_r1.client()) == null ? null : tmp_20_0.de04_019_household_size) || "-");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_21_0 = ctx_r1.client()) == null ? null : tmp_21_0.de04_020_legal_status) || "-");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(((tmp_22_0 = ctx_r1.client()) == null ? null : tmp_22_0.de04_021_french_language_services) || "-");
  }
}
function PatientDetailComponent_Conditional_3_Conditional_62_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 27);
    \u0275\u0275element(1, "app-episode-list", 33);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function PatientDetailComponent_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(25, PatientDetailComponent_Conditional_3_Conditional_25_Template, 4, 0)(26, PatientDetailComponent_Conditional_3_Conditional_26_Template, 5, 1);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "div", 21)(28, "section", 22)(29, "button", 23);
    ...
    \u0275\u0275text(31, "Client Information (DE01)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(32, "span", 25);
    \u0275\u0275text(33);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(34, PatientDetailComponent_Conditional_3_Conditional_34_Template, 27, 5, "div", 26);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "section", 22)(36, "button", 23);
    \u0275\u0275listener("click", function PatientDetailComponent_Conditional_3_Template_button_click_36_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleSection("identifiers"));
    });
    \u0275\u0275elementStart(37, "span", 24);
    \u0275\u0275text(38, "Client Identifiers (DE02)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "span", 25);
    \u0275\u0275text(40);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(41, PatientDetailComponent_Conditional_3_Conditional_41_Template, 27, 5, "div", 26);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(42, "section", 22)(43, "button", 23);
    \u0275\u0275listener("click", function PatientDetailComponent_Conditional_3_Template_button_click_43_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleSection("address"));
    });
    \u0275\u0275elementStart(44, "span", 24);
    \u0275\u0275text(45, "Client Address (DE03)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(46, "span", 25);
    \u0275\u0275text(47);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(48, PatientDetailComponent_Conditional_3_Conditional_48_Template, 22, 4, "div", 26);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(49, "section", 22)(50, "button", 23);
    \u0275\u0275listener("click", function PatientDetailComponent_Conditional_3_Template_button_click_50_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleSection("sdoh"));
    });
    \u0275\u0275elementStart(51, "span", 24);
    \u0275\u0275text(52, "Socio-Demographic Data (DE04)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(53, "span", 25);
    \u0275\u0275text(54);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(55, PatientDetailComponent_Conditional_3_Conditional_55_Template, 107, 21, "div", 26);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(56, "section", 22)(57, "button", 23);
    \u0275\u0275listener("click", function PatientDetailComponent_Conditional_3_Template_button_click_57_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(61);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(62, PatientDetailComponent_Conditional_3_Conditional_62_Template, 2, 1, "div", 27);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_1_0;
    ...
    \u0275\u0275advance(14);
    \u0275\u0275classProp("complete", ctx_r1.sdohComplete())("incomplete", !ctx_r1.sdohComplete());
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.sdohComplete() ? 25 : 26);
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate(ctx_r1.isSectionExpanded("demographics") ? "\u2212" : "+");
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.isSectionExpanded("demographics") ? 34 : -1);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(ctx_r1.isSectionExpanded("identifiers") ? "\u2212" : "+");
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.isSectionExpanded("identifiers") ? 41 : -1);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(ctx_r1.isSectionExpanded("address") ? "\u2212" : "+");
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.isSectionExpanded("address") ? 48 : -1);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(ctx_r1.isSectionExpanded("sdoh") ? "\u2212" : "+");
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.isSectionExpanded("sdoh") ? 55 : -1);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("Episodes (", ctx_r1.episodeCount(), ")");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.isSectionExpanded("episodes") ? "\u2212" : "+");
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.isSectionExpanded("episodes") ? 62 : -1);
  }
}
var PatientDetailComponent = class _PatientDetailComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PatientDetailComponent, selectors: [["app-patient-detail"]], outputs: { viewEpisode: "viewEpisode", viewLogs: "viewLogs" }, decls: 4, vars: 1, consts: [[1, "patient-detail-container"], [1, "loading-state"], [1, "empty-state"], [1, "spinner"], [1, "empty-icon"], ["width", "64", "height", "64", "viewBox", "0 0 24 24", "fill", "none", "stroke", "currentColor", "stroke-width", "1.5"], ["d", "M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"], ["cx", "9", "cy", "7", "r", "4"], ["d", "M23 21v-2a4 4 0 0 0-3-3.87"], ["d", "M16 3.13a4 4 0 0 1 0 7.75"], [1, "detail-header"], [1, "patient-name"], [1, "status-badge"], [1, "patient-ids"], [1, "id-badge"], [1, "detail-actions"], ["disabled", "", "title", "Coming soon", 1, "btn-action", "btn-primary"], [1, "btn-icon"], ["disabled", "", "title", "Coming soon", 1, "btn-action"], ["title", "View related logs", 1, "btn-action", 3, "click"], [1, "sdoh-banner"], [1, "detail-sections"], [1, "detail-section"], [1, "section-header", 3, "click"], [1, "section-title"], [1, "section-toggle"], [1, "section-content"], [1, "section-content", "episodes-content"], [1, "sdoh-icon"], [1, "missing-fields"], [1, "field-grid"], [1, "field"], [1, "field-grid", "sdoh-grid"], [3, "episodes"]], template: function PatientDetailComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0);
      \u0275\u0275conditionalCreate(1, PatientDetailComponent_Conditional_1_Template, 4, 0, "div", 1)(2, PatientDetailComponent_Conditional_2_Template, 9, 0, "div", 2)(3, PatientDetailComponent_Conditional_3_Template, 63, 23);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance();
...
(() => {
  ...
  @if (loading()) {
    ...
    <!-- SDOH Completeness Banner -->
    <div class="sdoh-banner" [class.complete]="sdohComplete()" [class.incomplete]="!sdohComplete()">
      @if (sdohComplete()) {
      ...
      <section class="detail-section">
        ...
        @if (isSectionExpanded('identifiers')) {
          <div class="section-content">
            <div class="field-grid">
              <div class="field">
                <label>MRN (DE02.001)</label>
                <span>{{ client()?.de02_001_mrn || '-' }}</span>
              </div>
              <div class="field">
                <label>Vendor ID (DE02.002)</label>
                <span>{{ client()?.de02_002_vendor_id || '-' }}</span>
              </div>
              <div class="field">
                <label>Health Card # (DE02.003)</label>
                <span>{{ client()?.de02_003_hcn || '-' }}</span>
              </div>
              <div class="field">
                <label>HCN Type (DE02.004)</label>
                <span>{{ client()?.de02_004_hcn_type || '-' }}</span>
              </div>
              <div class="field">
                <label>Issuing Authority (DE02.005)</label>
      ...
      <section class="detail-section">
        ...
        @if (isSectionExpanded('address')) {
          <div class="section-content">
            <div class="field-grid">
              <div class="field">
                <label>Address Use (DE03.001)</label>
                <span>{{ client()?.de03_001_address_use || '-' }}</span>
              </div>
              <div class="field">
                <label>City (DE03.002)</label>
                <span>{{ client()?.de03_002_city || '-' }}</span>
              </div>
              <div class="field">
                <label>Province (DE03.003)</label>
                <span>{{ client()?.de03_003_province || '-' }}</span>
              </div>
              <div class="field">
                <label>Postal Code (DE03.004)</label>
...
//# sourceMappingURL=chunk-XLWFK77R.js.map
