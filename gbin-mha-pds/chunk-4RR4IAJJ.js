...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SecurityComponent, { className: "SecurityComponent", filePath: "src/app/security/security.ts", lineNumber: 701 });
})();
export {
  SecurityComponent
};
