...
var routes = [
  {
    path: "",
    loadComponent: () => import("./chunk-HNVEK6MT.js").then((m) => m.DefaultRedirectComponent),
    title: "MHA PDS"
  },
  {
    path: "ccl-test",
  ...
  {
    path: "config",
    loadComponent: () => import("./chunk-2DDLWYDT.js").then((m) => m.ConfigEditorComponent),
    canActivate: [tabAccessGuard],
  ...
  {
    path: "operations",
    loadComponent: () => import("./chunk-VIWUOOM7.js").then((m) => m.OperationsComponent),
    canActivate: [tabAccessGuard],
  ...
  {
    path: "security",
    loadComponent: () => import("./chunk-CKERZVVR.js").then((m) => m.SecurityComponent),
    canActivate: [tabAccessGuard],
    title: "MHA PDS Security"
  },
  {
    path: "reports",
    loadComponent: () => import("./chunk-2GMMLKD7.js").then((m) => m.ReportsComponent),
    canActivate: [tabAccessGuard],
    title: "MHA PDS Reports"
  },
  {
    path: "no-access",
    loadComponent: () => import("./chunk-YPKFSIHA.js").then((m) => m.NoAccessComponent),
...
// src/app/version.ts
var buildVersion = "v0.0.292-develop";
var packageVersion = "0.0.292";
