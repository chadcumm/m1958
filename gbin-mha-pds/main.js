...
var routes = [
  ...
  {
    path: "logs",
    loadComponent: () => import("./chunk-6CBZKQSU.js").then((m) => m.LogsComponent),
    title: "MHA PDS Logs"
  },
  {
    path: "patients",
  ...
  {
    path: "operations",
    loadComponent: () => import("./chunk-OIU7XYSA.js").then((m) => m.OperationsComponent),
...
// src/app/version.ts
var buildVersion = "v0.0.142-develop";
var packageVersion = "0.0.142";
