...
var routes = [
  ...
  {
    path: "config",
    loadComponent: () => import("./chunk-FEYHOQA2.js").then((m) => m.ConfigEditorComponent),
  ...
  {
    path: "patients",
    loadComponent: () => import("./chunk-WQ4KUAGF.js").then((m) => m.PatientsComponent),
...
// src/app/version.ts
var buildVersion = "v0.0.193-develop";
var packageVersion = "0.0.193";
