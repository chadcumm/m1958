...
var routes = [
  ...
  {
    path: "logs",
    loadComponent: () => import("./chunk-47J7DVU6.js").then((m) => m.LogsComponent),
    title: "MHA PDS Logs"
  },
  {
    path: "patients",
    loadComponent: () => import("./chunk-BQHNVKTJ.js").then((m) => m.PatientsComponent),
  ...
  {
    path: "operations",
    loadComponent: () => import("./chunk-RK6IL77O.js").then((m) => m.OperationsComponent),
...
// src/app/version.ts
var buildVersion = "v0.0.246-develop";
var packageVersion = "0.0.246";
