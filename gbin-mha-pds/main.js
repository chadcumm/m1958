...
var routes = [
  ...
  {
    path: "logs",
    loadComponent: () => import("./chunk-3YUJWIAX.js").then((m) => m.LogsComponent),
    title: "MHA PDS Logs"
  },
  {
    path: "patients",
    loadComponent: () => import("./chunk-MR7GRWUQ.js").then((m) => m.PatientsComponent),
...
// src/app/version.ts
var buildVersion = "v0.0.201-develop";
var packageVersion = "0.0.201";
