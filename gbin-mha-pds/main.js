...
var routes = [
  ...
  {
    path: "logs",
    loadComponent: () => import("./chunk-4ZSTHT7I.js").then((m) => m.LogsComponent),
    title: "MHA PDS Logs"
  },
  {
    path: "patients",
    loadComponent: () => import("./chunk-4ON4GHP4.js").then((m) => m.PatientsComponent),
...
// src/app/version.ts
var buildVersion = "v0.0.252-develop";
var packageVersion = "0.0.252";
