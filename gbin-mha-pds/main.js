...
var routes = [
  ...
  {
    path: "logs",
    loadComponent: () => import("./chunk-75LQFP4G.js").then((m) => m.LogsComponent),
    title: "MHA PDS Logs"
  },
  {
    path: "patients",
    loadComponent: () => import("./chunk-QSSA2POX.js").then((m) => m.PatientsComponent),
...
// src/app/version.ts
var buildVersion = "v0.0.250-develop";
var packageVersion = "0.0.250";
