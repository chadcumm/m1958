...
var routes = [
  ...
  {
    path: "config",
    loadComponent: () => import("./chunk-JVDQZOQO.js").then((m) => m.ConfigEditorComponent),
    title: "MHA PDS Configuration"
  },
  {
    path: "logs",
    loadComponent: () => import("./chunk-WY43QJLN.js").then((m) => m.LogsComponent),
    title: "MHA PDS Logs"
  },
  {
    path: "patients",
    loadComponent: () => import("./chunk-5WCHU3SV.js").then((m) => m.PatientsComponent),
    title: "MHA PDS Patients"
  },
  {
    path: "operations",
    loadComponent: () => import("./chunk-VVWVC4IX.js").then((m) => m.OperationsComponent),
...
// src/app/version.ts
var buildVersion = "v0.0.101-develop";
var packageVersion = "0.0.101";
