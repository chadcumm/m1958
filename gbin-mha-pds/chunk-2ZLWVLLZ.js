...
function RunReportModalComponent_Conditional_25_For_5_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("ngModelChange", function RunReportModalComponent_Conditional_25_For_5_Template_input_ngModelChange_3_listener($event) {
...
function RunReportModalComponent_Conditional_25_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(4, RunReportModalComponent_Conditional_25_For_5_Template, 4, 5, "div", 18, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
var RunReportModalComponent = class _RunReportModalComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RunReportModalComponent, selectors: [["app-run-report-modal"]], inputs: { report: [1, "report"] }, outputs: { execute: "execute", cancel: "cancel" }, decls: 32, vars: 6, consts: [[1, "modal-backdrop", 3, "click"], [1, "modal-dialog", 3, "click"], [1, "modal-header"], [1, "modal-title"], [1, "modal-close", 3, "click"], [1, "modal-body"], [1, "report-description"], [1, "report-meta"], [1, "meta-row"], [1, "meta-label"], [1, "meta-value", "badge-render"], [1, "meta-value", "mono"], [1, "params-section"], [1, "no-params"], [1, "modal-footer"], [1, "btn", "btn-secondary", 3, "click"], [1, "btn", "btn-primary", 3, "click"], [1, "params-grid"], [1, "param-row"], [1, "param-label", 3, "for"], [1, "param-input", 3, "ngModelChange", "id", "type", "ngModel"]], template: function RunReportModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(24);
      \u0275\u0275elementEnd()()();
      \u0275\u0275conditionalCreate(25, RunReportModalComponent_Conditional_25_Template, 6, 0, "div", 12)(26, RunReportModalComponent_Conditional_26_Template, 2, 0, "p", 13);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(27, "div", 14)(28, "button", 15);
      \u0275\u0275listener("click", function RunReportModalComponent_Template_button_click_28_listener() {
        return ctx.cancel.emit();
      });
      \u0275\u0275text(29, "Cancel");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(30, "button", 16);
      \u0275\u0275listener("click", function RunReportModalComponent_Template_button_click_30_listener() {
        return ctx.onExecute();
      });
      \u0275\u0275text(31, "Execute Report");
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(4);
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.paramKeys().length > 0 ? 25 : 26);
    }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RunReportModalComponent, { className: "RunReportModalComponent", filePath: "src/app/reports/components/run-report-modal.ts", lineNumber: 255 });
})();
