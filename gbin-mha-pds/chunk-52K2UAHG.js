...
var REQUEST_CONFIGS = [
  ...
  },
  {
    ...
    description: "Add a patient to the MHA PDS system by their Financial Number (FIN NBR). Use Test Mode (commit_mode=0) to validate without saving, or Commit Mode (commit_mode=1) to save to database.",
    category: "Operations",
    wrapperKey: "add_patient_params",
    exampleData: '{"add_patient_params":{"fin_nbr":"12345678","commit_mode":"0"}}',
    inputSchema: [
      {
        name: "fin_nbr",
        label: "FIN NBR",
        type: "text",
        required: true,
        placeholder: "Enter the Financial Number"
      },
      {
        name: "commit_mode",
        label: "Commit Mode",
