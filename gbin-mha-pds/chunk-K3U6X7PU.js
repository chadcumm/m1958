...
function OperationsComponent_Conditional_83_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("disabled", ctx_r0.dataManagerRunning());
  }
}
...
function OperationsComponent_Conditional_87_Conditional_32_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(3, _c0))("queryParams", \u0275\u0275pureFunction1(4, _c1, (tmp_3_0 = ctx_r0.dataManagerResult()) == null ? null : tmp_3_0.log_id));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" View Log Entry (ID: ", (tmp_4_0 = ctx_r0.dataManagerResult()) == null ? null : tmp_4_0.log_id, ") ");
  }
}
function OperationsComponent_Conditional_87_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    let tmp_13_0;
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275classProp("success", ((tmp_1_0 = ctx_r0.dataManagerResult()) == null ? null : tmp_1_0.status) === "SUCCESS")("error", ((tmp_2_0 = ctx_r0.dataManagerResult()) == null ? null : tmp_2_0.status) === "ERROR");
    \u0275\u0275advance(2);
    \u0275\u0275classProp("success", ((tmp_3_0 = ctx_r0.dataManagerResult()) == null ? null : tmp_3_0.status) === "SUCCESS")("error", ((tmp_4_0 = ctx_r0.dataManagerResult()) == null ? null : tmp_4_0.status) === "ERROR");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", (tmp_5_0 = ctx_r0.dataManagerResult()) == null ? null : tmp_5_0.status, " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate((tmp_6_0 = ctx_r0.dataManagerResult()) == null ? null : tmp_6_0.message);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("Duration: ", (tmp_7_0 = ctx_r0.dataManagerResult()) == null ? null : tmp_7_0.duration_seconds, "s");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("Mode: ", ((tmp_8_0 = ctx_r0.dataManagerResult()) == null ? null : tmp_8_0.commit_mode) === 0 ? "Test" : "Commit");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("Source: ", ((tmp_9_0 = ctx_r0.dataManagerResult()) == null ? null : tmp_9_0.data_mode) === 0 ? "Dummy" : "Database");
    \u0275\u0275advance(9);
    \u0275\u0275textInterpolate((tmp_10_0 = ctx_r0.dataManagerResult()) == null ? null : tmp_10_0.summary == null ? null : tmp_10_0.summary.episode_count);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((tmp_11_0 = ctx_r0.dataManagerResult()) == null ? null : tmp_11_0.summary == null ? null : tmp_11_0.summary.submission_count);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((tmp_12_0 = ctx_r0.dataManagerResult()) == null ? null : tmp_12_0.summary == null ? null : tmp_12_0.summary.error_count);
    \u0275\u0275advance();
    \u0275\u0275conditional(((tmp_13_0 = ctx_r0.dataManagerResult()) == null ? null : tmp_13_0.log_id) ? 32 : -1);
  }
}
...
var OperationsComponent = class _OperationsComponent {
  ...
  // 0=dummy, 1=database
  dummyCount = 5;
  dataManagerRunning = signal(false, ...ngDevMode ? [{ debugName: "dataManagerRunning" }] : []);
  dataManagerResult = signal(null, ...ngDevMode ? [{ debugName: "dataManagerResult" }] : []);
  openSystemOverview() {
  ...
  runDataManager() {
    this.dataManagerRunning.set(true);
    this.dataManagerResult.set(null);
    const requestData = JSON.stringify({
      run_data_manager_params: {
    ...
    this.cclService.load({
      ...
      try {
        const response = this.cclService.get("runDataManager");
        if (response) {
          const normalizedResult = {
            executed: response.executed ?? response.EXECUTED ?? 0,
            commit_mode: response.commit_mode ?? response.COMMIT_MODE ?? 0,
          ...
          this.dataManagerResult.set(normalizedResult);
        }
      } catch (err) {
        this.dataManagerResult.set({
          executed: 0,
          commit_mode: this.dataCommitMode,
          data_mode: this.dataMode,
          dummy_cnt: this.dummyCount,
      ...
      this.dataManagerRunning.set(false);
    });
  }
  lookupFIN() {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _OperationsComponent, selectors: [["app-operations"]], decls: 90, vars: 34, consts: [[1, "operations-container"], [1, "operations-header"], [1, "header-content"], [1, "subtitle"], [1, "system-overview-btn", 3, "click"], [1, "btn-icon"], [1, "run-manager-section"], [1, "description"], [1, "mode-selector"], [1, "mode-option"], ["type", "radio", "name", "commitMode", 3, "ngModelChange", "value", "ngModel", "disabled"], [1, "mode-label"], [1, "mode-desc"], [1, "run-button", 3, "click", "disabled"], [1, "add-patient-section"], [1, "search-row"], ["type", "text", "placeholder", "Enter FIN NBR...", 1, "fin-input", 3, "ngModelChange", "input", "keydown.enter", "ngModel", "disabled"], [1, "search-button", 3, "click", "disabled"], [1, "spinner"], [1, "add-patient-result", "error"], [1, "encounter-table-wrap"], [1, "add-patient-result", 3, "success", "error"], [1, "run-data-manager-section"], ["type", "radio", "name", "dataCommitMode", 3, "ngModelChange", "value", "ngModel", "disabled"], [1, "mode-selector", 2, "margin-top", "16px"], ["type", "radio", "name", "dataMode", 3, "ngModelChange", "value", "ngModel", "disabled"], [1, "dummy-count-row"], [1, "data-manager-result", 3, "success", "error"], [1, "results-section", 3, "success", "error"], [1, "result-status"], [1, "status-badge", "error"], [1, "result-message"], [1, "encounter-table"], [3, "selected"], [3, "click"], ["type", "radio", "name", "encounterSelect", 3, "click", "checked"], ["type", "radio", "name", "addPatientCommitMode", 3, "ngModelChange", "value", "ngModel", "disabled"], [1, "add-patient-result"], [1, "status-badge"], ["type", "number", "min", "1", "max", "50", 1, "dummy-count-input", 3, "ngModelChange", "ngModel", "disabled"], [1, "data-manager-result"], [1, "result-timing"], [1, "result-details"], [1, "detail-grid"], [1, "detail-item"], [1, "detail-label"], [1, "detail-value"], [1, "result-actions"], [1, "view-log-link", 3, "routerLink", "queryParams"], [1, "results-section"], [1, "result-summary"], [3, "closed", "viewLog"]], template: function OperationsComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(50, "Run Data Manager");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(51, "p", 7);
      \u0275\u0275text(52, " Execute the MHA PDS Data Manager to build JSON payloads from stored data and prepare for transmission to Ontario Health. ");
      \u0275\u0275elementEnd();
    ...
    if (rf & 2) {
      ...
      \u0275\u0275property("disabled", ctx.dataManagerRunning());
      \u0275\u0275advance(7);
      \u0275\u0275property("value", 1);
      \u0275\u0275twoWayProperty("ngModel", ctx.dataCommitMode);
      \u0275\u0275property("disabled", ctx.dataManagerRunning());
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(OperationsComponent, [{
    ...
    <div class="operations-container">
      ...
      <section class="run-data-manager-section">
        <h2>Run Data Manager</h2>
        <p class="description">
          Execute the MHA PDS Data Manager to build JSON payloads from stored data
        ...
        <button
          class="run-button"
          [disabled]="dataManagerRunning()"
          (click)="runDataManager()"
        >
          @if (dataManagerRunning()) {
            <span class="spinner"></span>
            Running...
          } @else {
            Run Data Manager
        ...
        @if (dataManagerResult()) {
          <div class="data-manager-result"
               [class.success]="dataManagerResult()?.status === 'SUCCESS'"
               [class.error]="dataManagerResult()?.status === 'ERROR'">
            <div class="result-status">
              <span class="status-badge"
                    [class.success]="dataManagerResult()?.status === 'SUCCESS'"
                    [class.error]="dataManagerResult()?.status === 'ERROR'">
                {{ dataManagerResult()?.status }}
              </span>
              <span class="result-message">{{ dataManagerResult()?.message }}</span>
            </div>

            <div class="result-timing">
              <span>Duration: {{ dataManagerResult()?.duration_seconds }}s</span>
              <span>Mode: {{ dataManagerResult()?.commit_mode === 0 ? 'Test' : 'Commit' }}</span>
              <span>Source: {{ dataManagerResult()?.data_mode === 0 ? 'Dummy' : 'Database' }}</span>
            </div>
            ...
            <div class="result-details">
              ...
              <div class="detail-grid">
                <div class="detail-item">
                  ...
                  <span class="detail-value">{{ dataManagerResult()?.summary?.episode_count }}</span>
                </div>
                <div class="detail-item">
                  <span class="detail-label">Submissions</span>
                  <span class="detail-value">{{ dataManagerResult()?.summary?.submission_count }}</span>
                </div>
                <div class="detail-item">
                  <span class="detail-label">Errors</span>
                  <span class="detail-value">{{ dataManagerResult()?.summary?.error_count }}</span>
                </div>
              </div>
            </div>

            @if (dataManagerResult()?.log_id) {
              <div class="result-actions">
                <a [routerLink]="['/logs']" [queryParams]="{logId: dataManagerResult()?.log_id}"
                   class="view-log-link">
                  View Log Entry (ID: {{ dataManagerResult()?.log_id }})
                </a>
              </div>
            }
          </div>
