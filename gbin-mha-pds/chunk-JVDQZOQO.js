...
var ConfigSectionMirth = class _ConfigSectionMirth {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConfigSectionMirth, selectors: [["app-config-section-mirth"]], inputs: { config: "config" }, outputs: { configChange: "configChange" }, decls: 44, vars: 8, consts: [[1, "section-content"], [1, "form-grid"], [1, "form-group", "full-width"], ["for", "mirthUrl"], ["type", "url", "id", "mirthUrl", "placeholder", "https://mirth-server.example.com:8443/api", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "help-text"], ["for", "mirthChannelId"], ["type", "text", "id", "mirthChannelId", "placeholder", "b397b5cb-c91c-47c2-af3a-438acfef6d8a", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "form-group"], ["for", "mirthUsername"], ["type", "text", "id", "mirthUsername", "placeholder", "API username", 1, "form-control", 3, "ngModelChange", "ngModel"], ["for", "mirthPassword"], [1, "password-field"], ["id", "mirthPassword", "placeholder", "API password", 1, "form-control", 3, "ngModelChange", "type", "ngModel"], ["type", "button", 1, "password-toggle", 3, "click"], ["for", "mirthTimeout"], ["type", "number", "id", "mirthTimeout", "min", "5", "max", "300", "step", "5", 1, "form-control", 3, "ngModelChange", "ngModel"], ["for", "mirthRetries"], ["type", "number", "id", "mirthRetries", "min", "0", "max", "10", "step", "1", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "test-connection-section"], ["type", "button", "disabled", "", "title", "Connection testing will be available in a future release", 1, "btn", "btn-outline"]], template: function ConfigSectionMirth_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(13, "UUID of the Mirth channel to trigger (find in Mirth Administrator \u2192 Channel Summary)");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(14, "div", 8)(15, "label", 9);
      \u0275\u0275text(16, "Username");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(17, "input", 10);
      \u0275\u0275listener("ngModelChange", function ConfigSectionMirth_Template_input_ngModelChange_17_listener($event) {
      ...
      \u0275\u0275text(20, "Password");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(21, "div", 12)(22, "input", 13);
      \u0275\u0275listener("ngModelChange", function ConfigSectionMirth_Template_input_ngModelChange_22_listener($event) {
        return ctx.onFieldChange("PASSWORD", $event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(23, "button", 14);
      \u0275\u0275listener("click", function ConfigSectionMirth_Template_button_click_23_listener() {
        return ctx.togglePasswordVisibility();
      });
      \u0275\u0275text(24);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(25, "small", 5);
      \u0275\u0275text(26, "Leave blank to keep existing password");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(27, "div", 8)(28, "label", 15);
      \u0275\u0275text(29, "Timeout (seconds)");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275text(32, "Connection timeout (5-300 seconds)");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(33, "div", 8)(34, "label", 17);
      \u0275\u0275text(35, "Retry Attempts");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(36, "input", 18);
      \u0275\u0275listener("ngModelChange", function ConfigSectionMirth_Template_input_ngModelChange_36_listener($event) {
        return ctx.onFieldChange("RETRY_ATTEMPTS", $event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(37, "small", 5);
      \u0275\u0275text(38, "Number of retries on connection failure (0-10)");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(39, "div", 19)(40, "button", 20);
      \u0275\u0275text(41, " Test Connection ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(42, "small", 5);
      \u0275\u0275text(43, "Connection testing not yet implemented");
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(5);
    ...
    <div class="section-content">
      <div class="form-grid">
        ...
        <div class="form-group full-width">
          ...
          <small class="help-text">UUID of the Mirth channel to trigger (find in Mirth Administrator \u2192 Channel Summary)</small>
        </div>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConfigSectionMirth, { className: "ConfigSectionMirth", filePath: "src/app/config-editor/sections/config-section-mirth.ts", lineNumber: 243 });
})();
...
function MappingEditorDrawer_Conditional_2_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(37, "Extension URL");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "input", 95);
    \u0275\u0275listener("ngModelChange", function MappingEditorDrawer_Conditional_2_Conditional_21_Template_input_ngModelChange_38_listener($event) {
      \u0275\u0275restoreView(_r23);
      const ctx_r1 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275text(40, "FHIR StructureDefinition URL for extensions (required for coded extension values)");
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    let tmp_2_0;
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ((tmp_8_0 = ctx_r1.editedMapping().VALUE_METADATA) == null ? null : tmp_8_0.EXTENSION_URL) || "");
  }
}
...
function MappingEditorDrawer_Conditional_2_Conditional_23_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, MappingEditorDrawer_Conditional_2_Conditional_23_For_2_Template, 2, 1, "div", 96, _forTrack13);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function MappingEditorDrawer_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(21, MappingEditorDrawer_Conditional_2_Conditional_21_Template, 41, 7, "div", 10);
    \u0275\u0275elementEnd();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MappingEditorDrawer, { className: "MappingEditorDrawer", filePath: "src/app/config-editor/sections/mapping-editor-drawer.ts", lineNumber: 1116 });
})();
