...
var MOCK_PATIENT_DETAIL_RESPONSE = {
  ...
  client: {
    ...
    de02_004_hcn_type: "OHIP",
    de02_005_issuing_authority: "Ontario",
    // DE03 - Client Address
      ...
      services: [
        {
          ...
          hsp_organization_name: "Grey Bruce Health Network",
...
var MOCK_AVAILABLE_LOCATIONS_RESPONSE = {
  ...
  LOCATIONS: [
    ...
    },
    {
      ...
      LOCATION_MEANING: "AMBULATORY",
      FACILITY_CD: 11449,
      FACILITY_NAME: "Hanover",
      BUILDING_CD: 12891,
      BUILDING_NAME: "Hanover Building",
      IS_MHA_CONFIGURED: 0
    },
    {
      ...
      LOCATION_MEANING: "AMBULATORY",
      FACILITY_CD: 11449,
      FACILITY_NAME: "Wiarton",
      BUILDING_CD: 12892,
      BUILDING_NAME: "Wiarton Building",
      IS_MHA_CONFIGURED: 0
    }
  ]
};
...
//# sourceMappingURL=chunk-IKEJJXH4.js.map
