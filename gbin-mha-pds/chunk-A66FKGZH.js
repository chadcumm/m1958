...
function extractMHAPDSEpisode(episode) {
  ...
  result.startDate = getStr(eoc, "DE06_003_FIRST_CONTACT_DATE");
  result.endDate = getStr(eoc, "DE06_010_SERVICE_TERMINATION_DATE");
  return result;
}
...
function extractMHAPDSServiceEvents(episode) {
  ...
  for (const svc of services) {
    ...
    events.push({
      ...
      functionalCentre: getCodedLabel(hse["DE10_003_SERVICE_MODALITY_TYPE"])
    });
  }
  return events;
}
function extractMHAPDSObservations(episode) {
  ...
  const obsFields = [
    { key: "DE04_005_PREFERRED_SERVICE_LANGUAGE", loincCode: "", display: "Preferred Service Language" },
    { key: "DE04_006_PREFERRED_OFFICIAL_LANGUAGE", loincCode: "", display: "Preferred Official Language" },
    { key: "DE04_007_GENDER_IDENTITY", loincCode: "76691-5", display: "Gender Identity" },
    { key: "DE04_008_SEXUAL_ORIENTATION", loincCode: "76690-7", display: "Sexual Orientation" },
    { key: "DE04_010_BORN_IN_CANADA", loincCode: "", display: "Born in Canada" },
    { key: "DE04_012_CITIZENSHIP_STATUS", loincCode: "92246-6", display: "Citizenship Status" },
    { key: "DE04_013_HIGHEST_EDUCATION", loincCode: "82589-3", display: "Highest Education" },
    { key: "DE04_014_EMPLOYMENT_STATUS", loincCode: "74165-2", display: "Employment Status" },
    { key: "DE04_015_INCOME_SOURCE", loincCode: "63513-6", display: "Income Source" },
    { key: "DE04_017_HOUSING_STATUS", loincCode: "71802-3", display: "Housing Status" },
    { key: "DE04_018_HOUSEHOLD_INCOME", loincCode: "77244-2", display: "Total Household Income" },
    { key: "DE04_020_LEGAL_STATUS", loincCode: "88696-0", display: "Legal Status" }
  ];
  for (const field of obsFields) {
    ...
    if (typeof val === "object") {
      const coded = val;
      value = coded.LABEL || coded.CODE || "";
      system = coded.CODE_SYSTEM || "";
    } else if (typeof val === "string") {
      value = val;
    }
    if (value) {
      observations.push({
        code: field.loincCode || field.key,
...
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_33_Conditional_1_Conditional_33_For_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275domElementStart(0, "div", 40);
    \u0275\u0275domListener("click", function ExtractionPayloadViewerComponent_Conditional_1_Conditional_33_Conditional_1_Conditional_33_For_4_Template_div_click_0_listener() {
    ...
    \u0275\u0275text(10);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(11, "div", 47)(12, "span");
    \u0275\u0275text(13);
    \u0275\u0275domElementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", ep_r9.fieldsCount, " fields");
    \u0275\u0275advance(3);
...
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_33_Conditional_1_Conditional_33_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "h4");
    \u0275\u0275text(1, "Episodes");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(2, "div", 38);
    \u0275\u0275repeaterCreate(3, ExtractionPayloadViewerComponent_Conditional_1_Conditional_33_Conditional_1_Conditional_33_For_4_Template, 16, 10, "div", 39, \u0275\u0275componentInstance().trackByEpisode, true);
    \u0275\u0275domElementEnd();
  }
  if (rf & 2) {
...
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_33_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(32);
    \u0275\u0275domElementEnd()()();
    \u0275\u0275conditionalCreate(33, ExtractionPayloadViewerComponent_Conditional_1_Conditional_33_Conditional_1_Conditional_33_Template, 5, 0);
  }
  if (rf & 2) {
    \u0275\u0275nextContext(2);
    const info_r3 = \u0275\u0275readContextLet(1);
    ...
    \u0275\u0275textInterpolate(info_r3.episodeCount);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r5.hasMultipleEpisodes() ? 33 : -1);
  }
}
...
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_33_For_6_Conditional_10_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const de_r11 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275repeater(de_r11.items);
  }
}
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_33_For_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275domElementStart(0, "div", 35)(1, "button", 48);
    \u0275\u0275domListener("click", function ExtractionPayloadViewerComponent_Conditional_1_Conditional_33_For_6_Template_button_click_1_listener() {
      const de_r11 = \u0275\u0275restoreView(_r10).$implicit;
      const ctx_r5 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r5.toggleDataElementExpand(de_r11.code));
    });
    ...
    \u0275\u0275text(5);
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(6, "span", 50);
    \u0275\u0275text(7);
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(8, "span", 33);
    \u0275\u0275text(9);
    \u0275\u0275domElementEnd()();
    \u0275\u0275conditionalCreate(10, ExtractionPayloadViewerComponent_Conditional_1_Conditional_33_For_6_Conditional_10_Template, 3, 0, "ul", 51);
    \u0275\u0275domElementEnd();
  }
  if (rf & 2) {
    const de_r11 = ctx.$implicit;
    const ctx_r5 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r5.isDataElementExpanded(de_r11.code) ? "\u25BC" : "\u25B6");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(de_r11.code);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(de_r11.name);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("(", de_r11.count, ")");
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r5.isDataElementExpanded(de_r11.code) ? 10 : -1);
  }
}
...
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_33_Conditional_7_For_4_Conditional_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const resource_r14 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275repeater(resource_r14.ids);
  }
}
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_33_Conditional_7_For_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275domListener("click", function ExtractionPayloadViewerComponent_Conditional_1_Conditional_33_Conditional_7_For_4_Template_button_click_1_listener() {
      const resource_r14 = \u0275\u0275restoreView(_r13).$implicit;
      const ctx_r5 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r5.toggleResourceExpand(resource_r14.type));
    });
    \u0275\u0275domElementStart(2, "span", 49);
    \u0275\u0275text(3);
    \u0275\u0275domElementEnd();
    ...
    \u0275\u0275text(7);
    \u0275\u0275domElementEnd()();
    \u0275\u0275conditionalCreate(8, ExtractionPayloadViewerComponent_Conditional_1_Conditional_33_Conditional_7_For_4_Conditional_8_Template, 3, 0, "ul", 56);
    \u0275\u0275domElementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r5 = \u0275\u0275nextContext(4);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r5.isResourceExpanded(resource_r14.type) ? "\u25BC" : "\u25B6");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(resource_r14.type);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("(", resource_r14.count, ")");
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r5.isResourceExpanded(resource_r14.type) ? 8 : -1);
  }
}
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_33_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(3, ExtractionPayloadViewerComponent_Conditional_1_Conditional_33_Conditional_7_For_4_Template, 9, 4, "div", 53, \u0275\u0275componentInstance().trackByResourceType, true);
    \u0275\u0275domElementEnd();
  }
  if (rf & 2) {
    const ctx_r5 = \u0275\u0275nextContext(3);
...
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_33_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, ExtractionPayloadViewerComponent_Conditional_1_Conditional_33_Conditional_1_Template, 34, 7);
...
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_34_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "div", 18)(1, "div", 58)(2, "h4");
    ...
    \u0275\u0275text(9);
    \u0275\u0275domElementEnd()()()();
    \u0275\u0275domElementStart(10, "div", 58)(11, "h4");
    \u0275\u0275text(12, "DE02 - Client Identifiers");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(13, "div", 36)(14, "div", 37)(15, "span", 23);
    \u0275\u0275text(16, "MRN");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(17, "span", 59);
    \u0275\u0275text(18);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(19, "div", 37)(20, "span", 23);
    \u0275\u0275text(21, "OHIP Number");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(22, "span", 59);
    \u0275\u0275text(23);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(24, "div", 37)(25, "span", 23);
    \u0275\u0275text(26, "Birth Date");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(27, "span", 24);
    \u0275\u0275text(28);
    \u0275\u0275domElementEnd()()()();
    \u0275\u0275domElementStart(29, "div", 58)(30, "h4");
    \u0275\u0275text(31, "DE03 - Client Address");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(32, "div", 36)(33, "div", 60)(34, "span", 23);
    \u0275\u0275text(35, "Address");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(36, "span", 24);
    \u0275\u0275text(37);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(38, "div", 37)(39, "span", 23);
    \u0275\u0275text(40, "Postal Code");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(41, "span", 59);
    \u0275\u0275text(42);
    \u0275\u0275domElementEnd()()()()();
  }
  if (rf & 2) {
...
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_35_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(53);
    \u0275\u0275domElementEnd()()()();
    \u0275\u0275domElementStart(54, "div", 58)(55, "h4");
    ...
    \u0275\u0275text(62);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(63, "div", 37)(64, "span", 23);
    \u0275\u0275text(65, "Organization ID");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(66, "span", 59);
    \u0275\u0275text(67);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(68, "div", 37)(69, "span", 23);
    \u0275\u0275text(70, "Location");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(71, "span", 24);
    \u0275\u0275text(72);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(73, "div", 37)(74, "span", 23);
    \u0275\u0275text(75, "Site Code");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(76, "span", 59);
    \u0275\u0275text(77);
    \u0275\u0275domElementEnd()()()();
    \u0275\u0275domElementStart(78, "div", 58)(79, "h4");
    \u0275\u0275text(80, "DE09 - Health Program");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(81, "div", 36)(82, "div", 37)(83, "span", 23);
    \u0275\u0275text(84, "Program Name");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(85, "span", 24);
    \u0275\u0275text(86);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(87, "div", 37)(88, "span", 23);
    \u0275\u0275text(89, "Program ID");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(90, "span", 59);
    \u0275\u0275text(91);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(92, "div", 37)(93, "span", 23);
    \u0275\u0275text(94, "Program Code");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(95, "span", 59);
    \u0275\u0275text(96);
    \u0275\u0275domElementEnd()()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((parsed_r2 == null ? null : parsed_r2.summary == null ? null : parsed_r2.summary.episodeInfo == null ? null : parsed_r2.summary.episodeInfo.startDate) || "N/A");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((parsed_r2 == null ? null : parsed_r2.summary == null ? null : parsed_r2.summary.episodeInfo == null ? null : parsed_r2.summary.episodeInfo.endDate) || "N/A");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((parsed_r2 == null ? null : parsed_r2.summary == null ? null : parsed_r2.summary.episodeInfo == null ? null : parsed_r2.summary.episodeInfo.type) || "N/A");
    \u0275\u0275advance(9);
...
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_36_Conditional_1_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "div", 64)(1, "div", 65)(2, "span", 66);
    \u0275\u0275text(3);
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(4, "span", 67);
    \u0275\u0275text(5);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(6, "div", 68)(7, "div", 69)(8, "span", 23);
    \u0275\u0275text(9, "Start");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(10, "span", 24);
    \u0275\u0275text(11);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(12, "div", 69)(13, "span", 23);
    \u0275\u0275text(14, "End");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(15, "span", 24);
    \u0275\u0275text(16);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(17, "div", 69)(18, "span", 23);
    \u0275\u0275text(19, "Service Type");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(20, "span", 24);
    \u0275\u0275text(21);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(22, "div", 69)(23, "span", 23);
    \u0275\u0275text(24, "Functional Centre");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(25, "span", 59);
    \u0275\u0275text(26);
    \u0275\u0275domElementEnd()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(event_r17.encounterId || "Unknown");
    \u0275\u0275advance();
    \u0275\u0275classMap("status-" + event_r17.status);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(event_r17.status);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(event_r17.startDate || "N/A");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(event_r17.endDate || "N/A");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(event_r17.serviceType || "N/A");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(event_r17.functionalCentre || "N/A");
  }
}
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_36_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, ExtractionPayloadViewerComponent_Conditional_1_Conditional_36_Conditional_1_For_2_Template, 27, 8, "div", 64, \u0275\u0275componentInstance().trackByServiceEvent, true);
    \u0275\u0275domElementEnd();
  }
  if (rf & 2) {
    const ctx_r5 = \u0275\u0275nextContext(3);
...
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_36_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "div", 63)(1, "span", 70);
    \u0275\u0275text(2, "\u25CB");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(3, "p");
...
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_36_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, ExtractionPayloadViewerComponent_Conditional_1_Conditional_36_Conditional_1_Template, 3, 0, "div", 62)(2, ExtractionPayloadViewerComponent_Conditional_1_Conditional_36_Conditional_2_Template, 5, 0, "div", 63);
    \u0275\u0275domElementEnd();
  }
  if (rf & 2) {
    const ctx_r5 = \u0275\u0275nextContext(2);
...
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_37_Conditional_1_For_2_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const obs_r18 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(obs_r18.system);
  }
}
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_37_Conditional_1_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "div", 72)(1, "div", 73)(2, "span", 74);
    \u0275\u0275text(3);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(4, "div", 75);
    \u0275\u0275text(5);
    \u0275\u0275domElementEnd();
    \u0275\u0275conditionalCreate(6, ExtractionPayloadViewerComponent_Conditional_1_Conditional_37_Conditional_1_For_2_Conditional_6_Template, 2, 1, "div", 76);
    \u0275\u0275domElementEnd();
  }
  if (rf & 2) {
    const obs_r18 = ctx.$implicit;
    const ctx_r5 = \u0275\u0275nextContext(4);
    \u0275\u0275advance(2);
    \u0275\u0275domProperty("title", obs_r18.code);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r5.getObservationName(obs_r18.code));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(obs_r18.value || "Not specified");
    \u0275\u0275advance();
    \u0275\u0275conditional(obs_r18.system ? 6 : -1);
  }
}
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_37_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "div", 71);
    \u0275\u0275repeaterCreate(1, ExtractionPayloadViewerComponent_Conditional_1_Conditional_37_Conditional_1_For_2_Template, 7, 4, "div", 72, \u0275\u0275componentInstance().trackByObservation, true);
    \u0275\u0275domElementEnd();
  }
  if (rf & 2) {
    const ctx_r5 = \u0275\u0275nextContext(3);
...
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_37_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, ExtractionPayloadViewerComponent_Conditional_1_Conditional_37_Conditional_1_Template, 3, 0, "div", 71)(2, ExtractionPayloadViewerComponent_Conditional_1_Conditional_37_Conditional_2_Template, 5, 0, "div", 63);
    \u0275\u0275domElementEnd();
  }
  if (rf & 2) {
    const ctx_r5 = \u0275\u0275nextContext(2);
...
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_38_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275domElementStart(0, "div", 21)(1, "div", 77)(2, "button", 78);
    ...
    \u0275\u0275text(3);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(4, "pre", 79)(5, "code");
    \u0275\u0275text(6);
    \u0275\u0275domElementEnd()()();
  }
  if (rf & 2) {
...
function ExtractionPayloadViewerComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(34, ExtractionPayloadViewerComponent_Conditional_1_Conditional_34_Template, 43, 6, "div", 18);
    \u0275\u0275conditionalCreate(35, ExtractionPayloadViewerComponent_Conditional_1_Conditional_35_Template, 97, 16, "div", 18);
  ...
  if (rf & 2) {
    ...
    const config_r20 = ctx_r5.statusConfig();
    \u0275\u0275advance();
    const info_r21 = \u0275\u0275storeLet(ctx_r5.submissionInfo());
    \u0275\u0275advance(3);
    \u0275\u0275classMap(config_r20.class);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(config_r20.icon);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(config_r20.label);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r5.isMHAPDS() ? 9 : 10);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r5.isMHAPDS() && info_r21 ? 11 : 12);
    \u0275\u0275advance(2);
...
var ExtractionPayloadViewerComponent = class _ExtractionPayloadViewerComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ExtractionPayloadViewerComponent, selectors: [["app-extraction-payload-viewer"]], outputs: { closed: "closed" }, decls: 3, vars: 2, consts: [[1, "loading-overlay"], [1, "extraction-viewer"], [1, "no-content"], [1, "loading-spinner"], [1, "extraction-header"], [1, "status-banner"], [1, "status-icon"], [1, "status-label"], [1, "resource-count"], [1, "header-grid"], [1, "episode-selector"], [1, "data-element-pills"], [1, "de-pill", 3, "title"], [1, "tabs"], [1, "tab", 3, "click"], [1, "count-badge"], [1, "tab-content"], [1, "summary-content"], [1, "detail-content"], [1, "services-content"], [1, "demographics-content"], [1, "json-content"], [1, "header-item"], [1, "label"], [1, "value"], [1, "value", "bundle-id"], [1, "episode-selector-label"], [1, "episode-pills"], [1, "episode-pill", 3, "active", "title"], [1, "episode-pill", 3, "click", "title"], [1, "ep-name"], [1, "ep-program"], [1, "de-code"], [1, "de-count"], [1, "de-list"], [1, "de-item"], [1, "detail-grid"], [1, "detail-item"], [1, "episodes-overview"], [1, "episode-overview-card", 3, "active"], [1, "episode-overview-card", 3, "click"], [1, "ep-card-header"], [1, "ep-card-id"], [1, "ep-card-fields"], [1, "ep-card-details"], [1, "ep-card-patient"], [1, "ep-card-program"], [1, "ep-card-meta"], [1, "de-toggle", 3, "click"], [1, "toggle-icon"], [1, "de-name"], [1, "de-items"], [1, "resource-list"], [1, "resource-item"], [1, "resource-toggle", 3, "click"], [1, "resource-type"], [1, "resource-ids"], [1, "parse-errors"], [1, "detail-section"], [1, "value", "mono"], [1, "detail-item", "full-width"], [1, "value", "status-badge"], [1, "service-events-list"], [1, "no-data"], [1, "service-event-card"], [1, "event-header"], [1, "event-id"], [1, "event-status"], [1, "event-details"], [1, "event-item"], [1, "empty-icon"], [1, "observations-list"], [1, "observation-card"], [1, "obs-header"], [1, "obs-code", 3, "title"], [1, "obs-value"], [1, "obs-system"], [1, "content-toolbar"], [1, "copy-btn", 3, "click"], [1, "json-pre"]], template: function ExtractionPayloadViewerComponent_Template(rf, ctx) {
    if (rf & 1) {
                ...
                @for (ep of episodes(); track trackByEpisode($index, ep)) {
                  <div
                    ...
                    <div class="ep-card-header">
                      ...
                      <span class="ep-card-fields">{{ ep.fieldsCount }} fields</span>
                    </div>
