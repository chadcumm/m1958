...
function isMhaPdsConfiguration(value) {
  ...
  return typeof config.UPDT_DT_TM === "string" && typeof config.MIRTH_CONNECT === "object" && typeof config.SUBMISSION === "object" && typeof config.PROCESSING === "object" && typeof config.CODE_TABLES_CNT === "number" && Array.isArray(config.CODE_TABLES) && typeof config.CODE_TABLE_MAPPING_CNT === "number" && Array.isArray(config.CODE_TABLE_MAPPINGS) && typeof config.MAPPING_CNT === "number" && Array.isArray(config.MAPPINGS) && typeof config.SUBMIT_FIELDS_CNT === "number" && Array.isArray(config.SUBMIT_FIELDS) && typeof config.FHIR_RESOURCE_CODES_CNT === "number" && Array.isArray(config.FHIR_RESOURCE_CODES) && hasValidMhaLocations && hasValidServiceEventTypes && hasValidTimeIntervalMappings;
}
