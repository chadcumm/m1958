...
function OperationsComponent_Conditional_44_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 19)(1, "div", 23)(2, "span", 24);
    \u0275\u0275text(3, "ERROR");
    \u0275\u0275elementEnd();
...
function OperationsComponent_Conditional_45_For_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(1, "td")(2, "input", 29);
...
function OperationsComponent_Conditional_45_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 20)(1, "table", 26)(2, "thead")(3, "tr");
    \u0275\u0275element(4, "th");
    \u0275\u0275elementStart(5, "th");
    \u0275\u0275text(6, "Alias Pool");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275repeaterCreate(18, OperationsComponent_Conditional_45_For_19_Template, 15, 9, "tr", 27, _forTrack0);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function OperationsComponent_Conditional_46_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 8)(1, "label", 9)(2, "input", 30);
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(8, "label", 9)(9, "input", 30);
...
function OperationsComponent_Conditional_47_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 31)(1, "div", 23)(2, "span", 32);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "span", 25);
    \u0275\u0275text(5);
...
function OperationsComponent_Conditional_48_Conditional_53_Template(rf, ctx) {
  if (rf & 1) {
...
function OperationsComponent_Conditional_48_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section", 33)(1, "h3");
    \u0275\u0275text(2, "Execution Results");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 34)(4, "div", 23)(5, "span", 32);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "span", 25);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "div", 35)(10, "span");
    \u0275\u0275text(11);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(22);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(23, "div", 38)(24, "span", 39);
    \u0275\u0275text(25, "New Clients");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "span", 40);
    \u0275\u0275text(27);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(28, "div", 38)(29, "span", 39);
    \u0275\u0275text(30, "Updated Clients");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "span", 40);
    \u0275\u0275text(32);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(33, "div", 38)(34, "span", 39);
    \u0275\u0275text(35, "Unchanged");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(36, "span", 40);
    \u0275\u0275text(37);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(38, "div", 38)(39, "span", 39);
    \u0275\u0275text(40, "Episodes Created");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(41, "span", 40);
    \u0275\u0275text(42);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(43, "div", 38)(44, "span", 39);
    \u0275\u0275text(45, "Services Created");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(46, "span", 40);
    \u0275\u0275text(47);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(48, "div", 38)(49, "span", 39);
    \u0275\u0275text(50, "Appointments");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(51, "span", 40);
    \u0275\u0275text(52);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275conditionalCreate(53, OperationsComponent_Conditional_48_Conditional_53_Template, 3, 6, "div", 41);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_1_0;
...
function OperationsComponent_Conditional_49_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-system-overview-panel", 43);
    \u0275\u0275listener("closed", function OperationsComponent_Conditional_49_Template_app_system_overview_panel_closed_0_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.closeSystemOverview());
    })("viewLog", function OperationsComponent_Conditional_49_Template_app_system_overview_panel_viewLog_0_listener($event) {
      \u0275\u0275restoreView(_r5);
      const ctx_r0 = \u0275\u0275nextContext();
...
var OperationsComponent = class _OperationsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _OperationsComponent, selectors: [["app-operations"]], decls: 50, vars: 18, consts: [[1, "operations-container"], [1, "operations-header"], [1, "header-content"], [1, "subtitle"], [1, "system-overview-btn", 3, "click"], [1, "btn-icon"], [1, "run-manager-section"], [1, "description"], [1, "mode-selector"], [1, "mode-option"], ["type", "radio", "name", "commitMode", 3, "ngModelChange", "value", "ngModel", "disabled"], [1, "mode-label"], [1, "mode-desc"], [1, "run-button", 3, "click", "disabled"], [1, "add-patient-section"], [1, "search-row"], ["type", "text", "placeholder", "Enter FIN NBR...", 1, "fin-input", 3, "ngModelChange", "input", "keydown.enter", "ngModel", "disabled"], [1, "search-button", 3, "click", "disabled"], [1, "spinner"], [1, "add-patient-result", "error"], [1, "encounter-table-wrap"], [1, "add-patient-result", 3, "success", "error"], [1, "results-section", 3, "success", "error"], [1, "result-status"], [1, "status-badge", "error"], [1, "result-message"], [1, "encounter-table"], [3, "selected"], [3, "click"], ["type", "radio", "name", "encounterSelect", 3, "click", "checked"], ["type", "radio", "name", "addPatientCommitMode", 3, "ngModelChange", "value", "ngModel", "disabled"], [1, "add-patient-result"], [1, "status-badge"], [1, "results-section"], [1, "result-summary"], [1, "result-timing"], [1, "result-details"], [1, "detail-grid"], [1, "detail-item"], [1, "detail-label"], [1, "detail-value"], [1, "result-actions"], [1, "view-log-link", 3, "routerLink", "queryParams"], [3, "closed", "viewLog"]], template: function OperationsComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(48, OperationsComponent_Conditional_48_Template, 54, 20, "section", 22);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(49, OperationsComponent_Conditional_49_Template, 1, 0, "app-system-overview-panel");
    }
    if (rf & 2) {
      \u0275\u0275advance(18);
      \u0275\u0275property("value", 0);
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.result() ? 48 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.showSystemOverview() ? 49 : -1);
    }
