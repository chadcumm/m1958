...
var AuditService = class _AuditService {
  ...
  normalizePatientAuditResponse(response) {
    ...
    return {
      ...
      bundles: bundles.map((b) => this.normalizeBundle(b))
    };
  }
  /**
...
function AuditBundleListComponent_Conditional_2_For_39_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr", 25)(1, "td", 26)(2, "div", 27);
    \u0275\u0275element(3, "app-audit-data-points", 28);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function AuditBundleListComponent_Conditional_2_For_39_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr", 19);
    \u0275\u0275listener("click", function AuditBundleListComponent_Conditional_2_For_39_Template_tr_click_0_listener() {
      const bundle_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.toggleBundle(bundle_r4.submission_batch_id));
    });
    \u0275\u0275elementStart(1, "td", 17)(2, "span", 20);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(17);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(18, AuditBundleListComponent_Conditional_2_For_39_Conditional_18_Template, 4, 2, "tr", 25);
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.isBundleExpanded(bundle_r4.submission_batch_id) ? 18 : -1);
  }
}
function AuditBundleListComponent_Conditional_2_ForEmpty_40_Template(rf, ctx) {
  if (rf & 1) {
...
function AuditBundleListComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(36, "Data Points");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(37, "tbody");
    \u0275\u0275repeaterCreate(38, AuditBundleListComponent_Conditional_2_For_39_Template, 19, 14, null, null, _forTrack03, false, AuditBundleListComponent_Conditional_2_ForEmpty_40_Template, 3, 0, "tr");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var AuditBundleListComponent = class _AuditBundleListComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AuditBundleListComponent, selectors: [["app-audit-bundle-list"]], inputs: { bundles: [1, "bundles"], loading: [1, "loading"] }, outputs: { filteredBundlesChange: "filteredBundlesChange" }, decls: 3, vars: 1, consts: [[1, "loading-state"], [1, "empty-state"], [1, "spinner"], [1, "summary-bar"], [1, "summary-counts"], [1, "total-count"], [1, "type-count"], [1, "summary-actions"], [1, "type-filter", 3, "ngModelChange", "ngModel"], ["value", "ALL"], ["value", "SERVICE_REQUEST_EOC"], ["value", "CLIENT_SDOH"], ["value", "HEALTH_SERVICES"], ["title", "Expand all", 1, "action-btn", 3, "click"], ["title", "Collapse all", 1, "action-btn", 3, "click"], [1, "table-wrapper"], [1, "bundle-table"], [1, "col-expand"], [1, "col-count"], [1, "bundle-row", 3, "click"], [1, "expand-icon"], [1, "type-badge"], [1, "col-id", 3, "title"], [1, "col-date"], [1, "status-badge"], [1, "expanded-row"], ["colspan", "7"], [1, "expanded-content"], [3, "dataPoints", "bundleType"], ["colspan", "7", 1, "no-matches"]], template: function AuditBundleListComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275conditionalCreate(0, AuditBundleListComponent_Conditional_0_Template, 3, 0, "div", 0)(1, AuditBundleListComponent_Conditional_1_Template, 2, 0, "div", 1)(2, AuditBundleListComponent_Conditional_2_Template, 41, 7);
    }
    if (rf & 2) {
...
(() => {
  ...
  `, styles: ['/* angular:styles/component:scss;717a8501d37be8951f322b9c66f2a744d852c4e10c010b1ce046c56d5a9b187e;/Users/chadcummings/Github/chadcumm/gbin-mha-pds/src/app/audit/components/audit-bundle-list.ts */\n.loading-state {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  gap: 0.5rem;\n  padding: 3rem;\n  color: #6c757d;\n  font-size: 0.875rem;\n}\n.spinner {\n  display: inline-block;\n  width: 20px;\n  height: 20px;\n  border: 2px solid #e9ecef;\n  border-top-color: #1a365d;\n  border-radius: 50%;\n  animation: spin 0.6s linear infinite;\n}\n@keyframes spin {\n  to {\n    transform: rotate(360deg);\n  }\n}\n.empty-state {\n  text-align: center;\n  color: #6c757d;\n  font-size: 0.9375rem;\n  font-style: italic;\n  padding: 3rem;\n}\n.summary-bar {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  flex-wrap: wrap;\n  gap: 0.75rem;\n  padding: 0.75rem 0;\n  margin-bottom: 0.5rem;\n  border-bottom: 1px solid #e9ecef;\n}\n.summary-counts {\n  display: flex;\n  align-items: center;\n  gap: 0.75rem;\n}\n.summary-counts .total-count {\n  font-weight: 600;\n  color: #1a365d;\n  font-size: 0.875rem;\n}\n.summary-counts .type-count {\n  font-size: 0.8125rem;\n  color: #6c757d;\n}\n.summary-actions {\n  display: flex;\n  align-items: center;\n  gap: 0.5rem;\n}\n.type-filter {\n  padding: 0.375rem 0.5rem;\n  border: 1px solid #ced4da;\n  border-radius: 4px;\n  font-size: 0.8125rem;\n  color: #495057;\n  background: white;\n  cursor: pointer;\n}\n.type-filter:focus {\n  outline: none;\n  border-color: #1a365d;\n  box-shadow: 0 0 0 2px rgba(26, 54, 93, 0.15);\n}\n.action-btn {\n  padding: 0.375rem 0.625rem;\n  border: 1px solid #ced4da;\n  border-radius: 4px;\n  background: white;\n  font-size: 0.75rem;\n  color: #495057;\n  cursor: pointer;\n  transition: background-color 0.15s;\n}\n.action-btn:hover {\n  background: #e9ecef;\n}\n.table-wrapper {\n  overflow-x: auto;\n}\n.bundle-table {\n  width: 100%;\n  border-collapse: collapse;\n  font-size: 0.8125rem;\n}\n.bundle-table th,\n.bundle-table td {\n  padding: 0.5rem 0.625rem;\n  text-align: left;\n  border-bottom: 1px solid #dee2e6;\n}\n.bundle-table th {\n  background: #f8f9fa;\n  font-weight: 600;\n  color: #495057;\n  white-space: nowrap;\n  font-size: 0.75rem;\n  text-transform: uppercase;\n  letter-spacing: 0.3px;\n}\n.col-expand {\n  width: 32px;\n  text-align: center;\n  padding-left: 0.5rem;\n  padding-right: 0;\n}\n.col-count {\n  text-align: center;\n  width: 80px;\n}\n.bundle-row {\n  cursor: pointer;\n  transition: background-color 0.15s;\n}\n.bundle-row:hover {\n  background: #f1f3f4;\n}\n.bundle-row:nth-child(4n+1) {\n  background: #fafbfc;\n}\n.bundle-row:nth-child(4n+1):hover {\n  background: #f1f3f4;\n}\n.expand-icon {\n  color: #6c757d;\n  font-size: 0.6875rem;\n}\n.type-badge {\n  display: inline-block;\n  padding: 2px 8px;\n  border-radius: 4px;\n  font-size: 0.6875rem;\n  font-weight: 500;\n  white-space: nowrap;\n}\n.type-badge.badge-eoc {\n  background: #dbeafe;\n  color: #1e40af;\n}\n.type-badge.badge-sdoh {\n  background: #dcfce7;\n  color: #166534;\n}\n.type-badge.badge-hse {\n  background: #ffedd5;\n  color: #9a3412;\n}\n.status-badge {\n  display: inline-block;\n  padding: 2px 8px;\n  border-radius: 4px;\n  font-size: 0.6875rem;\n  font-weight: 500;\n  text-transform: uppercase;\n}\n.status-badge.status-accepted {\n  background: #d4edda;\n  color: #155724;\n}\n.status-badge.status-submitted {\n  background: #dbeafe;\n  color: #1e40af;\n}\n.status-badge.status-error {\n  background: #f8d7da;\n  color: #721c24;\n}\n.col-id {\n  font-family:\n    "SFMono-Regular",\n    Consolas,\n    "Liberation Mono",\n    Menlo,\n    monospace;\n  font-size: 0.75rem;\n  color: #495057;\n  cursor: default;\n}\n.col-date {\n  white-space: nowrap;\n  color: #6c757d;\n  font-size: 0.8125rem;\n}\n.expanded-row td {\n  padding: 0;\n  background: #f8f9fa;\n  border-bottom: 2px solid #dee2e6;\n}\n.expanded-content {\n  padding: 8px 12px 12px 40px;\n}\n.no-matches {\n  text-align: center;\n  color: #6c757d;\n  font-style: italic;\n  padding: 2rem !important;\n}\n@media (max-width: 768px) {\n  .summary-bar {\n    flex-direction: column;\n    align-items: flex-start;\n  }\n  .summary-actions {\n    flex-wrap: wrap;\n  }\n}\n'] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AuditBundleListComponent, { className: "AuditBundleListComponent", filePath: "src/app/audit/components/audit-bundle-list.ts", lineNumber: 372 });
})();
