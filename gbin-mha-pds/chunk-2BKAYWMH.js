...
var MOCK_PATIENT_DETAIL_RESPONSE = {
  ...
  client: {
    ...
    // DE04 - SDOH fields
    de04_001_sdoh_effective_date: "10-Jan-2025",
    de04_002_ethnicity: "White",
    de04_003_religion: "Christian",
    de04_004_first_language: "English",
    de04_005_service_language: "English",
    de04_006_official_language: "English",
    de04_007_gender_identity: "Male",
    de04_008_sexual_orientation: "Heterosexual",
    de04_009_year_arrived_canada: "",
    de04_010_born_in_canada: "Yes",
    ...
    submission_batch_id: "BATCH-CLIENT-2025-0110",
    submission_response_id: "620450"
  },
  episodes: [
    {
      episode_id: 55501,
...
var MOCK_LOOKUP_FIN_MULTI = {
  STATUS: "SUCCESS",
  MESSAGE: "3 encounter(s) found for FIN: 8073250",
  FIN_NBR: "8073250",
  MATCH_CNT: 3,
  MATCHES: [
    {
      ENCNTR_ID: 54022731,
      PERSON_ID: 1173072,
      PERSON_NAME: "TESTPATIENT, MHAPDS",
      ALIAS_POOL: "GBHS-OS Account Number",
      ALIAS_POOL_CD: 2090492788,
      ENCNTR_TYPE: "Inpatient",
      REG_DT_TM: "04-FEB-2026",
      DISCH_DT_TM: "",
      LOC_FACILITY: "Owen Sound",
      LOC_NURSE_UNIT: "MH Unit 3S",
      ENCNTR_STATUS: "Active",
      FIN_NBR: "8073250"
    },
    {
      ENCNTR_ID: 7516342,
      PERSON_ID: 1173072,
      PERSON_NAME: "TESTPATIENT, MHAPDS",
      ALIAS_POOL: "SBGHC-KI Account Number",
      ALIAS_POOL_CD: 12441316,
      ENCNTR_TYPE: "Outpatient",
      REG_DT_TM: "14-NOV-2005",
      DISCH_DT_TM: "14-NOV-2005",
      LOC_FACILITY: "Kincardine",
      LOC_NURSE_UNIT: "",
      ENCNTR_STATUS: "Discharged",
      FIN_NBR: "8073250"
    },
    {
      ENCNTR_ID: 3134115,
      PERSON_ID: 1173072,
      PERSON_NAME: "TESTPATIENT, MHAPDS",
      ALIAS_POOL: "GBHS-MA Account Number",
      ALIAS_POOL_CD: 1686531,
      ENCNTR_TYPE: "Outpatient",
      REG_DT_TM: "15-JUL-2001",
      DISCH_DT_TM: "15-JUL-2001",
      LOC_FACILITY: "Meaford",
      LOC_NURSE_UNIT: "",
      ENCNTR_STATUS: "Discharged",
      FIN_NBR: "8073250"
    }
...
var MOCK_LOOKUP_FIN_NONE = {
  STATUS: "NO_MATCHES",
  MESSAGE: "No encounters found for FIN: 99999999",
  FIN_NBR: "99999999",
  MATCH_CNT: 0,
  MATCHES: []
};

// src/app/mocks/examples/audit.mock.ts
function buildMockPayload(opts) {
  const responseData = opts.responseBundleId ? JSON.stringify({ resourceType: "Bundle", id: opts.responseBundleId, type: "transaction-response" }) : "";
  return JSON.stringify({
    MIRTH_REQUEST: {
      requestType: "logSubmission",
      timestamp: "2026-02-15T10:30:00-05:00",
      mirthChannelId: "503b37e9-1234-5678-abcd-ef1234567890",
      mirthChannelName: "03 - Ontario Health Submission",
      mirthChannelMessageId: opts.messageId,
      submittedData: JSON.stringify(opts.submittedData),
      responseData,
      responseStatusCode: opts.statusCode,
      responseStatusLine: opts.statusLine
    }
  });
}
var MOCK_SUBMITTED_EOC = {
  CNT: 1,
  QUAL: [{
    EPISODE_IDENTIFIER: "EP-2026-00123",
    CLIENT: {
      DE01_001_FIRST_NAME: "John",
      DE01_003_LAST_NAME: "Smith",
      DE01_004_DATE_OF_BIRTH: "1985-03-15"
    ...
    REFERRAL: {
      DE05_001_REFERRAL_ID: {
        CODE: "REF-2026-00456",
        LABEL: "",
        CODE_SYSTEM: ""
      },
      DE05_002_REFERRAL_RECEIVED_DATE: "2026-01-10",
      DE05_004_REFERRAL_SOURCE_TYPE: {
        CODE: "community-agency",
        LABEL: "Community Agency",
        CODE_VALUE_SOURCE: "MHA PDS v1.2 CT-020",
        CODE_SYSTEM: "http://ehealthontario.ca/fhir/ValueSet/mha-pds-referral-source-type",
        EXTENSION_URL: "http://ehealthontario.ca/fhir/StructureDefinition/ca-on-mha-ext-referral-source-type"
      },
      DE05_005_REFERRAL_TYPE: {
        CODE: "new-referral",
        LABEL: "New Referral",
        CODE_VALUE_SOURCE: "MHA PDS v1.2 CT-021",
        CODE_SYSTEM: "http://ehealthontario.ca/fhir/ValueSet/mha-pds-referral-type"
      }
    },
    EPISODE_OF_CARE: {
      DE06_001_EPISODE_OF_CARE_ID: {
        CODE: "EP-2026-00123",
        LABEL: "",
        CODE_SYSTEM: ""
      },
      DE06_002_EPISODE_OF_CARE_STATUS: {
        CODE: "active",
        LABEL: "Active",
        CODE_SYSTEM: "http://hl7.org/fhir/episode-of-care-status"
      }
    },
    HEALTH_PROGRAM: {
      DE09_001_PROGRAM_NUMBER: {
        CODE: "1.7254077811",
        LABEL: "",
        CODE_SYSTEM: "http://ontariohealth.ca/fhir/NamingSystem/id-HealthcareService-GBRH"
      },
      DE09_003_FUNCTIONAL_CENTRE: {
        CODE: "ATS",
        LABEL: "Adult Treatment Services",
        CODE_VALUE_SOURCE: "MHA PDS v1.2 CT-005",
        CODE_SYSTEM: "http://ehealthontario.ca/fhir/ValueSet/mha-pds-functional-centre",
        EXTENSION_URL: "http://ehealthontario.ca/fhir/StructureDefinition/ca-on-mha-ext-functional-centre-code"
      }
    }
  }]
};
var MOCK_SUBMITTED_SDOH = {
  CNT: 1,
  QUAL: [{
    EPISODE_IDENTIFIER: "EP-2026-00123",
    CLIENT: {
      DE01_004_DATE_OF_BIRTH: "1985-03-15",
      DE02_001_CLIENT_IDENTIFIER_MRN: "MRN001234",
      ADDRESS: {
        DE03_002_CITY: "Owen Sound"
      },
      SOCIO_DEMOGRAPHICS: {
        DE04_007_GENDER_IDENTITY: {
          ...
          LABEL: "Identifies as male gender",
          CODE_SYSTEM: "http://snomed.info/sct",
          OBSERVATION_CODE: {
            CODE: "76691-5",
            LABEL: "Gender identity",
...
var MOCK_SUBMITTED_HSE = {
  CNT: 1,
  QUAL: [{
    EPISODE_IDENTIFIER: "EP-2026-00123",
    SERVICES: [{
      HSP_ORGANIZATION: {
        DE07_001_ORGANIZATION_NUMBER: {
          CODE: "51958",
          LABEL: "",
          CODE_SYSTEM: "http://ehealthontario.ca/fhir/NamingSystem/id-Organization-ConnexOrg"
        }
      },
      HSP_SITE: {
        DE08_001_SITE_NUMBER: {
          CODE: "5803",
          LABEL: "",
          CODE_SYSTEM: "http://ehealthontario.ca/fhir/NamingSystem/id-Location-ConnexSite"
        }
      },
      HEALTH_SERVICE_EVENT: {
        DE10_001_EVENT_ID: {
          CODE: "SE-2026-00789",
          LABEL: "",
          CODE_SYSTEM: ""
        },
        DE10_002_SERVICE_MODALITY: {
          CODE: "individual-face-to-face",
          LABEL: "Individual Face to Face",
          CODE_VALUE_SOURCE: "MHA PDS v1.2 CT-027",
          CODE_SYSTEM: "http://ehealthontario.ca/fhir/ValueSet/mha-pds-service-modality"
        },
        DE10_004_ENCOUNTER_DATE: "2026-02-12"
      }
    }]
  }]
};
var MOCK_AUDITABLE_PATIENTS_RESPONSE = {
  status: "S",
  patient_count: 4,
  patients: [
    {
...
var MOCK_PATIENT_AUDIT_BUNDLES_RESPONSE = {
  status: "S",
  person_id: 98765001,
  display_name: "Smith, John",
  mrn: "MRN001234",
  ...
  bundles: [
    {
      submission_batch_id: "a1b2c3d4-e5f6-7890-abcd-ef1234567890",
      submission_response_id: "resp-001-abc",
      bundle_type: "SERVICE_REQUEST_EOC",
      submission_status: "ACCEPTED",
      submission_dt_tm: "2026-02-15 10:30:00",
      submission_dt_tm_fmt: "15-FEB-2026 10:30:00",
      record_source: "EPISODE",
      source_id: 100001,
      episode_identifier: "EP-2026-00123",
      data_point_cnt: 6,
      data_points: [
        {
          field_code: "DE05.001",
          field_label: "Referral ID",
          value_sent: "REF-2026-00456",
          mapped_code: "",
          mapped_label: "",
          code_system: ""
        },
        {
          field_code: "DE05.002",
          field_label: "Referral Received Date",
          value_sent: "10-JAN-2026",
          mapped_code: "",
          mapped_label: "",
          code_system: ""
        },
        {
          field_code: "DE05.004",
          field_label: "Referral Source Type",
          value_sent: "",
          mapped_code: "",
          mapped_label: "",
          code_system: ""
        ...
        {
          field_code: "DE09.001",
          field_label: "Program Number",
          value_sent: "1.7254077811",
          mapped_code: "",
          mapped_label: "",
          code_system: ""
        },
      ...
      json_payload: buildMockPayload({
        statusCode: 201,
        statusLine: "HTTP/1.1 201 Created",
        messageId: 17681,
        submittedData: MOCK_SUBMITTED_EOC,
        responseBundleId: "resp-bundle-eoc-001"
      })
    },
    {
      submission_batch_id: "b2c3d4e5-f6a7-8901-bcde-f12345678901",
      submission_response_id: "resp-002-def",
      bundle_type: "CLIENT_SDOH",
      submission_status: "ACCEPTED",
      submission_dt_tm: "2026-02-15 10:30:05",
      submission_dt_tm_fmt: "15-FEB-2026 10:30:05",
      record_source: "CLIENT",
      source_id: 200001,
      episode_identifier: "EP-2026-00123",
      data_point_cnt: 5,
      data_points: [
        ...
        {
          field_code: "DE02.001",
          field_label: "Client Identifier (MRN)",
          value_sent: "MRN001234",
          mapped_code: "",
          mapped_label: "",
          code_system: ""
        },
      ...
      json_payload: buildMockPayload({
        ...
        statusLine: "HTTP/1.1 201 Created",
        messageId: 17682,
        submittedData: MOCK_SUBMITTED_SDOH,
        responseBundleId: "resp-bundle-sdoh-001"
      })
    },
    {
      submission_batch_id: "c3d4e5f6-a7b8-9012-cdef-123456789012",
      submission_response_id: "resp-003-ghi",
      bundle_type: "HEALTH_SERVICES",
      submission_status: "ACCEPTED",
      submission_dt_tm: "2026-02-15 10:30:10",
      submission_dt_tm_fmt: "15-FEB-2026 10:30:10",
      ...
      data_points: [
        {
          field_code: "DE07.001",
          field_label: "HSP Organization Number",
          value_sent: "51958",
          mapped_code: "",
          mapped_label: "",
          code_system: ""
        ...
        {
          field_code: "DE10.001",
          field_label: "Service Event ID",
          value_sent: "SE-2026-00789",
          mapped_code: "",
          mapped_label: "",
          code_system: ""
        },
        ...
        {
          field_code: "DE10.004",
          field_label: "Service Event Date",
          value_sent: "12-FEB-2026",
          mapped_code: "",
          mapped_label: "",
          code_system: ""
        }
      ...
      json_payload: buildMockPayload({
        ...
        statusLine: "HTTP/1.1 201 Created",
        messageId: 17683,
        submittedData: MOCK_SUBMITTED_HSE,
        responseBundleId: "resp-bundle-hse-001"
      })
    },
    {
      submission_batch_id: "d4e5f6a7-b8c9-0123-defa-234567890123",
      submission_response_id: "",
      bundle_type: "HEALTH_SERVICES",
      submission_status: "SUBMITTED",
      submission_dt_tm: "2026-02-18 14:15:00",
      submission_dt_tm_fmt: "18-FEB-2026 14:15:00",
      record_source: "SERVICE",
      source_id: 300002,
      episode_identifier: "EP-2026-00123",
      data_point_cnt: 5,
      data_points: [
        ...
        },
        {
          ...
          field_label: "Service Modality",
          value_sent: "",
          mapped_code: "group-face-to-face",
          mapped_label: "Group Face to Face",
          code_system: ""
        },
        {
          field_code: "DE10.005",
          field_label: "Direct Service Minutes",
          value_sent: "60",
          mapped_code: "",
          mapped_label: "",
          code_system: ""
...
var MOCK_REGISTRY = {
  ...
  "lookupFIN": MOCK_LOOKUP_FIN_MULTI,
  "getAuditablePatients": MOCK_AUDITABLE_PATIENTS_RESPONSE,
  "getPatientAuditBundles": MOCK_PATIENT_AUDIT_BUNDLES_RESPONSE,
  ...
  // lookupFIN variants
  "lookupFIN-no-matches": MOCK_LOOKUP_FIN_NONE,
  ...
  "gbin_mha_pds_service-lookupFIN": MOCK_LOOKUP_FIN_MULTI,
  "gbin_mha_pds_service-getAuditablePatients": MOCK_AUDITABLE_PATIENTS_RESPONSE,
  "gbin_mha_pds_service-getPatientAuditBundles": MOCK_PATIENT_AUDIT_BUNDLES_RESPONSE,
