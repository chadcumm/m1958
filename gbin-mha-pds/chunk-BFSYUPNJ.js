...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConfigEditorComponent, { className: "ConfigEditorComponent", filePath: "src/app/config-editor/config-editor.ts", lineNumber: 97 });
})();
export {
