          ...
          if (patient && patient.episodes) {
            ...
            patient.episodes.forEach((episode) => {
              ...
              if (episode.appointments && (recordType === "ALL" || recordType === "APPOINTMENT")) {
                ...
                episode.appointments.forEach((appointment) => {
                  if (!appointmentIds || appointmentIds.includes(String(appointment.appointment_id))) {
                    appointment.submission_status = "PENDING";
                  }
                });
              }
            });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EpisodeListClassicComponent, { className: "EpisodeListClassicComponent", filePath: "src/app/patients/components/episode-list-classic.ts", lineNumber: 21 });
})();
