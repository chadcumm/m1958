...
function parseExtractionPayload(jsonText) {
  const parseErrors = [];
  if (!jsonText || jsonText.trim().length === 0) {
    return null;
  }
  ...
  const status = determinePayloadStatus(raw);
  const statusConfig = EXTRACTION_STATUS_CONFIG[status];
  const summary = buildExtractionSummary(raw, parseErrors);
  return {
    raw,
    status,
    statusLabel: statusConfig.label,
...
function determinePayloadStatus(bundle) {
  ...
  if (hasPatient && hasEpisode) {
    return "COMPLETE";
  } else if (hasPatient || hasEpisode) {
    return "PARTIAL";
  }
  return "PARTIAL";
}
function buildExtractionSummary(bundle, parseErrors) {
  const patientInfo = extractPatientInfo2(bundle);
  const episodeInfo = extractEpisodeInfo(bundle);
  const referralInfo = extractReferralInfo(bundle);
  const providerInfo = extractProviderInfo(bundle);
  const programInfo = extractProgramInfo(bundle);
  const serviceEvents = extractServiceEvents(bundle);
  const observations = extractObservations(bundle);
  const dataElements = buildDataElementSummary(bundle);
  return {
    patientInfo,
    episodeInfo,
    referralInfo,
...
function extractPatientInfo2(bundle) {
  const result = {
    name: "",
    mrn: "",
    ohip: "",
  ...
  if (ohipIdentifier?.value) {
    result.ohip = ohipIdentifier.value;
  }
...
function extractEpisodeInfo(bundle) {
  const result = {
    episodeId: "",
    status: "",
    startDate: "",
  ...
  if (episode.period) {
    result.startDate = formatDate(episode.period.start);
    result.endDate = formatDate(episode.period.end);
  }
  result.type = episode.type?.[0]?.coding?.[0]?.display || "";
  return result;
}
function extractReferralInfo(bundle) {
  const result = {
    referralId: "",
    referralDate: "",
    referralSource: "",
  ...
  if (!bundle?.entry) return result;
  const serviceRequestEntry = bundle.entry.find(
...
function extractProviderInfo(bundle) {
  const result = {
    organizationName: "",
    organizationId: "",
    locationName: "",
...
function extractProgramInfo(bundle) {
  const result = {
    programId: "",
    programName: "",
    programCode: ""
...
function extractServiceEvents(bundle) {
  const events = [];
  ...
  for (const entry of encounterEntries) {
    ...
    events.push({
      ...
      functionalCentre: enc.serviceType?.coding?.[0]?.code || ""
    });
  }
  return events;
}
...
function buildDataElementSummary(bundle) {
  const summaries = [];
  if (!bundle?.entry) return summaries;
  const resourceCounts = /* @__PURE__ */ new Map();
  for (const entry of bundle.entry) {
    const type = entry.resource?.resourceType || "Unknown";
    if (!resourceCounts.has(type)) {
      resourceCounts.set(type, { count: 0, items: [] });
    }
    const data = resourceCounts.get(type);
    data.count++;
    const desc = extractResourceDescription2(entry);
    if (desc) {
      data.items.push(desc);
    }
  }
...
function extractResourceDescription2(entry) {
  ...
  switch (type) {
    ...
    case "ServiceRequest": {
      const refId = resource.identifier?.[0]?.value;
      return refId ? `Referral: ${refId}` : "";
    }
    case "EpisodeOfCare": {
      const epId = resource.identifier?.find(
        (id) => id.system?.includes("episode-of-care") || id.system?.includes("EpisodeOfCare")
...
function getResourceTypeSummary2(bundle) {
  ...
  for (const entry of bundle.entry) {
    const type = entry.resource?.resourceType || "Unknown";
    const description = extractResourceDescription2(entry);
    if (!typeMap.has(type)) {
      typeMap.set(type, { count: 0, ids: [] });
    }
    const data = typeMap.get(type);
...
function ExtractionPayloadViewerComponent_Conditional_1_For_33_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "span", 15)(1, "span", 25);
    \u0275\u0275text(2);
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(3, "span", 26);
    \u0275\u0275text(4);
    \u0275\u0275domElementEnd()();
  }
  if (rf & 2) {
    const de_r2 = ctx.$implicit;
    \u0275\u0275domProperty("title", de_r2.description);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(de_r2.code);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(de_r2.count);
  }
}
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_43_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "span", 18);
    \u0275\u0275text(1);
    \u0275\u0275domElementEnd();
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r2.serviceEventCount());
  }
}
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_46_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "span", 18);
    \u0275\u0275text(1);
    \u0275\u0275domElementEnd();
  ...
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r2.observationCount());
  }
}
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_50_For_5_Conditional_10_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "li");
    \u0275\u0275text(1);
    \u0275\u0275domElementEnd();
...
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_50_For_5_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "ul", 34);
    \u0275\u0275repeaterCreate(1, ExtractionPayloadViewerComponent_Conditional_1_Conditional_50_For_5_Conditional_10_For_2_Template, 2, 1, "li", null, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275domElementEnd();
  }
  if (rf & 2) {
    const de_r5 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275repeater(de_r5.items);
  }
}
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_50_For_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275domElementStart(0, "div", 28)(1, "button", 31);
    \u0275\u0275domListener("click", function ExtractionPayloadViewerComponent_Conditional_1_Conditional_50_For_5_Template_button_click_1_listener() {
      const de_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.toggleDataElementExpand(de_r5.code));
    });
    ...
    \u0275\u0275text(5);
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(6, "span", 33);
    \u0275\u0275text(7);
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(8, "span", 26);
    \u0275\u0275text(9);
    \u0275\u0275domElementEnd()();
    \u0275\u0275conditionalCreate(10, ExtractionPayloadViewerComponent_Conditional_1_Conditional_50_For_5_Conditional_10_Template, 3, 0, "ul", 34);
    \u0275\u0275domElementEnd();
  }
  if (rf & 2) {
    const de_r5 = ctx.$implicit;
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r2.isDataElementExpanded(de_r5.code) ? "\u25BC" : "\u25B6");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(de_r5.code);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(de_r5.name);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("(", de_r5.count, ")");
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.isDataElementExpanded(de_r5.code) ? 10 : -1);
  }
}
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_50_For_10_Conditional_8_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "li");
    \u0275\u0275text(1);
    \u0275\u0275domElementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(id_r9);
  }
}
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_50_For_10_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "ul", 37);
    \u0275\u0275repeaterCreate(1, ExtractionPayloadViewerComponent_Conditional_1_Conditional_50_For_10_Conditional_8_For_2_Template, 2, 1, "li", null, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275domElementEnd();
  }
  if (rf & 2) {
    const resource_r8 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275repeater(resource_r8.ids);
  }
}
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_50_For_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275domElementStart(0, "div", 30)(1, "button", 35);
    \u0275\u0275domListener("click", function ExtractionPayloadViewerComponent_Conditional_1_Conditional_50_For_10_Template_button_click_1_listener() {
      const resource_r8 = \u0275\u0275restoreView(_r7).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r2.toggleResourceExpand(resource_r8.type));
    });
    \u0275\u0275domElementStart(2, "span", 32);
    \u0275\u0275text(3);
    \u0275\u0275domElementEnd();
    ...
    \u0275\u0275text(7);
    \u0275\u0275domElementEnd()();
    \u0275\u0275conditionalCreate(8, ExtractionPayloadViewerComponent_Conditional_1_Conditional_50_For_10_Conditional_8_Template, 3, 0, "ul", 37);
    \u0275\u0275domElementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r2.isResourceExpanded(resource_r8.type) ? "\u25BC" : "\u25B6");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(resource_r8.type);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("(", resource_r8.count, ")");
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.isResourceExpanded(resource_r8.type) ? 8 : -1);
  }
}
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_50_Conditional_11_For_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "li");
    \u0275\u0275text(1);
    \u0275\u0275domElementEnd();
...
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_50_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "h4");
    \u0275\u0275text(1, "Parse Warnings");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(2, "ul", 38);
    \u0275\u0275repeaterCreate(3, ExtractionPayloadViewerComponent_Conditional_1_Conditional_50_Conditional_11_For_4_Template, 2, 1, "li", null, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275domElementEnd();
  }
  if (rf & 2) {
    \u0275\u0275nextContext(2);
    const parsed_r11 = \u0275\u0275readContextLet(0);
    \u0275\u0275advance(3);
    \u0275\u0275repeater(parsed_r11.parseErrors);
  }
}
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_50_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "div", 20)(1, "h4");
    \u0275\u0275text(2, "Data Elements");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(3, "div", 27);
    \u0275\u0275repeaterCreate(4, ExtractionPayloadViewerComponent_Conditional_1_Conditional_50_For_5_Template, 11, 5, "div", 28, \u0275\u0275componentInstance().trackByDataElement, true);
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(6, "h4");
    \u0275\u0275text(7, "Resources by Type");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(8, "div", 29);
    \u0275\u0275repeaterCreate(9, ExtractionPayloadViewerComponent_Conditional_1_Conditional_50_For_10_Template, 9, 4, "div", 30, \u0275\u0275componentInstance().trackByResourceType, true);
    \u0275\u0275domElementEnd();
    \u0275\u0275conditionalCreate(11, ExtractionPayloadViewerComponent_Conditional_1_Conditional_50_Conditional_11_Template, 5, 0);
    \u0275\u0275domElementEnd();
  }
  if (rf & 2) {
    \u0275\u0275nextContext();
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275repeater(ctx_r2.dataElements());
    \u0275\u0275advance(5);
    \u0275\u0275repeater(ctx_r2.resourceSummary());
    \u0275\u0275advance(2);
    \u0275\u0275conditional((parsed_r11 == null ? null : parsed_r11.parseErrors) && parsed_r11.parseErrors.length > 0 ? 11 : -1);
  }
}
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_51_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "div", 21)(1, "div", 39)(2, "h4");
    \u0275\u0275text(3, "DE01 - Client Name");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(4, "div", 40)(5, "div", 41)(6, "span", 11);
    \u0275\u0275text(7, "Full Name");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(8, "span", 13);
    \u0275\u0275text(9);
    \u0275\u0275domElementEnd()()()();
    \u0275\u0275domElementStart(10, "div", 39)(11, "h4");
    \u0275\u0275text(12, "DE02 - Client Identifiers");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(13, "div", 40)(14, "div", 41)(15, "span", 11);
    \u0275\u0275text(16, "MRN");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(17, "span", 42);
    \u0275\u0275text(18);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(19, "div", 41)(20, "span", 11);
    \u0275\u0275text(21, "OHIP Number");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(22, "span", 42);
    \u0275\u0275text(23);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(24, "div", 41)(25, "span", 11);
    \u0275\u0275text(26, "Birth Date");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(27, "span", 13);
    \u0275\u0275text(28);
    \u0275\u0275domElementEnd()()()();
    \u0275\u0275domElementStart(29, "div", 39)(30, "h4");
    \u0275\u0275text(31, "DE03 - Client Address");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(32, "div", 40)(33, "div", 43)(34, "span", 11);
    \u0275\u0275text(35, "Address");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(36, "span", 13);
    \u0275\u0275text(37);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(38, "div", 41)(39, "span", 11);
    \u0275\u0275text(40, "Postal Code");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(41, "span", 42);
    \u0275\u0275text(42);
    \u0275\u0275domElementEnd()()()()();
  }
  if (rf & 2) {
    ...
    const parsed_r11 = \u0275\u0275readContextLet(0);
    \u0275\u0275advance(9);
    \u0275\u0275textInterpolate((parsed_r11 == null ? null : parsed_r11.summary == null ? null : parsed_r11.summary.patientInfo == null ? null : parsed_r11.summary.patientInfo.name) || "N/A");
    \u0275\u0275advance(9);
    \u0275\u0275textInterpolate((parsed_r11 == null ? null : parsed_r11.summary == null ? null : parsed_r11.summary.patientInfo == null ? null : parsed_r11.summary.patientInfo.mrn) || "N/A");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((parsed_r11 == null ? null : parsed_r11.summary == null ? null : parsed_r11.summary.patientInfo == null ? null : parsed_r11.summary.patientInfo.ohip) || "N/A");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((parsed_r11 == null ? null : parsed_r11.summary == null ? null : parsed_r11.summary.patientInfo == null ? null : parsed_r11.summary.patientInfo.birthDate) || "N/A");
    \u0275\u0275advance(9);
    \u0275\u0275textInterpolate((parsed_r11 == null ? null : parsed_r11.summary == null ? null : parsed_r11.summary.patientInfo == null ? null : parsed_r11.summary.patientInfo.address) || "N/A");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((parsed_r11 == null ? null : parsed_r11.summary == null ? null : parsed_r11.summary.patientInfo == null ? null : parsed_r11.summary.patientInfo.postalCode) || "N/A");
  }
}
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_52_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "div", 21)(1, "div", 39)(2, "h4");
    ...
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(8, "span", 42);
    \u0275\u0275text(9);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(10, "div", 41)(11, "span", 11);
    \u0275\u0275text(12, "Referral Date");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(13, "span", 13);
    \u0275\u0275text(14);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(15, "div", 41)(16, "span", 11);
    \u0275\u0275text(17, "Status");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(18, "span", 44);
    \u0275\u0275text(19);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(20, "div", 41)(21, "span", 11);
    \u0275\u0275text(22, "Referral Source");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(23, "span", 13);
    \u0275\u0275text(24);
    \u0275\u0275domElementEnd()()()();
    \u0275\u0275domElementStart(25, "div", 39)(26, "h4");
    \u0275\u0275text(27, "DE06 - Episode of Care");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(28, "div", 40)(29, "div", 41)(30, "span", 11);
    \u0275\u0275text(31, "Episode ID");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(32, "span", 42);
    \u0275\u0275text(33);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(34, "div", 41)(35, "span", 11);
    \u0275\u0275text(36, "Status");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(37, "span", 44);
    \u0275\u0275text(38);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(39, "div", 41)(40, "span", 11);
    \u0275\u0275text(41, "Start Date");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(42, "span", 13);
    \u0275\u0275text(43);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(44, "div", 41)(45, "span", 11);
    \u0275\u0275text(46, "End Date");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(47, "span", 13);
    \u0275\u0275text(48);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(49, "div", 41)(50, "span", 11);
    \u0275\u0275text(51, "Type");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(52, "span", 13);
    \u0275\u0275text(53);
    \u0275\u0275domElementEnd()()()();
    \u0275\u0275domElementStart(54, "div", 39)(55, "h4");
    \u0275\u0275text(56, "DE07/DE08 - Provider Organization & Site");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(57, "div", 40)(58, "div", 41)(59, "span", 11);
    \u0275\u0275text(60, "Organization");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(61, "span", 13);
    \u0275\u0275text(62);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(63, "div", 41)(64, "span", 11);
    \u0275\u0275text(65, "Organization ID");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(66, "span", 42);
    \u0275\u0275text(67);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(68, "div", 41)(69, "span", 11);
    \u0275\u0275text(70, "Location");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(71, "span", 13);
    \u0275\u0275text(72);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(73, "div", 41)(74, "span", 11);
    \u0275\u0275text(75, "Site Code");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(76, "span", 42);
    \u0275\u0275text(77);
    \u0275\u0275domElementEnd()()()();
    \u0275\u0275domElementStart(78, "div", 39)(79, "h4");
    \u0275\u0275text(80, "DE09 - Health Program");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(81, "div", 40)(82, "div", 41)(83, "span", 11);
    \u0275\u0275text(84, "Program Name");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(85, "span", 13);
    \u0275\u0275text(86);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(87, "div", 41)(88, "span", 11);
    \u0275\u0275text(89, "Program ID");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(90, "span", 42);
    \u0275\u0275text(91);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(92, "div", 41)(93, "span", 11);
    \u0275\u0275text(94, "Program Code");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(95, "span", 42);
    \u0275\u0275text(96);
    \u0275\u0275domElementEnd()()()()();
  }
  if (rf & 2) {
    ...
    const parsed_r11 = \u0275\u0275readContextLet(0);
    \u0275\u0275advance(9);
    \u0275\u0275textInterpolate((parsed_r11 == null ? null : parsed_r11.summary == null ? null : parsed_r11.summary.referralInfo == null ? null : parsed_r11.summary.referralInfo.referralId) || "N/A");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((parsed_r11 == null ? null : parsed_r11.summary == null ? null : parsed_r11.summary.referralInfo == null ? null : parsed_r11.summary.referralInfo.referralDate) || "N/A");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((parsed_r11 == null ? null : parsed_r11.summary == null ? null : parsed_r11.summary.referralInfo == null ? null : parsed_r11.summary.referralInfo.status) || "N/A");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((parsed_r11 == null ? null : parsed_r11.summary == null ? null : parsed_r11.summary.referralInfo == null ? null : parsed_r11.summary.referralInfo.referralSource) || "N/A");
    \u0275\u0275advance(9);
    \u0275\u0275textInterpolate((parsed_r11 == null ? null : parsed_r11.summary == null ? null : parsed_r11.summary.episodeInfo == null ? null : parsed_r11.summary.episodeInfo.episodeId) || "N/A");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((parsed_r11 == null ? null : parsed_r11.summary == null ? null : parsed_r11.summary.episodeInfo == null ? null : parsed_r11.summary.episodeInfo.status) || "N/A");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((parsed_r11 == null ? null : parsed_r11.summary == null ? null : parsed_r11.summary.episodeInfo == null ? null : parsed_r11.summary.episodeInfo.startDate) || "N/A");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((parsed_r11 == null ? null : parsed_r11.summary == null ? null : parsed_r11.summary.episodeInfo == null ? null : parsed_r11.summary.episodeInfo.endDate) || "N/A");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((parsed_r11 == null ? null : parsed_r11.summary == null ? null : parsed_r11.summary.episodeInfo == null ? null : parsed_r11.summary.episodeInfo.type) || "N/A");
    \u0275\u0275advance(9);
    \u0275\u0275textInterpolate((parsed_r11 == null ? null : parsed_r11.summary == null ? null : parsed_r11.summary.providerInfo == null ? null : parsed_r11.summary.providerInfo.organizationName) || "N/A");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((parsed_r11 == null ? null : parsed_r11.summary == null ? null : parsed_r11.summary.providerInfo == null ? null : parsed_r11.summary.providerInfo.organizationId) || "N/A");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((parsed_r11 == null ? null : parsed_r11.summary == null ? null : parsed_r11.summary.providerInfo == null ? null : parsed_r11.summary.providerInfo.locationName) || "N/A");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((parsed_r11 == null ? null : parsed_r11.summary == null ? null : parsed_r11.summary.providerInfo == null ? null : parsed_r11.summary.providerInfo.siteCode) || "N/A");
    \u0275\u0275advance(9);
    \u0275\u0275textInterpolate((parsed_r11 == null ? null : parsed_r11.summary == null ? null : parsed_r11.summary.programInfo == null ? null : parsed_r11.summary.programInfo.programName) || "N/A");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((parsed_r11 == null ? null : parsed_r11.summary == null ? null : parsed_r11.summary.programInfo == null ? null : parsed_r11.summary.programInfo.programId) || "N/A");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((parsed_r11 == null ? null : parsed_r11.summary == null ? null : parsed_r11.summary.programInfo == null ? null : parsed_r11.summary.programInfo.programCode) || "N/A");
  }
}
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_53_Conditional_1_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "div", 47)(1, "div", 48)(2, "span", 49);
    \u0275\u0275text(3);
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(4, "span", 50);
    \u0275\u0275text(5);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(6, "div", 51)(7, "div", 52)(8, "span", 11);
    \u0275\u0275text(9, "Start");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(10, "span", 13);
    \u0275\u0275text(11);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(12, "div", 52)(13, "span", 11);
    \u0275\u0275text(14, "End");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(15, "span", 13);
    \u0275\u0275text(16);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(17, "div", 52)(18, "span", 11);
    \u0275\u0275text(19, "Service Type");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(20, "span", 13);
    \u0275\u0275text(21);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(22, "div", 52)(23, "span", 11);
    \u0275\u0275text(24, "Functional Centre");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(25, "span", 42);
    \u0275\u0275text(26);
    \u0275\u0275domElementEnd()()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(event_r12.encounterId || "Unknown");
    \u0275\u0275advance();
    \u0275\u0275classMap("status-" + event_r12.status);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(event_r12.status);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(event_r12.startDate || "N/A");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(event_r12.endDate || "N/A");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(event_r12.serviceType || "N/A");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(event_r12.functionalCentre || "N/A");
  }
}
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_53_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "div", 45);
    \u0275\u0275repeaterCreate(1, ExtractionPayloadViewerComponent_Conditional_1_Conditional_53_Conditional_1_For_2_Template, 27, 8, "div", 47, \u0275\u0275componentInstance().trackByServiceEvent, true);
    \u0275\u0275domElementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r2.serviceEvents());
  }
}
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_53_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "div", 46)(1, "span", 53);
    \u0275\u0275text(2, "\u25CB");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(3, "p");
...
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_53_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "div", 22);
    \u0275\u0275conditionalCreate(1, ExtractionPayloadViewerComponent_Conditional_1_Conditional_53_Conditional_1_Template, 3, 0, "div", 45)(2, ExtractionPayloadViewerComponent_Conditional_1_Conditional_53_Conditional_2_Template, 5, 0, "div", 46);
    \u0275\u0275domElementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.hasServiceEvents() ? 1 : 2);
  }
}
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_54_Conditional_1_For_2_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const obs_r13 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(obs_r13.system);
  }
}
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_54_Conditional_1_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "div", 55)(1, "div", 56)(2, "span", 57);
    \u0275\u0275text(3);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(4, "div", 58);
    \u0275\u0275text(5);
    \u0275\u0275domElementEnd();
    \u0275\u0275conditionalCreate(6, ExtractionPayloadViewerComponent_Conditional_1_Conditional_54_Conditional_1_For_2_Conditional_6_Template, 2, 1, "div", 59);
    \u0275\u0275domElementEnd();
  }
  if (rf & 2) {
    const obs_r13 = ctx.$implicit;
    const ctx_r2 = \u0275\u0275nextContext(4);
    \u0275\u0275advance(2);
    \u0275\u0275domProperty("title", obs_r13.code);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r2.getObservationName(obs_r13.code));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(obs_r13.value || "Not specified");
    \u0275\u0275advance();
    \u0275\u0275conditional(obs_r13.system ? 6 : -1);
  }
}
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_54_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "div", 54);
    \u0275\u0275repeaterCreate(1, ExtractionPayloadViewerComponent_Conditional_1_Conditional_54_Conditional_1_For_2_Template, 7, 4, "div", 55, \u0275\u0275componentInstance().trackByObservation, true);
    \u0275\u0275domElementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(3);
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r2.observations());
  }
}
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_54_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "div", 46)(1, "span", 53);
    \u0275\u0275text(2, "\u25CB");
    \u0275\u0275domElementEnd();
...
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_54_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "div", 23);
    \u0275\u0275conditionalCreate(1, ExtractionPayloadViewerComponent_Conditional_1_Conditional_54_Conditional_1_Template, 3, 0, "div", 54)(2, ExtractionPayloadViewerComponent_Conditional_1_Conditional_54_Conditional_2_Template, 5, 0, "div", 46);
    \u0275\u0275domElementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.hasObservations() ? 1 : 2);
  }
}
function ExtractionPayloadViewerComponent_Conditional_1_Conditional_55_Template(rf, ctx) {
  if (rf & 1) {
    const _r14 = \u0275\u0275getCurrentView();
    \u0275\u0275domElementStart(0, "div", 24)(1, "div", 60)(2, "button", 61);
    \u0275\u0275domListener("click", function ExtractionPayloadViewerComponent_Conditional_1_Conditional_55_Template_button_click_2_listener() {
      \u0275\u0275restoreView(_r14);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.copyToClipboard(ctx_r2.formattedRawData()));
    });
    \u0275\u0275text(3);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(4, "pre", 62)(5, "code");
    \u0275\u0275text(6);
    \u0275\u0275domElementEnd()()();
  }
  if (rf & 2) {
...
function ExtractionPayloadViewerComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(30);
    \u0275\u0275domElementEnd()()();
    \u0275\u0275domElementStart(31, "div", 14);
    \u0275\u0275repeaterCreate(32, ExtractionPayloadViewerComponent_Conditional_1_For_33_Template, 5, 3, "span", 15, _forTrack02);
    \u0275\u0275domElementEnd()();
    \u0275\u0275domElementStart(34, "div", 16)(35, "button", 17);
    \u0275\u0275domListener("click", function ExtractionPayloadViewerComponent_Conditional_1_Template_button_click_35_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.setActiveTab("summary"));
    });
    \u0275\u0275text(36, " Summary ");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(37, "button", 17);
    \u0275\u0275domListener("click", function ExtractionPayloadViewerComponent_Conditional_1_Template_button_click_37_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.setActiveTab("patient"));
    });
    \u0275\u0275text(38, " Patient (DE01-03) ");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(39, "button", 17);
    \u0275\u0275domListener("click", function ExtractionPayloadViewerComponent_Conditional_1_Template_button_click_39_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.setActiveTab("episode"));
    });
    \u0275\u0275text(40, " Episode (DE05-09) ");
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(41, "button", 17);
    \u0275\u0275domListener("click", function ExtractionPayloadViewerComponent_Conditional_1_Template_button_click_41_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.setActiveTab("services"));
    });
    \u0275\u0275text(42, " Services (DE10) ");
    \u0275\u0275conditionalCreate(43, ExtractionPayloadViewerComponent_Conditional_1_Conditional_43_Template, 2, 1, "span", 18);
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(44, "button", 17);
    \u0275\u0275domListener("click", function ExtractionPayloadViewerComponent_Conditional_1_Template_button_click_44_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.setActiveTab("demographics"));
    });
    \u0275\u0275text(45, " Demographics (DE04) ");
    \u0275\u0275conditionalCreate(46, ExtractionPayloadViewerComponent_Conditional_1_Conditional_46_Template, 2, 1, "span", 18);
    \u0275\u0275domElementEnd();
    \u0275\u0275domElementStart(47, "button", 17);
    \u0275\u0275domListener("click", function ExtractionPayloadViewerComponent_Conditional_1_Template_button_click_47_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.setActiveTab("raw"));
    });
    ...
    \u0275\u0275conditionalCreate(50, ExtractionPayloadViewerComponent_Conditional_1_Conditional_50_Template, 12, 1, "div", 20);
    \u0275\u0275conditionalCreate(51, ExtractionPayloadViewerComponent_Conditional_1_Conditional_51_Template, 43, 6, "div", 21);
    \u0275\u0275conditionalCreate(52, ExtractionPayloadViewerComponent_Conditional_1_Conditional_52_Template, 97, 16, "div", 21);
    \u0275\u0275conditionalCreate(53, ExtractionPayloadViewerComponent_Conditional_1_Conditional_53_Template, 3, 1, "div", 22);
    \u0275\u0275conditionalCreate(54, ExtractionPayloadViewerComponent_Conditional_1_Conditional_54_Template, 3, 1, "div", 23);
    \u0275\u0275conditionalCreate(55, ExtractionPayloadViewerComponent_Conditional_1_Conditional_55_Template, 7, 4, "div", 24);
    \u0275\u0275domElementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    const parsed_r15 = \u0275\u0275storeLet(ctx_r2.parsedPayload());
    const config_r16 = ctx_r2.statusConfig();
    \u0275\u0275advance(3);
    \u0275\u0275classMap(config_r16.class);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(config_r16.icon);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(config_r16.label);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", parsed_r15 == null ? null : parsed_r15.summary == null ? null : parsed_r15.summary.totalResources, " resources");
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate((parsed_r15 == null ? null : parsed_r15.bundleId) || "N/A");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((parsed_r15 == null ? null : parsed_r15.bundleType) || "collection");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((parsed_r15 == null ? null : parsed_r15.summary == null ? null : parsed_r15.summary.patientInfo == null ? null : parsed_r15.summary.patientInfo.name) || "N/A");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((parsed_r15 == null ? null : parsed_r15.summary == null ? null : parsed_r15.summary.patientInfo == null ? null : parsed_r15.summary.patientInfo.mrn) || "N/A");
    \u0275\u0275advance(2);
    \u0275\u0275repeater(ctx_r2.dataElements());
    \u0275\u0275advance(3);
    \u0275\u0275classProp("active", ctx_r2.activeTab() === "summary");
    \u0275\u0275advance(2);
    \u0275\u0275classProp("active", ctx_r2.activeTab() === "patient");
    \u0275\u0275advance(2);
    \u0275\u0275classProp("active", ctx_r2.activeTab() === "episode");
    \u0275\u0275advance(2);
    \u0275\u0275classProp("active", ctx_r2.activeTab() === "services");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r2.hasServiceEvents() ? 43 : -1);
    \u0275\u0275advance();
    \u0275\u0275classProp("active", ctx_r2.activeTab() === "demographics");
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx_r2.hasObservations() ? 46 : -1);
    \u0275\u0275advance();
    \u0275\u0275classProp("active", ctx_r2.activeTab() === "raw");
    \u0275\u0275advance(3);
    \u0275\u0275conditional(ctx_r2.activeTab() === "summary" ? 50 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.activeTab() === "patient" ? 51 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.activeTab() === "episode" ? 52 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.activeTab() === "services" ? 53 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.activeTab() === "demographics" ? 54 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.activeTab() === "raw" ? 55 : -1);
  }
}
function ExtractionPayloadViewerComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "div", 2)(1, "p");
    \u0275\u0275text(2, "No extraction data available or content is not a valid FHIR Bundle.");
    \u0275\u0275domElementEnd()();
  }
}
var ExtractionPayloadViewerComponent = class _ExtractionPayloadViewerComponent {
  ...
  parsedPayload = computed(() => {
    ...
    if (!text?.text_content)
      return null;
    return parseExtractionPayload(text.text_content);
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ExtractionPayloadViewerComponent, selectors: [["app-extraction-payload-viewer"]], outputs: { closed: "closed" }, decls: 3, vars: 2, consts: [[1, "loading-overlay"], [1, "extraction-viewer"], [1, "no-content"], [1, "loading-spinner"], [1, "extraction-header"], [1, "status-banner"], [1, "status-icon"], [1, "status-label"], [1, "resource-count"], [1, "header-grid"], [1, "header-item"], [1, "label"], [1, "value", "bundle-id"], [1, "value"], [1, "data-element-pills"], [1, "de-pill", 3, "title"], [1, "tabs"], [1, "tab", 3, "click"], [1, "count-badge"], [1, "tab-content"], [1, "summary-content"], [1, "detail-content"], [1, "services-content"], [1, "demographics-content"], [1, "json-content"], [1, "de-code"], [1, "de-count"], [1, "de-list"], [1, "de-item"], [1, "resource-list"], [1, "resource-item"], [1, "de-toggle", 3, "click"], [1, "toggle-icon"], [1, "de-name"], [1, "de-items"], [1, "resource-toggle", 3, "click"], [1, "resource-type"], [1, "resource-ids"], [1, "parse-errors"], [1, "detail-section"], [1, "detail-grid"], [1, "detail-item"], [1, "value", "mono"], [1, "detail-item", "full-width"], [1, "value", "status-badge"], [1, "service-events-list"], [1, "no-data"], [1, "service-event-card"], [1, "event-header"], [1, "event-id"], [1, "event-status"], [1, "event-details"], [1, "event-item"], [1, "empty-icon"], [1, "observations-list"], [1, "observation-card"], [1, "obs-header"], [1, "obs-code", 3, "title"], [1, "obs-value"], [1, "obs-system"], [1, "content-toolbar"], [1, "copy-btn", 3, "click"], [1, "json-pre"]], template: function ExtractionPayloadViewerComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275conditionalCreate(0, ExtractionPayloadViewerComponent_Conditional_0_Template, 4, 0, "div", 0);
      \u0275\u0275conditionalCreate(1, ExtractionPayloadViewerComponent_Conditional_1_Template, 56, 30, "div", 1)(2, ExtractionPayloadViewerComponent_Conditional_2_Template, 3, 0, "div", 2);
    }
    if (rf & 2) {
      \u0275\u0275conditional(ctx.loading() ? 0 : -1);
      \u0275\u0275advance();
...
@if (hasContent()) {
        ...
        <div class="detail-content">
          ...
          <div class="detail-section">
            ...
            <div class="detail-grid">
              ...
              <div class="detail-item">
                <span class="label">OHIP Number</span>
          ...
          <div class="detail-section">
            ...
            <div class="detail-grid">
              ...
              <div class="detail-item">
                ...
                <span class="value">{{ parsed?.summary?.episodeInfo?.startDate || 'N/A' }}</span>
              </div>
              <div class="detail-item">
                <span class="label">End Date</span>
                <span class="value">{{ parsed?.summary?.episodeInfo?.endDate || 'N/A' }}</span>
              </div>
              <div class="detail-item">
                <span class="label">Type</span>
                <span class="value">{{ parsed?.summary?.episodeInfo?.type || 'N/A' }}</span>
              </div>
            </div>
          </div>
                ...
                <div class="service-event-card">
                  ...
                  <div class="event-details">
                    ...
                    <div class="event-item">
                      ...
                      <span class="value">{{ event.endDate || 'N/A' }}</span>
                    </div>
                    <div class="event-item">
                    ...
                    <div class="event-item">
                      ...
                      <span class="value mono">{{ event.functionalCentre || 'N/A' }}</span>
                    </div>
                  </div>
                </div>
              }
              ...
              @for (obs of observations(); track trackByObservation($index, obs)) {
                <div class="observation-card">
                  <div class="obs-header">
                    <span class="obs-code" [title]="obs.code">{{ getObservationName(obs.code) }}</span>
                  </div>
  ...
  <div class="no-content">
    <p>No extraction data available or content is not a valid FHIR Bundle.</p>
  </div>
}
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ExtractionPayloadViewerComponent, { className: "ExtractionPayloadViewerComponent", filePath: "src/app/logs/components/extraction-payload-viewer.ts", lineNumber: 32 });
})();
