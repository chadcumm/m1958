...
function OperationsComponent_Conditional_34_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 33)(7, "span");
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "span");
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "div", 34)(12, "h4");
    \u0275\u0275text(13, "Summary");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "div", 35)(15, "div", 36)(16, "span", 37);
    ...
    \u0275\u0275text(24);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(25, "div", 36)(26, "span", 37);
    ...
    \u0275\u0275text(34);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(35, "div", 36)(36, "span", 37);
    \u0275\u0275text(37, "Episodes Created");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "span", 38);
    \u0275\u0275text(39);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(40, "div", 36)(41, "span", 37);
    \u0275\u0275text(42, "Services Created");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(43, "span", 38);
    \u0275\u0275text(44);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(45, "div", 36)(46, "span", 37);
    \u0275\u0275text(47, "Appointments");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(48, "span", 38);
    \u0275\u0275text(49);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275conditionalCreate(50, OperationsComponent_Conditional_34_Conditional_50_Template, 3, 6, "div", 39);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_1_0;
...
function OperationsComponent_Conditional_45_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 20)(1, "div", 30)(2, "span", 41);
    \u0275\u0275text(3, "ERROR");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "span", 32);
    \u0275\u0275text(5);
...
function OperationsComponent_Conditional_46_For_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(1, "td")(2, "input", 45);
...
function OperationsComponent_Conditional_46_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 21)(1, "table", 42)(2, "thead")(3, "tr");
    \u0275\u0275element(4, "th");
    \u0275\u0275elementStart(5, "th");
    \u0275\u0275text(6, "Alias Pool");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275repeaterCreate(18, OperationsComponent_Conditional_46_For_19_Template, 15, 9, "tr", 43, _forTrack0);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
...
function OperationsComponent_Conditional_47_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 8)(1, "label", 9)(2, "input", 46);
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(8, "label", 9)(9, "input", 46);
...
function OperationsComponent_Conditional_48_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 47)(1, "div", 30)(2, "span", 31);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "span", 32);
    \u0275\u0275text(5);
...
function OperationsComponent_Conditional_88_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 49)(1, "div", 30)(2, "span", 31);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "span", 32);
    \u0275\u0275text(5);
    ...
    \u0275\u0275text(12);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "div", 34)(14, "h4");
    \u0275\u0275text(15, "Summary");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "div", 35)(17, "div", 36)(18, "span", 37);
    \u0275\u0275text(19, "Episodes Processed");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "span", 38);
    \u0275\u0275text(21);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(22, "div", 36)(23, "span", 37);
    ...
    \u0275\u0275text(31);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275conditionalCreate(32, OperationsComponent_Conditional_88_Conditional_32_Template, 3, 6, "div", 39);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_1_0;
...
function OperationsComponent_Conditional_89_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-system-overview-panel", 50);
    \u0275\u0275listener("closed", function OperationsComponent_Conditional_89_Template_app_system_overview_panel_closed_0_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.closeSystemOverview());
    })("viewLog", function OperationsComponent_Conditional_89_Template_app_system_overview_panel_viewLog_0_listener($event) {
      \u0275\u0275restoreView(_r6);
      const ctx_r0 = \u0275\u0275nextContext();
...
var OperationsComponent = class _OperationsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _OperationsComponent, selectors: [["app-operations"]], decls: 90, vars: 34, consts: [[1, "operations-container"], [1, "operations-header"], [1, "header-content"], [1, "subtitle"], [1, "system-overview-btn", 3, "click"], [1, "btn-icon"], [1, "run-manager-section"], [1, "description"], [1, "mode-selector"], [1, "mode-option"], ["type", "radio", "name", "commitMode", 3, "ngModelChange", "value", "ngModel", "disabled"], [1, "mode-label"], [1, "mode-desc"], [1, "run-button", 3, "click", "disabled"], [1, "manager-result", 3, "success", "error"], [1, "add-patient-section"], [1, "search-row"], ["type", "text", "placeholder", "Enter FIN NBR...", 1, "fin-input", 3, "ngModelChange", "input", "keydown.enter", "ngModel", "disabled"], [1, "search-button", 3, "click", "disabled"], [1, "spinner"], [1, "add-patient-result", "error"], [1, "encounter-table-wrap"], [1, "add-patient-result", 3, "success", "error"], [1, "run-data-extract-section"], ["type", "radio", "name", "dataCommitMode", 3, "ngModelChange", "value", "ngModel", "disabled"], [1, "mode-selector", 2, "margin-top", "16px"], ["type", "radio", "name", "dataMode", 3, "ngModelChange", "value", "ngModel", "disabled"], [1, "dummy-count-row"], [1, "data-manager-result", 3, "success", "error"], [1, "manager-result"], [1, "result-status"], [1, "status-badge"], [1, "result-message"], [1, "result-timing"], [1, "result-details"], [1, "detail-grid"], [1, "detail-item"], [1, "detail-label"], [1, "detail-value"], [1, "result-actions"], [1, "view-log-link", 3, "routerLink", "queryParams"], [1, "status-badge", "error"], [1, "encounter-table"], [3, "selected"], [3, "click"], ["type", "radio", "name", "encounterSelect", 3, "click", "checked"], ["type", "radio", "name", "addPatientCommitMode", 3, "ngModelChange", "value", "ngModel", "disabled"], [1, "add-patient-result"], ["type", "number", "min", "1", "max", "50", 1, "dummy-count-input", 3, "ngModelChange", "ngModel", "disabled"], [1, "data-manager-result"], [3, "closed", "viewLog"]], template: function OperationsComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275conditionalCreate(89, OperationsComponent_Conditional_89_Template, 1, 0, "app-system-overview-panel");
    }
    if (rf & 2) {
      \u0275\u0275advance(18);
      \u0275\u0275property("value", 0);
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.showSystemOverview() ? 89 : -1);
    }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(OperationsComponent, [{
    ...
    <div class="operations-container">
      ...
      <!-- TODO: Re-enable when Mirth REST API integration is ready
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(OperationsComponent, { className: "OperationsComponent", filePath: "src/app/operations/operations.ts", lineNumber: 1043 });
})();
export {
  OperationsComponent
};
