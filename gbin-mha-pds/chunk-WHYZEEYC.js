...
function ReferenceComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(47, "Channel Flow Diagram");
    \u0275\u0275elementEnd();
    \u0275\u0275element(48, "app-mermaid-diagram", 20);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(49, "section", 21)(50, "h2");
    \u0275\u0275text(51, "FHIR Resource Profiles");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(52, "p", 12);
    \u0275\u0275text(53, " The FHIR Transformation channel creates these MHA PDS-compliant FHIR R4 resources: ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(54, "div", 22)(55, "div", 23)(56, "h4");
    \u0275\u0275text(57, "Core Resources");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(58, "ul", 24)(59, "li")(60, "code");
    \u0275\u0275text(61, "Patient");
    \u0275\u0275elementEnd();
    \u0275\u0275text(62, " - DE01-DE04 client demographics");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(63, "li")(64, "code");
    \u0275\u0275text(65, "Organization");
    \u0275\u0275elementEnd();
    \u0275\u0275text(66, " - DE07 HSP organization");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(67, "li")(68, "code");
    \u0275\u0275text(69, "Location");
    \u0275\u0275elementEnd();
    \u0275\u0275text(70, " - DE08 HSP site");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(71, "div", 23)(72, "h4");
    \u0275\u0275text(73, "Episode Resources");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(74, "ul", 24)(75, "li")(76, "code");
    \u0275\u0275text(77, "ServiceRequest");
    \u0275\u0275elementEnd();
    \u0275\u0275text(78, " - DE05 referral info");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(79, "li")(80, "code");
    \u0275\u0275text(81, "EpisodeOfCare");
    \u0275\u0275elementEnd();
    \u0275\u0275text(82, " - DE06 episode tracking");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(83, "li")(84, "code");
    \u0275\u0275text(85, "HealthcareService");
    \u0275\u0275elementEnd();
    \u0275\u0275text(86, " - DE09 health program");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(87, "div", 23)(88, "h4");
    \u0275\u0275text(89, "Service Resources");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(90, "ul", 24)(91, "li")(92, "code");
    \u0275\u0275text(93, "Encounter");
    \u0275\u0275elementEnd();
    \u0275\u0275text(94, " - DE10 health service events");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(95, "li")(96, "code");
    \u0275\u0275text(97, "Appointment");
    \u0275\u0275elementEnd();
    \u0275\u0275text(98, " - DE06.006-007 (cancelled only)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(99, "li")(100, "code");
    \u0275\u0275text(101, "Condition");
    \u0275\u0275elementEnd();
    \u0275\u0275text(102, " - Mental health condition");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(103, "div", 23)(104, "h4");
    \u0275\u0275text(105, "SDOH Observations (DE04)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(106, "ul", 24)(107, "li")(108, "code");
    \u0275\u0275text(109, "Observation-GenderIdentity");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(110, "li")(111, "code");
    \u0275\u0275text(112, "Observation-SexualOrientation");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(113, "li")(114, "code");
    \u0275\u0275text(115, "Observation-CitizenshipStatus");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(116, "li")(117, "code");
    \u0275\u0275text(118, "Observation-LevelOfEducation");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(119, "li")(120, "code");
    \u0275\u0275text(121, "Observation-EmploymentStatus");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(122, "li")(123, "code");
    \u0275\u0275text(124, "Observation-PersonalIncomeSource");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(125, "li")(126, "code");
    \u0275\u0275text(127, "Observation-HousingStatus");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(128, "li")(129, "code");
    \u0275\u0275text(130, "Observation-TotalHouseholdIncome");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(131, "li")(132, "code");
    \u0275\u0275text(133, "Observation-NumberOfPeopleIncomeSupports");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(134, "li")(135, "code");
    \u0275\u0275text(136, "Observation-LegalStatus");
    \u0275\u0275elementEnd()()()()()();
    \u0275\u0275elementStart(137, "section", 25)(138, "h2");
    \u0275\u0275text(139, "Bundle Types");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(140, "p", 12);
    \u0275\u0275text(141, " Each patient episode can generate one or more FHIR bundles based on the SUBMIT_BUNDLE array. Bundles are determined by data availability and episode state. ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(142, "table", 26)(143, "thead")(144, "tr")(145, "th");
    \u0275\u0275text(146, "Bundle Type");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(147, "th");
    \u0275\u0275text(148, "Contains");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(149, "th");
    \u0275\u0275text(150, "When Used");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(151, "tbody")(152, "tr")(153, "td")(154, "code");
    \u0275\u0275text(155, "SERVICE_REQUEST_EOC");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(156, "td");
    \u0275\u0275text(157, "Patient, Organization, Location, ServiceRequest, EpisodeOfCare, HealthcareService");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(158, "td");
    \u0275\u0275text(159, "New episode with referral and program enrollment");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(160, "tr")(161, "td")(162, "code");
    \u0275\u0275text(163, "CLIENT_SDOH");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(164, "td");
    \u0275\u0275text(165, "Patient, Organization, Location, Condition, 10\xD7 Observation profiles");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(166, "td");
    \u0275\u0275text(167, "Episode has socio-demographic data (DE04)");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(168, "tr")(169, "td")(170, "code");
    \u0275\u0275text(171, "HEALTH_SERVICES");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(172, "td");
    \u0275\u0275text(173, "Patient, Organization, Location, ServiceRequest, EpisodeOfCare, Encounter, HealthcareService");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(174, "td");
    \u0275\u0275text(175, "Episode has service events (DE10)");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(176, "tr")(177, "td")(178, "code");
    \u0275\u0275text(179, "SCHEDULED_APPOINTMENT");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(180, "td");
    \u0275\u0275text(181, "Patient, Organization, Location, EpisodeOfCare, Appointment");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(182, "td");
    \u0275\u0275text(183, "First appointment was missed/cancelled only");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(184, "section", 27)(185, "h2");
    \u0275\u0275text(186, "Integration Endpoints");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(187, "table", 28)(188, "thead")(189, "tr")(190, "th");
    \u0275\u0275text(191, "Endpoint");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(195, "Method");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(196, "tbody")(197, "tr")(198, "td");
    \u0275\u0275text(199, "Cerner MHA PDS Data API");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(200, "td")(201, "code");
    \u0275\u0275text(202, "m1958.gbrh_cd.cerncd.com/mpages/reports/gbin_mha_pds_data");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(203, "td");
    \u0275\u0275text(204, "GET");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(205, "tr")(206, "td");
    \u0275\u0275text(207, "OneID OAuth Token");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(208, "td")(209, "code");
    \u0275\u0275text(210, "login.pst.oneidfederation.ehealthontario.ca/oidc/access_token");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(211, "td");
    \u0275\u0275text(212, "POST");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(213, "tr")(214, "td");
    \u0275\u0275text(215, "Ontario Health FHIR API");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(216, "td")(217, "code");
    \u0275\u0275text(218, "provider.pst.ehealthontario.ca/api2/fhir/mha/Bundle");
    \u0275\u0275elementEnd()();
...
var ReferenceComponent = class _ReferenceComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ReferenceComponent, selectors: [["app-reference"]], decls: 13, vars: 6, consts: [[1, "reference-container"], [1, "reference-header"], [1, "subtitle"], [1, "tab-navigation"], [1, "tab-button", 3, "click"], [1, "diagram-section"], [1, "table-summary"], [1, "table-card"], [1, "erd-section"], ["diagramId", "mha-pds-erd", 3, "definition"], [1, "relationships-section"], [1, "relationships-table"], [1, "section-intro"], [1, "channel-summary"], [1, "channel-card"], [1, "channel-number"], [1, "channel-content"], [1, "channel-tags"], [1, "tag", "source"], [1, "tag", "dest"], ["diagramId", "mirth-flow", 3, "definition"], [1, "fhir-section"], [1, "profiles-grid"], [1, "profile-group"], [1, "profile-list"], [1, "bundles-section"], [1, "bundles-table"], [1, "endpoints-section"], [1, "endpoints-table"]], template: function ReferenceComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(12, ReferenceComponent_Conditional_12_Template, 221, 1);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(7);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ReferenceComponent, { className: "ReferenceComponent", filePath: "src/app/reference/reference.ts", lineNumber: 596 });
})();
export {
  ReferenceComponent
};
