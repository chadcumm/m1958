...
function RunReportModalComponent_Conditional_25_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(ctx_r0.report().CATEGORY);
  }
}
          ...
          <div class="report-meta">
            ...
            @if (report().CATEGORY) {
              <div class="meta-row">
                ...
                <span class="meta-value badge-render">{{ report().CATEGORY }}</span>
              </div>
            }
          </div>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RunReportModalComponent, { className: "RunReportModalComponent", filePath: "src/app/reports/components/run-report-modal.ts", lineNumber: 261 });
})();
